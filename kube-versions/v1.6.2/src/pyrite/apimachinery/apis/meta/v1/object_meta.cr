...
module Pyrite
  ...
  class Apimachinery::Apis::Meta::V1::ObjectMeta
    ...
    YAML.mapping({
      annotations:                   {type: Hash(String, String), nilable: true, key: "annotations"},
      cluster_name:                  {type: String, nilable: true, key: "clusterName"},
      creation_timestamp:            {type: Time, nilable: true, key: "creationTimestamp"},
      deletion_grace_period_seconds: {type: Int32, nilable: true, key: "deletionGracePeriodSeconds"},
      deletion_timestamp:            {type: Time, nilable: true, key: "deletionTimestamp"},
      finalizers:                    {type: Array(String), nilable: true, key: "finalizers"},
      generate_name:                 {type: String, nilable: true, key: "generateName"},
      generation:                    {type: Int32, nilable: true, key: "generation"},
      labels:                        {type: Hash(String, String), nilable: true, key: "labels"},
      name:                          {type: String, nilable: true, key: "name"},
      namespace:                     {type: String, nilable: true, key: "namespace"},
      owner_references:              {type: Array(Apimachinery::Apis::Meta::V1::OwnerReference), nilable: true, key: "ownerReferences"},
    ...
    def initialize(*, @annotations : Hash(String, String) | Nil = nil, @cluster_name : String | Nil = nil, @creation_timestamp : Time | Nil = nil, @deletion_grace_period_seconds : Int32 | Nil = nil, @deletion_timestamp : Time | Nil = nil, @finalizers : Array | Nil = nil, @generate_name : String | Nil = nil, @generation : Int32 | Nil = nil, @labels : Hash(String, String) | Nil = nil, @name : String | Nil = nil, @namespace : String | Nil = nil, @owner_references : Array | Nil = nil, @resource_version : String | Nil = nil, @self_link : String | Nil = nil, @uid : String | Nil = nil)
    end
  end
end
