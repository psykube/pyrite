...
module Pyrite
  ...
  class Kubernetes::Apis::Autoscaling::V1::HorizontalPodAutoscaler
    ...
    YAML.mapping({
      ...
      spec:        {type: Kubernetes::Apis::Autoscaling::V1::HorizontalPodAutoscalerSpec, nilable: true, key: "spec"},
      status:      {type: Kubernetes::Apis::Autoscaling::V1::HorizontalPodAutoscalerStatus, nilable: true, key: "status"},
    }, true)
  ...
  module Resources::Autoscaling::V1
    alias HorizontalPodAutoscaler = Kubernetes::Apis::Autoscaling::V1::HorizontalPodAutoscaler
  end
end
