...
module Pyrite
  ...
  class Api::Admissionregistration::V1alpha1::InitializerConfigurationList
    ...
    def create(initializers : Array | Nil = nil, metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
