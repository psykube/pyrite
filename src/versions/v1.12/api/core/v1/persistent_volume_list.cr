...
module Pyrite
  ...
  class Api::Core::V1::PersistentVolumeList
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Core::V1::PersistentVolumeSpec | Nil = nil, status : Api::Core::V1::PersistentVolumeStatus | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
