...
module Pyrite
  ...
  class Api::Core::V1::LimitRangeList
    ...
    # create a LimitRange
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Core::V1::LimitRangeSpec | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
