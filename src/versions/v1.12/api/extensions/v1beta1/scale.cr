...
module Pyrite
  ...
  class Api::Extensions::V1beta1::Scale
    ...
    def replace_extensions_v1beta1_deployment_scale(context : String | Nil = nil, dry_run : String | Nil = nil)
    end

    # partially update scale of the specified Deployment
    def patch_extensions_v1beta1_deployment_scale(context : String | Nil = nil, dry_run : String | Nil = nil)
    end
    ...
    def replace_extensions_v1beta1_replica_set_scale(context : String | Nil = nil, dry_run : String | Nil = nil)
    end

    # partially update scale of the specified ReplicaSet
    def patch_extensions_v1beta1_replica_set_scale(context : String | Nil = nil, dry_run : String | Nil = nil)
    end
    ...
    def replace_extensions_v1beta1_replication_controller_dummy_scale(context : String | Nil = nil, dry_run : String | Nil = nil)
    end

    # partially update scale of the specified ReplicationControllerDummy
    def patch_extensions_v1beta1_replication_controller_dummy_scale(context : String | Nil = nil, dry_run : String | Nil = nil)
    end
  end
