...
module Pyrite
  ...
  class Api::Extensions::V1beta1::DeploymentList
    getter api_version : String = "v1"
    getter kind : String = "List"
    # Items is the list of Deployments.
    property items : Array(Api::Extensions::V1beta1::Deployment)
    ...
    ::YAML.mapping({
      ...
      items:       {type: Array(Api::Extensions::V1beta1::Deployment), nilable: false, key: "items", getter: false, setter: false},
    ...
    # create a Deployment
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Extensions::V1beta1::DeploymentSpec | Nil = nil, status : Api::Extensions::V1beta1::DeploymentStatus | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
