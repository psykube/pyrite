...
module Pyrite
  ...
  class Api::Extensions::V1beta1::DaemonSetList
    getter api_version : String = "v1"
    getter kind : String = "List"
    # A list of daemon sets.
    property items : Array(Api::Extensions::V1beta1::DaemonSet)
    ...
    ::YAML.mapping({
      ...
      items:       {type: Array(Api::Extensions::V1beta1::DaemonSet), nilable: false, key: "items", getter: false, setter: false},
    ...
    # create a DaemonSet
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Extensions::V1beta1::DaemonSetSpec | Nil = nil, status : Api::Extensions::V1beta1::DaemonSetStatus | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
