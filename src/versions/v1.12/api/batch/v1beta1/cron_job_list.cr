...
module Pyrite
  ...
  class Api::Batch::V1beta1::CronJobList
    ...
    # create a CronJob
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Batch::V1beta1::CronJobSpec | Nil = nil, status : Api::Batch::V1beta1::CronJobStatus | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
