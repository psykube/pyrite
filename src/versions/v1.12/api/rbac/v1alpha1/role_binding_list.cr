...
module Pyrite
  ...
  class Api::Rbac::V1alpha1::RoleBindingList
    ...
    def create_rbac_authorization_v1alpha1_role_binding(role_ref : Api::Rbac::V1alpha1::RoleRef, metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, subjects : Array | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
