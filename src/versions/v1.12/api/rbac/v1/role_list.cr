...
module Pyrite
  ...
  class Api::Rbac::V1::RoleList
    ...
    # create a Role
    def create_rbac_authorization_v1_role(rules : Array, metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
