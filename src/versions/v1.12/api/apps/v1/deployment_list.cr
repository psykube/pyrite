...
module Pyrite
  ...
  class Api::Apps::V1::DeploymentList
    getter api_version : String = "v1"
    getter kind : String = "List"
    # Items is the list of Deployments.
    property items : Array(Api::Apps::V1::Deployment)
    ...
    ::YAML.mapping({
      ...
      items:       {type: Array(Api::Apps::V1::Deployment), nilable: false, key: "items", getter: false, setter: false},
    ...
    # create a Deployment
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Apps::V1::DeploymentSpec | Nil = nil, status : Api::Apps::V1::DeploymentStatus | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
