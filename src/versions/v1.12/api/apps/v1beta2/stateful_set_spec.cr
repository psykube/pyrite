...
module Pyrite
  ...
  class Api::Apps::V1beta2::StatefulSetSpec
    ...
    property update_strategy : Api::Apps::V1beta2::StatefulSetUpdateStrategy | Nil
    ...
    ::YAML.mapping({
      ...
      update_strategy:        {type: Api::Apps::V1beta2::StatefulSetUpdateStrategy, nilable: true, key: "updateStrategy", getter: false, setter: false},
    ...
    def initialize(*, @selector : Apimachinery::Apis::Meta::V1::LabelSelector, @service_name : String, @template : Api::Core::V1::PodTemplateSpec, @pod_management_policy : String | Nil = nil, @replicas : Int32 | Nil = nil, @revision_history_limit : Int32 | Nil = nil, @update_strategy : Api::Apps::V1beta2::StatefulSetUpdateStrategy | Nil = nil, @volume_claim_templates : Array | Nil = nil)
    end
  end
end
