...
module Pyrite
  ...
  class Api::Apps::V1beta2::DaemonSetList
    ...
    ::YAML.mapping({
      ...
      items:       {type: Array(Api::Apps::V1beta2::DaemonSet), nilable: false, key: "items", getter: false, setter: false},
    ...
    # create a DaemonSet
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Apps::V1beta2::DaemonSetSpec | Nil = nil, status : Api::Apps::V1beta2::DaemonSetStatus | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
