...
module Pyrite
  ...
  class Api::Apps::V1beta2::DaemonSetSpec
    ...
    def initialize(*, @selector : Apimachinery::Apis::Meta::V1::LabelSelector, @template : Api::Core::V1::PodTemplateSpec, @min_ready_seconds : Int32 | Nil = nil, @revision_history_limit : Int32 | Nil = nil, @update_strategy : Api::Apps::V1beta2::DaemonSetUpdateStrategy | Nil = nil)
    end
  end
end
