...
module Pyrite
  ...
  class Api::Apps::V1beta2::ControllerRevisionList
    ...
    property items : Array(Api::Apps::V1beta2::ControllerRevision)
    ...
    ::YAML.mapping({
      ...
      items:       {type: Array(Api::Apps::V1beta2::ControllerRevision), nilable: false, key: "items", getter: false, setter: false},
    ...
    def create(revision : Int32, data : Apimachinery::Runtime::RawExtension | Nil = nil, metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
