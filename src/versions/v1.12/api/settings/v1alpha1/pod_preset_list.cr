...
module Pyrite
  ...
  class Api::Settings::V1alpha1::PodPresetList
    ...
    # create a PodPreset
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Settings::V1alpha1::PodPresetSpec | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
