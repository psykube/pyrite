...
module Pyrite
  ...
  class Api::Coordination::V1beta1::LeaseList
    ...
    # create a Lease
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Coordination::V1beta1::LeaseSpec | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
