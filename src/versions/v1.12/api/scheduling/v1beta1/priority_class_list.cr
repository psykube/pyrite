...
module Pyrite
  ...
  class Api::Scheduling::V1beta1::PriorityClassList
    ...
    def create(value : Int32, description : String | Nil = nil, global_default : Bool | Nil = nil, metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
