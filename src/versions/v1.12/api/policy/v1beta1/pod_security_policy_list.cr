...
module Pyrite
  ...
  class Api::Policy::V1beta1::PodSecurityPolicyList
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Policy::V1beta1::PodSecurityPolicySpec | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
