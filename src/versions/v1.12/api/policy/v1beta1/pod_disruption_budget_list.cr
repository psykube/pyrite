...
module Pyrite
  ...
  class Api::Policy::V1beta1::PodDisruptionBudgetList
    ...
    ::YAML.mapping({
      ...
      items:       {type: Array(Api::Policy::V1beta1::PodDisruptionBudget), nilable: false, key: "items", getter: false, setter: false},
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Policy::V1beta1::PodDisruptionBudgetSpec | Nil = nil, status : Api::Policy::V1beta1::PodDisruptionBudgetStatus | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
