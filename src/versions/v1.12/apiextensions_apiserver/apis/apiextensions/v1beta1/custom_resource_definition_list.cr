...
module Pyrite
  ...
  class ApiextensionsApiserver::Apis::Apiextensions::V1beta1::CustomResourceDefinitionList
    ...
    def create(spec : ApiextensionsApiserver::Apis::Apiextensions::V1beta1::CustomResourceDefinitionSpec, metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, status : ApiextensionsApiserver::Apis::Apiextensions::V1beta1::CustomResourceDefinitionStatus | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
