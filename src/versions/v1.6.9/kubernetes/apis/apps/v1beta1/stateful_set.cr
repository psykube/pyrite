...
module Pyrite
  ...
  class Kubernetes::Apis::Apps::V1beta1::StatefulSet
    ...
    YAML.mapping({
      ...
      spec:        {type: Kubernetes::Apis::Apps::V1beta1::StatefulSetSpec, nilable: true, key: "spec"},
      status:      {type: Kubernetes::Apis::Apps::V1beta1::StatefulSetStatus, nilable: true, key: "status"},
    }, true)
  ...
  module Resources::Apps::V1beta1
    alias StatefulSet = Kubernetes::Apis::Apps::V1beta1::StatefulSet
  end
end
