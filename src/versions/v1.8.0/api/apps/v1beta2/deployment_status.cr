...
module Pyrite
  ...
  class Api::Apps::V1beta2::DeploymentStatus
    ...
    property conditions : Array(Api::Apps::V1beta2::DeploymentCondition) | Nil
    ...
    YAML.mapping({
      ...
      conditions:           {type: Array(Api::Apps::V1beta2::DeploymentCondition), nilable: true, key: "conditions", getter: false, setter: false},
