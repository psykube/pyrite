...
module Pyrite
  ...
  class Api::Autoscaling::V2beta1::HorizontalPodAutoscalerSpec
    ...
    def initialize(*, @max_replicas : Int32 | Nil = nil, @metrics : Array | Nil = nil, @min_replicas : Int32 | Nil = nil, @scale_target_ref : Api::Autoscaling::V2beta1::CrossVersionObjectReference | Nil = nil)
    end
  end
end
