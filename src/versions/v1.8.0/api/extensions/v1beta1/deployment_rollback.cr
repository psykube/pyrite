...
module Pyrite
  ...
  class Api::Extensions::V1beta1::DeploymentRollback
    ...
    def initialize(*, @api_version : String | Nil = nil, @kind : String | Nil = nil, @name : String | Nil = nil, @rollback_to : Api::Extensions::V1beta1::RollbackConfig | Nil = nil, @updated_annotations : Hash(String, String) | Nil = nil)
    end
  end
end
