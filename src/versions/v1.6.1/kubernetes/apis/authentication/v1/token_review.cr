...
module Pyrite
  ...
  class Kubernetes::Apis::Authentication::V1::TokenReview
    ...
    YAML.mapping({
      ...
      spec:        {type: Kubernetes::Apis::Authentication::V1::TokenReviewSpec, nilable: false, key: "spec"},
      status:      {type: Kubernetes::Apis::Authentication::V1::TokenReviewStatus, nilable: true, key: "status"},
    }, true)
    ...
    def initialize(*, @metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, @spec : Kubernetes::Apis::Authentication::V1::TokenReviewSpec | Nil = nil, @status : Kubernetes::Apis::Authentication::V1::TokenReviewStatus | Nil = nil)
    end
  end
