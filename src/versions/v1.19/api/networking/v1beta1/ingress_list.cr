...
module Pyrite
  ...
  class Api::Networking::V1beta1::IngressList
    ...
    # create an Ingress
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Networking::V1beta1::IngressSpec | Nil = nil, status : Api::Networking::V1beta1::IngressStatus | Nil = nil, context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end
