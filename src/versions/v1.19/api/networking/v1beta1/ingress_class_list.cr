...
module Pyrite
  ...
  class Api::Networking::V1beta1::IngressClassList
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Networking::V1beta1::IngressClassSpec | Nil = nil, context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end
