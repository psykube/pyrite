...
module Pyrite
  ...
  class Api::Networking::V1beta1::HTTPIngressPath < Kubernetes::Spec
    ...
    def initialize(*, @backend : Api::Networking::V1beta1::IngressBackend, @path : String | Nil = nil, @path_type : String | Nil = nil)
    end
  end
end
