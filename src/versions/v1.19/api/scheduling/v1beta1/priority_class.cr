...
module Pyrite
  ...
  class Api::Scheduling::V1beta1::PriorityClass
    ...
    @[::JSON::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("scheduling/v1beta1"))]
    @[::YAML::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("scheduling/v1beta1"))]
