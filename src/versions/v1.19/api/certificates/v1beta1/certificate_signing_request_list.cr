...
module Pyrite
  class Api::Certificates::V1beta1::CertificateSigningRequestList
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Certificates::V1beta1::CertificateSigningRequestSpec | Nil = nil, status : Api::Certificates::V1beta1::CertificateSigningRequestStatus | Nil = nil, context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end
