...
module Pyrite
  ...
  class Api::Admissionregistration::V1::ValidatingWebhookConfiguration
    ...
    @[::JSON::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("admissionregistration/v1"))]
    @[::YAML::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("admissionregistration/v1"))]
