...
module Pyrite
  ...
  class Api::Core::V1::ContainerStatus
    ...
    def initialize(*, @container_id : String | Nil = nil, @image : String, @image_id : String, @last_state : Api::Core::V1::ContainerState | Nil = nil, @name : String, @ready : Bool, @restart_count : Int32, @started : Bool | Nil = nil, @state : Api::Core::V1::ContainerState | Nil = nil)
    end
  end
end
