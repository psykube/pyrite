...
module Pyrite
  ...
  class Api::Core::V1::PersistentVolumeClaimList
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Core::V1::PersistentVolumeClaimSpec | Nil = nil, status : Api::Core::V1::PersistentVolumeClaimStatus | Nil = nil, context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end
