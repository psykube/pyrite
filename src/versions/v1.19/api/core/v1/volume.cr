...
module Pyrite
  ...
  class Api::Core::V1::Volume
    ...
    property ephemeral : Api::Core::V1::EphemeralVolumeSource | Nil
    ...
    ::YAML.mapping({
      ...
      ephemeral:               {type: Api::Core::V1::EphemeralVolumeSource, nilable: true, key: "ephemeral", getter: false, setter: false},
