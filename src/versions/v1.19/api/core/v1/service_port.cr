...
module Pyrite
  ...
  class Api::Core::V1::ServicePort
    ...
    def initialize(*, @port : Int32, @app_protocol : String | Nil = nil, @name : String | Nil = nil, @node_port : Int32 | Nil = nil, @protocol : String | Nil = nil, @target_port : Int32 | String | Nil = nil)
    end
  end
end
