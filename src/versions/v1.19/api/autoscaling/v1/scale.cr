...
module Pyrite
  ...
  class Api::Autoscaling::V1::Scale
    ...
    def replace_core_v1_replication_controller_scale(context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end

    # partially update scale of the specified ReplicationController
    def patch_core_v1_replication_controller_scale(context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil, force : Bool | Nil = nil)
    end
    ...
    def replace_apps_v1_deployment_scale(context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end

    # partially update scale of the specified Deployment
    def patch_apps_v1_deployment_scale(context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil, force : Bool | Nil = nil)
    end
    ...
    def replace_apps_v1_replica_set_scale(context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end

    # partially update scale of the specified ReplicaSet
    def patch_apps_v1_replica_set_scale(context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil, force : Bool | Nil = nil)
    end
    ...
    def replace_apps_v1_stateful_set_scale(context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end

    # partially update scale of the specified StatefulSet
    def patch_apps_v1_stateful_set_scale(context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil, force : Bool | Nil = nil)
    end
  end
