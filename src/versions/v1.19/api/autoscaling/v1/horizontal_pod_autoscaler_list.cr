...
module Pyrite
  ...
  class Api::Autoscaling::V1::HorizontalPodAutoscalerList
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Autoscaling::V1::HorizontalPodAutoscalerSpec | Nil = nil, status : Api::Autoscaling::V1::HorizontalPodAutoscalerStatus | Nil = nil, context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end
