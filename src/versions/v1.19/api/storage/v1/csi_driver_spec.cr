...
module Pyrite
  ...
  class Api::Storage::V1::CSIDriverSpec < Kubernetes::Spec
    ...
    def initialize(*, @attach_required : Bool | Nil = nil, @fs_group_policy : String | Nil = nil, @pod_info_on_mount : Bool | Nil = nil, @storage_capacity : Bool | Nil = nil, @volume_lifecycle_modes : Array | Nil = nil)
    end
  end
end
