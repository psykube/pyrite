...
module Pyrite
  ...
  class Api::Authorization::V1beta1::SelfSubjectAccessReviewSpec < Kubernetes::Spec
    ...
    def initialize(*, @non_resource_attributes : Api::Authorization::V1beta1::NonResourceAttributes | Nil = nil, @resource_attributes : Api::Authorization::V1beta1::ResourceAttributes | Nil = nil)
    end
  end
end
