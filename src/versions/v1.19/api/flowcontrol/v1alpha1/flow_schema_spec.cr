...
module Pyrite
  ...
  class Api::Flowcontrol::V1alpha1::FlowSchemaSpec
    ...
    def initialize(*, @distinguisher_method : Api::Flowcontrol::V1alpha1::FlowDistinguisherMethod | Nil = nil, @matching_precedence : Int32 | Nil = nil, @priority_level_configuration : Api::Flowcontrol::V1alpha1::PriorityLevelConfigurationReference, @rules : Array | Nil = nil)
    end
  end
end
