...
module Pyrite
  ...
  class KubeAggregator::Apis::Apiregistration::V1beta1::APIServiceSpec
    ...
    property service : KubeAggregator::Apis::Apiregistration::V1beta1::ServiceReference | Nil
    ...
    ::YAML.mapping({
      ...
      service:                  {type: KubeAggregator::Apis::Apiregistration::V1beta1::ServiceReference, nilable: true, key: "service", getter: false, setter: false},
    ...
    def initialize(*, @group_priority_minimum : Int32, @version_priority : Int32, @ca_bundle : String | Nil = nil, @group : String | Nil = nil, @insecure_skip_tls_verify : Bool | Nil = nil, @service : KubeAggregator::Apis::Apiregistration::V1beta1::ServiceReference | Nil = nil, @version : String | Nil = nil)
    end
  end
end
