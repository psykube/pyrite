...
module Pyrite
  ...
  class Kubernetes::Apis::Extensions::V1beta1::DaemonSet
    ...
    YAML.mapping({
      ...
      spec:        {type: Kubernetes::Apis::Extensions::V1beta1::DaemonSetSpec, nilable: true, key: "spec"},
      status:      {type: Kubernetes::Apis::Extensions::V1beta1::DaemonSetStatus, nilable: true, key: "status"},
    }, true)
