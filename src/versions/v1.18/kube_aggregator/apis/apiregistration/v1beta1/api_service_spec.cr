...
module Pyrite
  ...
  class KubeAggregator::Apis::Apiregistration::V1beta1::APIServiceSpec < Kubernetes::Spec
    ...
    def initialize(*, @ca_bundle : String | Nil = nil, @group : String | Nil = nil, @group_priority_minimum : Int32, @insecure_skip_tls_verify : Bool | Nil = nil, @service : KubeAggregator::Apis::Apiregistration::V1beta1::ServiceReference | Nil = nil, @version : String | Nil = nil, @version_priority : Int32)
    end
  end
end
