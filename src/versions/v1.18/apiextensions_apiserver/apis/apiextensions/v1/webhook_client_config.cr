...
module Pyrite
  ...
  class ApiextensionsApiserver::Apis::Apiextensions::V1::WebhookClientConfig
    ...
    property service : ApiextensionsApiserver::Apis::Apiextensions::V1::ServiceReference | Nil
    ...
    ::YAML.mapping({
      ...
      service:   {type: ApiextensionsApiserver::Apis::Apiextensions::V1::ServiceReference, nilable: true, key: "service", getter: false, setter: false},
    ...
    def initialize(*, @ca_bundle : String | Nil = nil, @service : ApiextensionsApiserver::Apis::Apiextensions::V1::ServiceReference | Nil = nil, @url : String | Nil = nil)
    end
  end
end
