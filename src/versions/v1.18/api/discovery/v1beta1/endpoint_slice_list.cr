...
module Pyrite
  ...
  class Api::Discovery::V1beta1::EndpointSliceList
    ...
    def create(address_type : String, endpoints : Array, metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, ports : Array | Nil = nil, context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end
