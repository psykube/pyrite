...
module Pyrite
  ...
  class Api::Autoscaling::V2beta2::HorizontalPodAutoscalerStatus
    ...
    ::YAML.mapping({
      conditions:          {type: Array(Api::Autoscaling::V2beta2::HorizontalPodAutoscalerCondition), nilable: false, key: "conditions", getter: false, setter: false},
      current_metrics:     {type: Array(Api::Autoscaling::V2beta2::MetricStatus), nilable: true, key: "currentMetrics", getter: false, setter: false},
