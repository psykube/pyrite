...
module Pyrite
  ...
  class Api::Storage::V1alpha1::VolumeAttachment
    ...
    @[::JSON::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("storage/v1alpha1"))]
    @[::YAML::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("storage/v1alpha1"))]
