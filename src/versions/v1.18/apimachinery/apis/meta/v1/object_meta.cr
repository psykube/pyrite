...
module Pyrite
  ...
  class Apimachinery::Apis::Meta::V1::ObjectMeta
    ...
    ::YAML.mapping({
      ...
      managed_fields:                {type: Array(Apimachinery::Apis::Meta::V1::ManagedFieldsEntry), nilable: true, key: "managedFields", getter: false, setter: false},
    ...
    def initialize(*, @annotations : Hash(String, String) | Nil = nil, @cluster_name : String | Nil = nil, @creation_timestamp : Time | Nil = nil, @deletion_grace_period_seconds : Int32 | Nil = nil, @deletion_timestamp : Time | Nil = nil, @finalizers : Array | Nil = nil, @generate_name : String | Nil = nil, @generation : Int32 | Nil = nil, @labels : Hash(String, String) | Nil = nil, @managed_fields : Array | Nil = nil, @name : String | Nil = nil, @namespace : String | Nil = nil, @owner_references : Array | Nil = nil, @resource_version : String | Nil = nil, @self_link : String | Nil = nil, @uid : String | Nil = nil)
    end
  end
end
