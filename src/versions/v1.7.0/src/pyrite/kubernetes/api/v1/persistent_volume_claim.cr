...
module Pyrite
  ...
  class Kubernetes::Api::V1::PersistentVolumeClaim
    ...
    YAML.mapping({
      ...
      spec:        {type: Kubernetes::Api::V1::PersistentVolumeClaimSpec, nilable: true, key: "spec"},
      status:      {type: Kubernetes::Api::V1::PersistentVolumeClaimStatus, nilable: true, key: "status"},
    }, true)
