...
module Pyrite
  ...
  class Api::Node::V1beta1::RuntimeClassList
    ...
    def create(handler : String, metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end
