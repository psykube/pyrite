...
module Pyrite
  ...
  class Api::Core::V1::EndpointsList
    ...
    # create Endpoints
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, subsets : Array | Nil = nil, context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end
