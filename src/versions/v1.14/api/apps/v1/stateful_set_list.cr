...
module Pyrite
  ...
  class Api::Apps::V1::StatefulSetList
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Apps::V1::StatefulSetSpec | Nil = nil, status : Api::Apps::V1::StatefulSetStatus | Nil = nil, context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end
