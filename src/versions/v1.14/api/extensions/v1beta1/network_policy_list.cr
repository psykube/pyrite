...
module Pyrite
  ...
  class Api::Extensions::V1beta1::NetworkPolicyList
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Extensions::V1beta1::NetworkPolicySpec | Nil = nil, context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end
