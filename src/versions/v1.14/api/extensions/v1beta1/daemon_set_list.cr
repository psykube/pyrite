...
module Pyrite
  ...
  class Api::Extensions::V1beta1::DaemonSetList
    ...
    # create a DaemonSet
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Extensions::V1beta1::DaemonSetSpec | Nil = nil, status : Api::Extensions::V1beta1::DaemonSetStatus | Nil = nil, context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end
