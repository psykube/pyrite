...
module Pyrite
  ...
  class Api::Admissionregistration::V1beta1::ValidatingWebhookConfiguration
    ...
    @[::JSON::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("admissionregistration/v1beta1"))]
    @[::YAML::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("admissionregistration/v1beta1"))]
