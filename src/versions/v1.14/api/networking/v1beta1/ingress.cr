...
module Pyrite
  ...
  class Api::Networking::V1beta1::Ingress
    ...
    @[::JSON::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("networking/v1beta1"))]
    @[::YAML::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("networking/v1beta1"))]
