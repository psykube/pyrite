...
module Pyrite
  ...
  class Api::Auditregistration::V1alpha1::WebhookClientConfig
    ...
    property service : Api::Auditregistration::V1alpha1::ServiceReference | Nil
    ...
    ::YAML.mapping({
      ...
      service:   {type: Api::Auditregistration::V1alpha1::ServiceReference, nilable: true, key: "service", getter: false, setter: false},
    ...
    def initialize(*, @ca_bundle : String | Nil = nil, @service : Api::Auditregistration::V1alpha1::ServiceReference | Nil = nil, @url : String | Nil = nil)
    end
  end
end
