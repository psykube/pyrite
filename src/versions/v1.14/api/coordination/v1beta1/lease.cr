...
module Pyrite
  ...
  class Api::Coordination::V1beta1::Lease
    ...
    @[::JSON::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("coordination/v1beta1"))]
    @[::YAML::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("coordination/v1beta1"))]
