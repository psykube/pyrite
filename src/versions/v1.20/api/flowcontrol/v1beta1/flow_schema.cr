...
module Pyrite
  ...
  class Api::Flowcontrol::V1beta1::FlowSchema
    ...
    @[::JSON::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("flowcontrol/v1beta1"))]
    @[::YAML::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("flowcontrol/v1beta1"))]
