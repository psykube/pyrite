...
module Pyrite
  ...
  class Api::Core::V1::CSIPersistentVolumeSource
    ...
    def initialize(*, @controller_expand_secret_ref : Api::Core::V1::SecretReference | Nil = nil, @controller_publish_secret_ref : Api::Core::V1::SecretReference | Nil = nil, @driver : String, @fs_type : String | Nil = nil, @node_publish_secret_ref : Api::Core::V1::SecretReference | Nil = nil, @node_stage_secret_ref : Api::Core::V1::SecretReference | Nil = nil, @read_only : Bool | Nil = nil, @volume_attributes : Hash(String, String) | Nil = nil, @volume_handle : String)
    end
  end
end
