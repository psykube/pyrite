...
module Pyrite
  ...
  class Api::Apiserverinternal::V1alpha1::StorageVersion
    ...
    @[::JSON::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("apiserverinternal/v1alpha1"))]
    @[::YAML::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("apiserverinternal/v1alpha1"))]
