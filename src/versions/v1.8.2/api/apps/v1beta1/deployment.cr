...
module Pyrite
  ...
  class Api::Apps::V1beta1::Deployment
    ...
    YAML.mapping({
      ...
      spec:        {type: Api::Apps::V1beta1::DeploymentSpec, nilable: true, key: "spec", getter: false, setter: false},
      status:      {type: Api::Apps::V1beta1::DeploymentStatus, nilable: true, key: "status", getter: false, setter: false},
    }, true)
  ...
  module Resources::Io::K8s::Api::Apps::V1beta1
    alias Deployment = Api::Apps::V1beta1::Deployment
  end
end
