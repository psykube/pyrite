...
module Pyrite
  ...
  class Api::Core::V1::ScaleIOVolumeSource
    ...
    YAML.mapping({
      ...
      secret_ref:        {type: Api::Core::V1::LocalObjectReference, nilable: false, key: "secretRef", getter: false, setter: false},
    ...
    def initialize(*, @fs_type : String | Nil = nil, @gateway : String | Nil = nil, @protection_domain : String | Nil = nil, @read_only : Bool | Nil = nil, @secret_ref : Api::Core::V1::LocalObjectReference | Nil = nil, @ssl_enabled : Bool | Nil = nil, @storage_mode : String | Nil = nil, @storage_pool : String | Nil = nil, @system : String | Nil = nil, @volume_name : String | Nil = nil)
    end
  end
end
