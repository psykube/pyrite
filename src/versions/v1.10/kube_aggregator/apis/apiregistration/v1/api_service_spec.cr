...
module Pyrite
  ...
  class KubeAggregator::Apis::Apiregistration::V1::APIServiceSpec
    ...
    def initialize(*, @ca_bundle : String, @group_priority_minimum : Int32, @service : KubeAggregator::Apis::Apiregistration::V1::ServiceReference, @version_priority : Int32, @group : String | Nil = nil, @insecure_skip_tls_verify : Bool | Nil = nil, @version : String | Nil = nil)
    end
  end
end
