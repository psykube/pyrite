...
module Pyrite
  ...
  class KubeAggregator::Apis::Apiregistration::V1::APIServiceSpec
    ...
    def initialize(*, @ca_bundle : String | Nil = nil, @group : String | Nil = nil, @group_priority_minimum : Int32 | Nil = nil, @insecure_skip_tls_verify : Bool | Nil = nil, @service : KubeAggregator::Apis::Apiregistration::V1::ServiceReference | Nil = nil, @version : String | Nil = nil, @version_priority : Int32 | Nil = nil)
    end
  end
end
