...
module Pyrite
  ...
  class ApiextensionsApiserver::Apis::Apiextensions::V1beta1::CustomResourceDefinitionNames
    ...
    def initialize(*, @categories : Array | Nil = nil, @kind : String | Nil = nil, @list_kind : String | Nil = nil, @plural : String | Nil = nil, @short_names : Array | Nil = nil, @singular : String | Nil = nil)
    end
  end
end
