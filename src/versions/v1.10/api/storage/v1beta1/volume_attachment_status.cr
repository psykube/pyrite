...
module Pyrite
  ...
  class Api::Storage::V1beta1::VolumeAttachmentStatus
    ...
    def initialize(*, @attached : Bool, @attach_error : Api::Storage::V1beta1::VolumeError | Nil = nil, @attachment_metadata : Hash(String, String) | Nil = nil, @detach_error : Api::Storage::V1beta1::VolumeError | Nil = nil)
    end
  end
end
