...
module Pyrite
  ...
  class Api::Storage::V1beta1::StorageClassList
    ...
    def create(provisioner : String, allow_volume_expansion : Bool | Nil = nil, metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, mount_options : Array | Nil = nil, parameters : Hash(String, String) | Nil = nil, reclaim_policy : String | Nil = nil, volume_binding_mode : String | Nil = nil, context : String | Nil = nil)
    end
