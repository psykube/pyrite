...
module Pyrite
  ...
  class Api::Apps::V1beta1::StatefulSetStatus
    ...
    property conditions : Array(Api::Apps::V1beta1::StatefulSetCondition) | Nil
    ...
    ::YAML.mapping({
      ...
      conditions:          {type: Array(Api::Apps::V1beta1::StatefulSetCondition), nilable: true, key: "conditions", getter: false, setter: false},
