...
module Pyrite
  ...
  class Api::Extensions::V1beta1::IngressList
    ...
    # create an Ingress
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Extensions::V1beta1::IngressSpec | Nil = nil, status : Api::Extensions::V1beta1::IngressStatus | Nil = nil, context : String | Nil = nil)
    end
