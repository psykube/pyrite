...
module Pyrite
  ...
  class Api::Core::V1::PodSecurityContext
    ...
    def initialize(*, @fs_group : Int32 | Nil = nil, @run_as_group : Int32 | Nil = nil, @run_as_non_root : Bool | Nil = nil, @run_as_user : Int32 | Nil = nil, @se_linux_options : Api::Core::V1::SELinuxOptions | Nil = nil, @supplemental_groups : Array | Nil = nil)
    end
  end
end
