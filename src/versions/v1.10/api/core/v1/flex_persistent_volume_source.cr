...
module Pyrite
  ...
  class Api::Core::V1::FlexPersistentVolumeSource
    ...
    def initialize(*, @driver : String, @fs_type : String | Nil = nil, @options : Hash(String, String) | Nil = nil, @read_only : Bool | Nil = nil, @secret_ref : Api::Core::V1::SecretReference | Nil = nil)
    end
  end
end
