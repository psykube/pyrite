...
module Pyrite
  ...
  class Api::Core::V1::PersistentVolumeSpec
    ...
    def initialize(*, @access_modes : Array | Nil = nil, @aws_elastic_block_store : Api::Core::V1::AWSElasticBlockStoreVolumeSource | Nil = nil, @azure_disk : Api::Core::V1::AzureDiskVolumeSource | Nil = nil, @azure_file : Api::Core::V1::AzureFilePersistentVolumeSource | Nil = nil, @capacity : Hash(String, String) | Nil = nil, @cephfs : Api::Core::V1::CephFSPersistentVolumeSource | Nil = nil, @cinder : Api::Core::V1::CinderVolumeSource | Nil = nil, @claim_ref : Api::Core::V1::ObjectReference | Nil = nil, @csi : Api::Core::V1::CSIPersistentVolumeSource | Nil = nil, @fc : Api::Core::V1::FCVolumeSource | Nil = nil, @flex_volume : Api::Core::V1::FlexPersistentVolumeSource | Nil = nil, @flocker : Api::Core::V1::FlockerVolumeSource | Nil = nil, @gce_persistent_disk : Api::Core::V1::GCEPersistentDiskVolumeSource | Nil = nil, @glusterfs : Api::Core::V1::GlusterfsVolumeSource | Nil = nil, @host_path : Api::Core::V1::HostPathVolumeSource | Nil = nil, @iscsi : Api::Core::V1::ISCSIPersistentVolumeSource | Nil = nil, @local : Api::Core::V1::LocalVolumeSource | Nil = nil, @mount_options : Array | Nil = nil, @nfs : Api::Core::V1::NFSVolumeSource | Nil = nil, @node_affinity : Api::Core::V1::VolumeNodeAffinity | Nil = nil, @persistent_volume_reclaim_policy : String | Nil = nil, @photon_persistent_disk : Api::Core::V1::PhotonPersistentDiskVolumeSource | Nil = nil, @portworx_volume : Api::Core::V1::PortworxVolumeSource | Nil = nil, @quobyte : Api::Core::V1::QuobyteVolumeSource | Nil = nil, @rbd : Api::Core::V1::RBDPersistentVolumeSource | Nil = nil, @scale_io : Api::Core::V1::ScaleIOPersistentVolumeSource | Nil = nil, @storage_class_name : String | Nil = nil, @storageos : Api::Core::V1::StorageOSPersistentVolumeSource | Nil = nil, @volume_mode : String | Nil = nil, @vsphere_volume : Api::Core::V1::VsphereVirtualDiskVolumeSource | Nil = nil)
    end
  end
end
