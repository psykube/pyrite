...
module Pyrite
  ...
  class Api::Rbac::V1::ClusterRoleBinding
    ...
    def create_rbac_authorization_v1_cluster_role_binding(context : String | Nil = nil)
    end
    ...
    def replace_rbac_authorization_v1_cluster_role_binding(context : String | Nil = nil)
    end

    # partially update the specified ClusterRoleBinding
    def patch_rbac_authorization_v1_cluster_role_binding(context : String | Nil = nil)
    end

    # delete a ClusterRoleBinding
    def delete_rbac_authorization_v1_cluster_role_binding(api_version : String | Nil = nil, grace_period_seconds : Int32 | Nil = nil, kind : String | Nil = nil, orphan_dependents : Bool | Nil = nil, preconditions : Apimachinery::Apis::Meta::V1::Preconditions | Nil = nil, propagation_policy : String | Nil = nil, context : String | Nil = nil)
    end
  end
