...
module Pyrite
  ...
  class Api::Authorization::V1::SelfSubjectAccessReview < Kubernetes::Object
    @api_version = "authorization.k8s.io/v1"
    @kind = "SelfSubjectAccessReview"

    def self.new(pull : ::JSON::PullParser)
      previous_def(pull).tap do |instance|
        unless instance.api_version == "authorization.k8s.io/v1" && instance.kind == "SelfSubjectAccessReview"
