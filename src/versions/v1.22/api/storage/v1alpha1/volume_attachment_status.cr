...
module Pyrite
  ...
  class Api::Storage::V1alpha1::VolumeAttachmentStatus < Kubernetes::Spec
    ...
    def initialize(*, @attach_error : Api::Storage::V1alpha1::VolumeError | Nil = nil, @attached : Bool, @attachment_metadata : Hash(String, String) | Nil = nil, @detach_error : Api::Storage::V1alpha1::VolumeError | Nil = nil)
    end
  end
end
