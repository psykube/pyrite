...
module Pyrite
  ...
  class Api::Admissionregistration::V1::MutatingWebhookConfiguration < Kubernetes::Object
    @api_version = "admissionregistration.k8s.io/v1"
    @kind = "MutatingWebhookConfiguration"

    def self.new(pull : ::JSON::PullParser)
      previous_def(pull).tap do |instance|
        unless instance.api_version == "admissionregistration.k8s.io/v1" && instance.kind == "MutatingWebhookConfiguration"
