...
module Pyrite
  ...
  class Api::Discovery::V1::EndpointSlice < Kubernetes::Object
    @api_version = "discovery.k8s.io/v1"
    @kind = "EndpointSlice"

    def self.new(pull : ::JSON::PullParser)
      previous_def(pull).tap do |instance|
        unless instance.api_version == "discovery.k8s.io/v1" && instance.kind == "EndpointSlice"
    ...
    property endpoints : Array(Api::Discovery::V1::Endpoint)
