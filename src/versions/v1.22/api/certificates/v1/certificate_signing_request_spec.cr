...
module Pyrite
  ...
  class Api::Certificates::V1::CertificateSigningRequestSpec < Kubernetes::Spec
    ...
    def initialize(*, @expiration_seconds : Int32 | Nil = nil, @extra : Hash(String, String) | Nil = nil, @groups : Array | Nil = nil, @request : String, @signer_name : String, @uid : String | Nil = nil, @usages : Array | Nil = nil, @username : String | Nil = nil)
    end
  end
end
