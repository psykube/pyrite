...
module Pyrite
  ...
  class Api::Autoscaling::V2beta1::MetricStatus < Kubernetes::Spec
    ...
    def initialize(*, @container_resource : Api::Autoscaling::V2beta1::ContainerResourceMetricStatus | Nil = nil, @external : Api::Autoscaling::V2beta1::ExternalMetricStatus | Nil = nil, @object : Api::Autoscaling::V2beta1::ObjectMetricStatus | Nil = nil, @pods : Api::Autoscaling::V2beta1::PodsMetricStatus | Nil = nil, @resource : Api::Autoscaling::V2beta1::ResourceMetricStatus | Nil = nil, @type : String)
    end
  end
end
