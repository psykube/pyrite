...
module Pyrite
  ...
  class Api::Core::V1::StorageOSVolumeSource < Kubernetes::Spec
    ...
    def initialize(*, @fs_type : String | Nil = nil, @read_only : Bool | Nil = nil, @secret_ref : Api::Core::V1::LocalObjectReference | Nil = nil, @volume_name : String | Nil = nil, @volume_namespace : String | Nil = nil)
    end
  end
end
