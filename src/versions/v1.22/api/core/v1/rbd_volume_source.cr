...
module Pyrite
  ...
  class Api::Core::V1::RBDVolumeSource < Kubernetes::Spec
    ...
    def initialize(*, @fs_type : String | Nil = nil, @image : String, @keyring : String | Nil = nil, @monitors : Array, @pool : String | Nil = nil, @read_only : Bool | Nil = nil, @secret_ref : Api::Core::V1::LocalObjectReference | Nil = nil, @user : String | Nil = nil)
    end
  end
end
