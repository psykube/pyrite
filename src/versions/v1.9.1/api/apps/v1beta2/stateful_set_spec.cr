...
module Pyrite
  ...
  class Api::Apps::V1beta2::StatefulSetSpec
    ...
    def initialize(*, @pod_management_policy : String | Nil = nil, @replicas : Int32 | Nil = nil, @revision_history_limit : Int32 | Nil = nil, @selector : Apimachinery::Apis::Meta::V1::LabelSelector | Nil = nil, @service_name : String | Nil = nil, @template : Api::Core::V1::PodTemplateSpec | Nil = nil, @update_strategy : Api::Apps::V1beta2::StatefulSetUpdateStrategy | Nil = nil, @volume_claim_templates : Array | Nil = nil)
    end
  end
end
