...
module Pyrite
  ...
  class Kubernetes::Apis::Autoscaling::V1::Scale
    ...
    YAML.mapping({
      ...
      spec:        {type: Kubernetes::Apis::Autoscaling::V1::ScaleSpec, nilable: true, key: "spec"},
      status:      {type: Kubernetes::Apis::Autoscaling::V1::ScaleStatus, nilable: true, key: "status"},
    }, true)
