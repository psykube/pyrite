...
module Pyrite
  ...
  class Api::Batch::V2alpha1::CronJobSpec
    ...
    def initialize(*, @concurrency_policy : String | Nil = nil, @failed_jobs_history_limit : Int32 | Nil = nil, @job_template : Api::Batch::V2alpha1::JobTemplateSpec | Nil = nil, @schedule : String | Nil = nil, @starting_deadline_seconds : Int32 | Nil = nil, @successful_jobs_history_limit : Int32 | Nil = nil, @suspend : Bool | Nil = nil)
    end
  end
end
