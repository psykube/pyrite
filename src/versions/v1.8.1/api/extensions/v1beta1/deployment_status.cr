...
module Pyrite
  ...
  class Api::Extensions::V1beta1::DeploymentStatus
    ...
    property conditions : Array(Api::Extensions::V1beta1::DeploymentCondition) | Nil
    ...
    YAML.mapping({
      ...
      conditions:           {type: Array(Api::Extensions::V1beta1::DeploymentCondition), nilable: true, key: "conditions", getter: false, setter: false},
