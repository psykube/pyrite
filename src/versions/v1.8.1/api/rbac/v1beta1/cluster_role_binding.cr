...
module Pyrite
  ...
  class Api::Rbac::V1beta1::ClusterRoleBinding
    ...
    def initialize(*, @metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, @role_ref : Api::Rbac::V1beta1::RoleRef | Nil = nil, @subjects : Array | Nil = nil)
    end
  end

  module Resources::Io::K8s::Api::Rbac::V1beta1
    alias ClusterRoleBinding = Api::Rbac::V1beta1::ClusterRoleBinding
  end
end
