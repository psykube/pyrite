...
module Pyrite
  ...
  class Kubernetes::Api::V1::Affinity
    ...
    YAML.mapping({
      node_affinity:     {type: Kubernetes::Api::V1::NodeAffinity, nilable: true, key: "nodeAffinity"},
      pod_affinity:      {type: Kubernetes::Api::V1::PodAffinity, nilable: true, key: "podAffinity"},
      pod_anti_affinity: {type: Kubernetes::Api::V1::PodAntiAffinity, nilable: true, key: "podAntiAffinity"},
    }, true)
