...
module Pyrite
  ...
  class KubeAggregator::Apis::Apiregistration::V1beta1::APIServiceSpec
    ...
    def initialize(*, @group_priority_minimum : Int32, @service : KubeAggregator::Apis::Apiregistration::V1beta1::ServiceReference, @version_priority : Int32, @ca_bundle : String | Nil = nil, @group : String | Nil = nil, @insecure_skip_tls_verify : Bool | Nil = nil, @version : String | Nil = nil)
    end
  end
end
