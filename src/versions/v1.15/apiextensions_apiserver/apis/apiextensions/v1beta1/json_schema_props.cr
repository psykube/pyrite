...
property x-kubernetes-embedded-resource : Bool | Nil
...
#      - type: string
#    - ... zero or more
property x-kubernetes-int-or-string : Bool | Nil

# x-kubernetes-preserve-unknown-fields stops the API server decoding step from pruning fields which are not specified in the validation schema. This affects fields recursively, but switches back to normal pruning behaviour if nested properties or additionalProperties are specified in the schema. This can either be true or undefined. False is forbidden.
property x-kubernetes-preserve-unknown-fields : Bool | Nil
...
x-kubernetes-embedded-resource: { type: Bool, nilable: true, key: "x-kubernetes-embedded-resource", getter: false, setter: false },
x-kubernetes-int-or-string: { type: Bool, nilable: true, key: "x-kubernetes-int-or-string", getter: false, setter: false },
x-kubernetes-preserve-unknown-fields: { type: Bool, nilable: true, key: "x-kubernetes-preserve-unknown-fields", getter: false, setter: false }
}, true)
