...
module Pyrite
  ...
  class Api::Apps::V1::ReplicaSetList
    ...
    # create a ReplicaSet
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Apps::V1::ReplicaSetSpec | Nil = nil, status : Api::Apps::V1::ReplicaSetStatus | Nil = nil, context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end
