...
module Pyrite
  ...
  class Api::Autoscaling::V2beta2::HorizontalPodAutoscalerSpec
    ...
    def initialize(*, @max_replicas : Int32, @scale_target_ref : Api::Autoscaling::V2beta2::CrossVersionObjectReference, @metrics : Array | Nil = nil, @min_replicas : Int32 | Nil = nil)
    end
  end
end
