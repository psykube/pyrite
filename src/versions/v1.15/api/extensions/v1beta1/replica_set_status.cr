...
module Pyrite
  ...
  class Api::Extensions::V1beta1::ReplicaSetStatus
    ...
    ::YAML.mapping({
      ...
      conditions:             {type: Array(Api::Extensions::V1beta1::ReplicaSetCondition), nilable: true, key: "conditions", getter: false, setter: false},
