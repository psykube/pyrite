...
module Pyrite
  ...
  class Kubernetes::Apis::Batch::V2alpha1::CronJob
    ...
    YAML.mapping({
      ...
      spec:        {type: Kubernetes::Apis::Batch::V2alpha1::CronJobSpec, nilable: true, key: "spec"},
      status:      {type: Kubernetes::Apis::Batch::V2alpha1::CronJobStatus, nilable: true, key: "status"},
    }, true)
