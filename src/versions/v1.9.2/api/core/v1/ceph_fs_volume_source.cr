...
module Pyrite
  ...
  class Api::Core::V1::CephFSVolumeSource
    ...
    def initialize(*, @monitors : Array | Nil = nil, @path : String | Nil = nil, @read_only : Bool | Nil = nil, @secret_file : String | Nil = nil, @secret_ref : Api::Core::V1::LocalObjectReference | Nil = nil, @user : String | Nil = nil)
    end
  end
end
