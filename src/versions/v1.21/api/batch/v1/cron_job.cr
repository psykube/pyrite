...
module Pyrite
  ...
  class Api::Batch::V1::CronJob < Kubernetes::Object
    @api_version = "batch/v1"
    @kind = "CronJob"

    def self.new(pull : ::JSON::PullParser)
      super(pull).tap do |instance|
        unless instance.api_version == "batch/v1" && instance.kind == "CronJob"
    ...
    @[::JSON::Field(key: "spec")]
    @[::YAML::Field(key: "spec")]
    property spec : Api::Batch::V1::CronJobSpec | Nil
    ...
    property status : Api::Batch::V1::CronJobStatus | Nil

    def initialize(*, @metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, @spec : Api::Batch::V1::CronJobSpec | Nil = nil, @status : Api::Batch::V1::CronJobStatus | Nil = nil)
    end
  end
end
