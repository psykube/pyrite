...
module Pyrite
  ...
  class Kubernetes::Apis::Authorization::V1::LocalSubjectAccessReview
  ...
  module Resources::Authorization::V1
    alias LocalSubjectAccessReview = ::Pyrite::Kubernetes::Apis::Authorization::V1::LocalSubjectAccessReview
  end
end
