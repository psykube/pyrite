...
module Pyrite
  ...
  class Kubernetes::Api::V1::PersistentVolumeSpec
    ...
    YAML.mapping({
      ...
      local:                            {type: Kubernetes::Api::V1::LocalVolumeSource, nilable: true, key: "local", getter: false, setter: false},
      ...
      storageos:                        {type: Kubernetes::Api::V1::StorageOSPersistentVolumeSource, nilable: true, key: "storageos", getter: false, setter: false},
