...
module Pyrite
  ...
  class Api::Autoscaling::V2beta1::MetricStatus
    ...
    def initialize(*, @object : Api::Autoscaling::V2beta1::ObjectMetricStatus | Nil = nil, @pods : Api::Autoscaling::V2beta1::PodsMetricStatus | Nil = nil, @resource : Api::Autoscaling::V2beta1::ResourceMetricStatus | Nil = nil, @type : String | Nil = nil)
    end
  end
end
