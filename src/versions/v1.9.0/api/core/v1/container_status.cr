...
module Pyrite
  ...
  class Api::Core::V1::ContainerStatus
    ...
    def initialize(*, @container_id : String | Nil = nil, @image : String | Nil = nil, @image_id : String | Nil = nil, @last_state : Api::Core::V1::ContainerState | Nil = nil, @name : String | Nil = nil, @ready : Bool | Nil = nil, @restart_count : Int32 | Nil = nil, @state : Api::Core::V1::ContainerState | Nil = nil)
    end
  end
end
