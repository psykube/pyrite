...
module Pyrite
  ...
  class Kubernetes::Apis::Rbac::V1beta1::RoleBinding
    ...
    YAML.mapping({
      ...
      role_ref:    {type: Kubernetes::Apis::Rbac::V1beta1::RoleRef, nilable: false, key: "roleRef"},
      subjects:    {type: Array(Kubernetes::Apis::Rbac::V1beta1::Subject), nilable: false, key: "subjects"},
    }, true)
  ...
  module Resources::Rbac::V1beta1
    alias RoleBinding = Kubernetes::Apis::Rbac::V1beta1::RoleBinding
  end
end
