...
module Pyrite
  ...
  class Kubernetes::Api::V1::StorageOSPersistentVolumeSource
    ...
    property secret_ref : Kubernetes::Api::V1::ObjectReference | Nil
    ...
    YAML.mapping({
      ...
      secret_ref:       {type: Kubernetes::Api::V1::ObjectReference, nilable: true, key: "secretRef", getter: false, setter: false},
    ...
    def initialize(*, @fs_type : String | Nil = nil, @read_only : Bool | Nil = nil, @secret_ref : Kubernetes::Api::V1::ObjectReference | Nil = nil, @volume_name : String | Nil = nil, @volume_namespace : String | Nil = nil)
    end
  end
end
