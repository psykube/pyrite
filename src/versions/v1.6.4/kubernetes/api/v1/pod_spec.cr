...
module Pyrite
  ...
  class Kubernetes::Api::V1::PodSpec
    ...
    YAML.mapping({
      ...
      affinity:                         {type: Kubernetes::Api::V1::Affinity, nilable: true, key: "affinity"},
      automount_service_account_token:  {type: Bool, nilable: true, key: "automountServiceAccountToken"},
      containers:                       {type: Array(Kubernetes::Api::V1::Container), nilable: false, key: "containers"},
      ...
      init_containers:                  {type: Array(Kubernetes::Api::V1::Container), nilable: true, key: "initContainers"},
      node_name:                        {type: String, nilable: true, key: "nodeName"},
      node_selector:                    {type: Hash(String, String), nilable: true, key: "nodeSelector"},
      restart_policy:                   {type: String, nilable: true, key: "restartPolicy"},
      scheduler_name:                   {type: String, nilable: true, key: "schedulerName"},
      security_context:                 {type: Kubernetes::Api::V1::PodSecurityContext, nilable: true, key: "securityContext"},
      ...
      subdomain:                        {type: String, nilable: true, key: "subdomain"},
      termination_grace_period_seconds: {type: Int32, nilable: true, key: "terminationGracePeriodSeconds"},
      tolerations:                      {type: Array(Kubernetes::Api::V1::Toleration), nilable: true, key: "tolerations"},
