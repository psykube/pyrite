...
module Pyrite
  ...
  class ApiextensionsApiserver::Apis::Apiextensions::V1::CustomResourceDefinitionStatus < Kubernetes::Spec
    ...
    def initialize(*, @accepted_names : ApiextensionsApiserver::Apis::Apiextensions::V1::CustomResourceDefinitionNames, @conditions : Array | Nil = nil, @stored_versions : Array)
    end
  end
end
