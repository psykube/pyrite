...
module Pyrite
  ...
  class ApiextensionsApiserver::Apis::Apiextensions::V1::CustomResourceDefinition
    ...
    @[::JSON::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("apiextensions/v1"))]
    @[::YAML::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("apiextensions/v1"))]
