...
module Pyrite
  ...
  class Api::Autoscaling::V2beta1::HorizontalPodAutoscaler
    ...
    @[::JSON::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("autoscaling/v2beta1"))]
    @[::YAML::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("autoscaling/v2beta1"))]
