...
module Pyrite
  ...
  class Api::Coordination::V1::Lease
    ...
    @[::JSON::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("coordination/v1"))]
    @[::YAML::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("coordination/v1"))]
