...
module Pyrite
  ...
  class Api::Policy::V1beta1::PodDisruptionBudget
    ...
    @[::JSON::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("policy/v1beta1"))]
    @[::YAML::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("policy/v1beta1"))]
