...
module Pyrite
  ...
  class Api::Apps::V1beta2::DeploymentList
    ...
    # create a Deployment
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Apps::V1beta2::DeploymentSpec | Nil = nil, status : Api::Apps::V1beta2::DeploymentStatus | Nil = nil, context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end
