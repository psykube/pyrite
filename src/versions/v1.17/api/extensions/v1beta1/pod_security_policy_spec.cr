...
module Pyrite
  ...
  class Api::Extensions::V1beta1::PodSecurityPolicySpec
    ...
    @[::JSON::Field(key: "allowedCSIDrivers")]
    @[::YAML::Field(key: "allowedCSIDrivers")]
    ...
    @[::JSON::Field(key: "runtimeClass")]
    @[::YAML::Field(key: "runtimeClass")]
    ...
    def initialize(*, @allow_privilege_escalation : Bool | Nil = nil, @allowed_csi_drivers : Array | Nil = nil, @allowed_capabilities : Array | Nil = nil, @allowed_flex_volumes : Array | Nil = nil, @allowed_host_paths : Array | Nil = nil, @allowed_proc_mount_types : Array | Nil = nil, @allowed_unsafe_sysctls : Array | Nil = nil, @default_add_capabilities : Array | Nil = nil, @default_allow_privilege_escalation : Bool | Nil = nil, @forbidden_sysctls : Array | Nil = nil, @fs_group : Api::Extensions::V1beta1::FSGroupStrategyOptions, @host_ipc : Bool | Nil = nil, @host_network : Bool | Nil = nil, @host_pid : Bool | Nil = nil, @host_ports : Array | Nil = nil, @privileged : Bool | Nil = nil, @read_only_root_filesystem : Bool | Nil = nil, @required_drop_capabilities : Array | Nil = nil, @run_as_group : Api::Extensions::V1beta1::RunAsGroupStrategyOptions | Nil = nil, @run_as_user : Api::Extensions::V1beta1::RunAsUserStrategyOptions, @runtime_class : Api::Extensions::V1beta1::RuntimeClassStrategyOptions | Nil = nil, @se_linux : Api::Extensions::V1beta1::SELinuxStrategyOptions, @supplemental_groups : Api::Extensions::V1beta1::SupplementalGroupsStrategyOptions, @volumes : Array | Nil = nil)
    end
  end
end
