...
module Pyrite
  ...
  class Api::Rbac::V1::ClusterRoleBinding
    getter api_version : String = "rbac/v1"
    ...
    ::YAML.mapping({
      api_version: {type: String, default: "rbac/v1", key: "apiVersion", setter: false},
    ...
    def initialize(*, @metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, @role_ref : Api::Rbac::V1::RoleRef | Nil = nil, @subjects : Array | Nil = nil)
    end
  end
