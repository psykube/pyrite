...
module Pyrite
  ...
  class Api::Autoscaling::V1::HorizontalPodAutoscalerSpec
    ...
    def initialize(*, @max_replicas : Int32 | Nil = nil, @min_replicas : Int32 | Nil = nil, @scale_target_ref : Api::Autoscaling::V1::CrossVersionObjectReference | Nil = nil, @target_cpu_utilization_percentage : Int32 | Nil = nil)
    end
  end
end
