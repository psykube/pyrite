...
module Pyrite
  ...
  class Api::Core::V1::SecretList
    ...
    # create a Secret
    def create(data : Hash(String, String) | Nil = nil, metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, string_data : Hash(String, String) | Nil = nil, type : String | Nil = nil, context : String | Nil = nil, dry_run : String | Nil = nil, field_manager : String | Nil = nil)
    end
