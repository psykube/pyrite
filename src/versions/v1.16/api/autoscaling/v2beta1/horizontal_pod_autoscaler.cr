...
module Pyrite
  ...
  class Api::Autoscaling::V2beta1::HorizontalPodAutoscaler < Kubernetes::Object
    @api_version = "autoscaling/v2beta1"
    @kind = "HorizontalPodAutoscaler"

    def self.new(pull : ::JSON::PullParser)
      super(pull).tap do |instance|
        unless instance.api_version == "autoscaling/v2beta1" && instance.kind == "HorizontalPodAutoscaler"
