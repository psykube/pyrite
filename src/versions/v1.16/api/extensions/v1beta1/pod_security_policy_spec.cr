...
module Pyrite
  ...
  class Api::Extensions::V1beta1::PodSecurityPolicySpec
    ...
    property allowed_csi_drivers : Array(Api::Extensions::V1beta1::AllowedCSIDriver) | Nil
    ...
    property runtime_class : Api::Extensions::V1beta1::RuntimeClassStrategyOptions | Nil
    ...
    ::YAML.mapping({
      ...
      allowed_csi_drivers:                {type: Array(Api::Extensions::V1beta1::AllowedCSIDriver), nilable: true, key: "allowedCSIDrivers", getter: false, setter: false},
      ...
      runtime_class:                      {type: Api::Extensions::V1beta1::RuntimeClassStrategyOptions, nilable: true, key: "runtimeClass", getter: false, setter: false},
    ...
    def initialize(*, @fs_group : Api::Extensions::V1beta1::FSGroupStrategyOptions, @run_as_user : Api::Extensions::V1beta1::RunAsUserStrategyOptions, @se_linux : Api::Extensions::V1beta1::SELinuxStrategyOptions, @supplemental_groups : Api::Extensions::V1beta1::SupplementalGroupsStrategyOptions, @allow_privilege_escalation : Bool | Nil = nil, @allowed_csi_drivers : Array | Nil = nil, @allowed_capabilities : Array | Nil = nil, @allowed_flex_volumes : Array | Nil = nil, @allowed_host_paths : Array | Nil = nil, @allowed_proc_mount_types : Array | Nil = nil, @allowed_unsafe_sysctls : Array | Nil = nil, @default_add_capabilities : Array | Nil = nil, @default_allow_privilege_escalation : Bool | Nil = nil, @forbidden_sysctls : Array | Nil = nil, @host_ipc : Bool | Nil = nil, @host_network : Bool | Nil = nil, @host_pid : Bool | Nil = nil, @host_ports : Array | Nil = nil, @privileged : Bool | Nil = nil, @read_only_root_filesystem : Bool | Nil = nil, @required_drop_capabilities : Array | Nil = nil, @run_as_group : Api::Extensions::V1beta1::RunAsGroupStrategyOptions | Nil = nil, @runtime_class : Api::Extensions::V1beta1::RuntimeClassStrategyOptions | Nil = nil, @volumes : Array | Nil = nil)
    end
  end
end
