...
module Pyrite
  ...
  class Api::Authentication::V1::TokenRequest
    ...
    @[::JSON::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("authentication/v1"))]
    @[::YAML::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("authentication/v1"))]
