...
module Pyrite
  ...
  class Api::Apps::V1beta1::DeploymentList
    ...
    # create a Deployment
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Apps::V1beta1::DeploymentSpec | Nil = nil, status : Api::Apps::V1beta1::DeploymentStatus | Nil = nil, context : String | Nil = nil)
    end
