...
module Pyrite
  ...
  class Api::Core::V1::ScaleIOPersistentVolumeSource
    ...
    def initialize(*, @fs_type : String | Nil = nil, @gateway : String, @protection_domain : String | Nil = nil, @read_only : Bool | Nil = nil, @secret_ref : Api::Core::V1::SecretReference, @ssl_enabled : Bool | Nil = nil, @storage_mode : String | Nil = nil, @storage_pool : String | Nil = nil, @system : String, @volume_name : String | Nil = nil)
    end
  end
end
