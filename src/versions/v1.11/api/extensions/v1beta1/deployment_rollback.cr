...
module Pyrite
  ...
  class Api::Extensions::V1beta1::DeploymentRollback < Kubernetes::Spec
    ...
    def initialize(*, @api_version : String | Nil = nil, @kind : String | Nil = nil, @name : String, @rollback_to : Api::Extensions::V1beta1::RollbackConfig, @updated_annotations : Hash(String, String) | Nil = nil)
    end
  end
end
