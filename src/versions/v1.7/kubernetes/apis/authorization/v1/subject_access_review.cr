...
module Pyrite
  ...
  class Kubernetes::Apis::Authorization::V1::SubjectAccessReview < Kubernetes::Object
    def self.new(pull : ::JSON::PullParser)
      previous_def(pull).tap do |instance|
        unless instance.api_version == "authorization/v1" && instance.kind == "SubjectAccessReview"
