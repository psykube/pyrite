...
module Pyrite
  ...
  class Kubernetes::Apis::Authorization::V1::SelfSubjectAccessReview
    ...
    def initialize(*, @spec : Kubernetes::Apis::Authorization::V1::SelfSubjectAccessReviewSpec, @metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, @status : Kubernetes::Apis::Authorization::V1::SubjectAccessReviewStatus | Nil = nil)
    end
  end

  module Resources::Authorization::V1
    alias SelfSubjectAccessReview = ::Pyrite::Kubernetes::Apis::Authorization::V1::SelfSubjectAccessReview
  end
end
