...
module Pyrite
  ...
  class Kubernetes::Apis::Batch::V2alpha1::CronJobSpec < Kubernetes::Spec
    ...
    def initialize(*, @concurrency_policy : String | Nil = nil, @failed_jobs_history_limit : Int32 | Nil = nil, @job_template : Kubernetes::Apis::Batch::V2alpha1::JobTemplateSpec, @schedule : String, @starting_deadline_seconds : Int32 | Nil = nil, @successful_jobs_history_limit : Int32 | Nil = nil, @suspend : Bool | Nil = nil)
    end
  end
end
