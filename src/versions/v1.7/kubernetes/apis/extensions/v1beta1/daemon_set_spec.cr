...
module Pyrite
  ...
  class Kubernetes::Apis::Extensions::V1beta1::DaemonSetSpec
    ...
    def initialize(*, @template : Kubernetes::Api::V1::PodTemplateSpec, @min_ready_seconds : Int32 | Nil = nil, @revision_history_limit : Int32 | Nil = nil, @selector : Apimachinery::Apis::Meta::V1::LabelSelector | Nil = nil, @template_generation : Int32 | Nil = nil, @update_strategy : Kubernetes::Apis::Extensions::V1beta1::DaemonSetUpdateStrategy | Nil = nil)
    end
  end
end
