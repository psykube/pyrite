...
module Pyrite
  ...
  class Kubernetes::Apis::Extensions::V1beta1::PodSecurityPolicyList
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Kubernetes::Apis::Extensions::V1beta1::PodSecurityPolicySpec | Nil = nil, context : String | Nil = nil)
    end
