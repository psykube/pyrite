...
module Pyrite
  ...
  class Kubernetes::Apis::Rbac::V1alpha1::RoleBindingList
    ...
    # list or watch objects of kind RoleBinding
    def self.list_rbac_authorization_v1alpha1_role_binding_for_all_namespaces(context : String | Nil = nil, field_selector : String | Nil = nil, include_uninitialized : Bool | Nil = nil, label_selector : String | Nil = nil, resource_version : String | Nil = nil, timeout_seconds : Int32 | Nil = nil, watch : Bool | Nil = nil)
    end
  end
end
