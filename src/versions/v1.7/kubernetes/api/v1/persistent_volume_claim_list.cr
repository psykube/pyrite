...
module Pyrite
  ...
  class Kubernetes::Api::V1::PersistentVolumeClaimList
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Kubernetes::Api::V1::PersistentVolumeClaimSpec | Nil = nil, status : Kubernetes::Api::V1::PersistentVolumeClaimStatus | Nil = nil, context : String | Nil = nil)
    end
