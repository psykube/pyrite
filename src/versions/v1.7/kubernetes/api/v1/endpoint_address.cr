...
module Pyrite
  ...
  class Kubernetes::Api::V1::EndpointAddress < Kubernetes::Spec
    ...
    def initialize(*, @hostname : String | Nil = nil, @ip : String, @node_name : String | Nil = nil, @target_ref : Kubernetes::Api::V1::ObjectReference | Nil = nil)
    end
  end
end
