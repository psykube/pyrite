...
module Pyrite
  ...
  class Kubernetes::Api::V1::DownwardAPIVolumeFile
    ...
    def initialize(*, @path : String, @field_ref : Kubernetes::Api::V1::ObjectFieldSelector | Nil = nil, @mode : Int32 | Nil = nil, @resource_field_ref : Kubernetes::Api::V1::ResourceFieldSelector | Nil = nil)
    end
  end
end
