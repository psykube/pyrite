...
module Pyrite
  ...
  class Kubernetes::Api::V1::PodSpec
    ...
    ::YAML.mapping({
      ...
      host_aliases:                     {type: Array(Kubernetes::Api::V1::HostAlias), nilable: true, key: "hostAliases", getter: false, setter: false},
