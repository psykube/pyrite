...
module Pyrite
  ...
  class Kubernetes::Api::V1::Volume
    ...
    ::YAML.mapping({
      ...
      storageos:               {type: Kubernetes::Api::V1::StorageOSVolumeSource, nilable: true, key: "storageos", getter: false, setter: false},
