...
module Pyrite
  ...
  class Kubernetes::Api::V1::NodeList
    ...
    # create a Node
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Kubernetes::Api::V1::NodeSpec | Nil = nil, status : Kubernetes::Api::V1::NodeStatus | Nil = nil, context : String | Nil = nil)
    end
