...
module Pyrite
  ...
  class Api::Apps::V1beta2::DeploymentStrategy
    ...
    ::YAML.mapping({
      rolling_update: {type: Api::Apps::V1beta2::RollingUpdateDeployment, nilable: true, key: "rollingUpdate", getter: false, setter: false},
