...
module Pyrite
  ...
  class Kubernetes::Apis::Extensions::V1beta1::DeploymentList
    getter api_version : String = "v1"
    getter kind : String = "List"
    # Items is the list of Deployments.
    property items : Array(Kubernetes::Apis::Extensions::V1beta1::Deployment)
    ...
    ::YAML.mapping({
      ...
      items:       {type: Array(Kubernetes::Apis::Extensions::V1beta1::Deployment), nilable: false, key: "items", getter: false, setter: false},
    ...
    # create a Deployment
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Kubernetes::Apis::Extensions::V1beta1::DeploymentSpec | Nil = nil, status : Kubernetes::Apis::Extensions::V1beta1::DeploymentStatus | Nil = nil, context : String | Nil = nil)
    end
