...
module Pyrite
  ...
  class Kubernetes::Apis::Extensions::V1beta1::DeploymentSpec
    ...
    property rollback_to : Kubernetes::Apis::Extensions::V1beta1::RollbackConfig | Nil

    # Label selector for pods. Existing ReplicaSets whose pods are selected by this will be the ones affected by this deployment.
    property selector : Apimachinery::Apis::Meta::V1::LabelSelector | Nil

    # The deployment strategy to use to replace existing pods with new ones.
    property strategy : Kubernetes::Apis::Extensions::V1beta1::DeploymentStrategy | Nil
