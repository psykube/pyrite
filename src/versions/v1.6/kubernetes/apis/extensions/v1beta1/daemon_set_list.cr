...
module Pyrite
  ...
  class Kubernetes::Apis::Extensions::V1beta1::DaemonSetList
    ...
    # create a DaemonSet
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Kubernetes::Apis::Extensions::V1beta1::DaemonSetSpec | Nil = nil, status : Kubernetes::Apis::Extensions::V1beta1::DaemonSetStatus | Nil = nil, context : String | Nil = nil)
    end
