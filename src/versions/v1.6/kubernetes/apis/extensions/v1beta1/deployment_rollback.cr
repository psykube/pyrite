...
module Pyrite
  ...
  class Kubernetes::Apis::Extensions::V1beta1::DeploymentRollback
    ...
    def initialize(*, @name : String, @rollback_to : Kubernetes::Apis::Extensions::V1beta1::RollbackConfig, @api_version : String | Nil = nil, @kind : String | Nil = nil, @updated_annotations : Hash(String, String) | Nil = nil)
    end
  end
end
