...
module Pyrite
  ...
  class Kubernetes::Apis::Extensions::V1beta1::NetworkPolicyList
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Kubernetes::Apis::Extensions::V1beta1::NetworkPolicySpec | Nil = nil, context : String | Nil = nil)
    end
