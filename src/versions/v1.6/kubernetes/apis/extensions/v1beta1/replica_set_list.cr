...
module Pyrite
  ...
  class Kubernetes::Apis::Extensions::V1beta1::ReplicaSetList
    ...
    # create a ReplicaSet
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Kubernetes::Apis::Extensions::V1beta1::ReplicaSetSpec | Nil = nil, status : Kubernetes::Apis::Extensions::V1beta1::ReplicaSetStatus | Nil = nil, context : String | Nil = nil)
    end
