...
module Pyrite
  ...
  class Kubernetes::Apis::Batch::V2alpha1::CronJobList
    ...
    # list or watch objects of kind ScheduledJob
    def self.list_batch_v2alpha1_scheduled_job_for_all_namespaces(context : String | Nil = nil, field_selector : String | Nil = nil, label_selector : String | Nil = nil, resource_version : String | Nil = nil, timeout_seconds : Int32 | Nil = nil, watch : Bool | Nil = nil)
    end
  end
end
