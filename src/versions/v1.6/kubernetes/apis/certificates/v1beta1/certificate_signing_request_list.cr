...
module Pyrite
  class Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequestList
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequestSpec | Nil = nil, status : Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequestStatus | Nil = nil, context : String | Nil = nil)
    end
