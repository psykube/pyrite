...
module Pyrite
  ...
  class Kubernetes::Apis::Apps::V1beta1::DeploymentRollback
    ...
    def initialize(*, @api_version : String | Nil = nil, @kind : String | Nil = nil, @name : String, @rollback_to : Kubernetes::Apis::Apps::V1beta1::RollbackConfig, @updated_annotations : Hash(String, String) | Nil = nil)
    end
  end
end
