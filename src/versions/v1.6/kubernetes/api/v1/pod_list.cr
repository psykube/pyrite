...
module Pyrite
  ...
  class Kubernetes::Api::V1::PodList
    ...
    # create a Pod
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Kubernetes::Api::V1::PodSpec | Nil = nil, status : Kubernetes::Api::V1::PodStatus | Nil = nil, context : String | Nil = nil)
    end
