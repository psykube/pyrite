...
module Pyrite
  ...
  class Kubernetes::Api::V1::PodAntiAffinity < Kubernetes::Spec
    ...
    property preferred_during_scheduling_ignored_during_execution : Array(Kubernetes::Api::V1::WeightedPodAffinityTerm) | Nil
