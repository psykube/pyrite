...
module Pyrite
  ...
  class Kubernetes::Api::V1::ServiceList
    ...
    # create a Service
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Kubernetes::Api::V1::ServiceSpec | Nil = nil, status : Kubernetes::Api::V1::ServiceStatus | Nil = nil, context : String | Nil = nil)
    end
