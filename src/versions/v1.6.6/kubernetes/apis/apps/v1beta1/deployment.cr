...
module Pyrite
  ...
  class Kubernetes::Apis::Apps::V1beta1::Deployment
    ...
    YAML.mapping({
      ...
      spec:        {type: Kubernetes::Apis::Apps::V1beta1::DeploymentSpec, nilable: true, key: "spec"},
      status:      {type: Kubernetes::Apis::Apps::V1beta1::DeploymentStatus, nilable: true, key: "status"},
    }, true)
  ...
  module Resources::Apps::V1beta1
    alias Deployment = Kubernetes::Apis::Apps::V1beta1::Deployment
  end
end
