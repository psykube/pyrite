...
module Pyrite
  ...
  class Api::Settings::V1alpha1::PodPreset
    ...
    @[::JSON::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("settings/v1alpha1"))]
    @[::YAML::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("settings/v1alpha1"))]
