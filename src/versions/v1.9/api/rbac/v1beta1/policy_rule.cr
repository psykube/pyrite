...
module Pyrite
  ...
  class Api::Rbac::V1beta1::PolicyRule < Kubernetes::Spec
    ...
    # Resources is a list of resources this rule applies to.  '*' represents all resources in the specified apiGroups. ['*/foo' represents the subresource 'foo' for all resources in the specified apiGroups.]('*/foo' represents the subresource 'foo' for all resources in the specified apiGroups.)
