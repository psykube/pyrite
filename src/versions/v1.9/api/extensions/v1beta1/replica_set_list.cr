...
module Pyrite
  ...
  class Api::Extensions::V1beta1::ReplicaSetList
    ...
    # create a ReplicaSet
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Extensions::V1beta1::ReplicaSetSpec | Nil = nil, status : Api::Extensions::V1beta1::ReplicaSetStatus | Nil = nil, context : String | Nil = nil)
    end
