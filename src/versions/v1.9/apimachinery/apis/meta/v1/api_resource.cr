...
module Pyrite
  ...
  class Apimachinery::Apis::Meta::V1::APIResource
    ...
    def initialize(*, @categories : Array | Nil = nil, @group : String | Nil = nil, @kind : String, @name : String, @namespaced : Bool, @short_names : Array | Nil = nil, @singular_name : String, @verbs : Array, @version : String | Nil = nil)
    end
  end
end
