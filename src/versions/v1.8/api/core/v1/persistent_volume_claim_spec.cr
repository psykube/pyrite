...
module Pyrite
  ...
  class Api::Core::V1::PersistentVolumeClaimSpec
    ...
    def initialize(*, @access_modes : Array | Nil = nil, @resources : Api::Core::V1::ResourceRequirements | Nil = nil, @selector : Apimachinery::Apis::Meta::V1::LabelSelector | Nil = nil, @storage_class_name : String | Nil = nil, @volume_name : String | Nil = nil)
    end
  end
end
