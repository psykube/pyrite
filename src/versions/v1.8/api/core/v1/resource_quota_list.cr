...
module Pyrite
  ...
  class Api::Core::V1::ResourceQuotaList
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Core::V1::ResourceQuotaSpec | Nil = nil, status : Api::Core::V1::ResourceQuotaStatus | Nil = nil, context : String | Nil = nil)
    end
