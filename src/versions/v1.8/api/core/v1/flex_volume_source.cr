...
module Pyrite
  ...
  class Api::Core::V1::FlexVolumeSource
    ...
    def initialize(*, @driver : String | Nil = nil, @fs_type : String | Nil = nil, @options : Hash(String, String) | Nil = nil, @read_only : Bool | Nil = nil, @secret_ref : Api::Core::V1::LocalObjectReference | Nil = nil)
    end
  end
end
