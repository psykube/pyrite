...
module Pyrite
  ...
  class Api::Core::V1::EventList
    ...
    # create an Event
    def create(involved_object : Api::Core::V1::ObjectReference, metadata : Apimachinery::Apis::Meta::V1::ObjectMeta, count : Int32 | Nil = nil, first_timestamp : Time | Nil = nil, last_timestamp : Time | Nil = nil, message : String | Nil = nil, reason : String | Nil = nil, source : Api::Core::V1::EventSource | Nil = nil, type : String | Nil = nil, context : String | Nil = nil)
    end
