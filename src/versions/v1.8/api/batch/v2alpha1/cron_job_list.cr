...
module Pyrite
  ...
  class Api::Batch::V2alpha1::CronJobList
    ...
    # create a CronJob
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Batch::V2alpha1::CronJobSpec | Nil = nil, status : Api::Batch::V2alpha1::CronJobStatus | Nil = nil, context : String | Nil = nil)
    end
