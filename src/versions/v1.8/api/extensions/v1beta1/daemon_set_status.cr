...
module Pyrite
  ...
  class Api::Extensions::V1beta1::DaemonSetStatus < Kubernetes::Spec
    ...
    def initialize(*, @collision_count : Int32 | Nil = nil, @current_number_scheduled : Int32, @desired_number_scheduled : Int32, @number_available : Int32 | Nil = nil, @number_misscheduled : Int32, @number_ready : Int32, @number_unavailable : Int32 | Nil = nil, @observed_generation : Int32 | Nil = nil, @updated_number_scheduled : Int32 | Nil = nil)
    end
  end
end
