...
module Pyrite
  ...
  class Api::Storage::V1::StorageClass < Kubernetes::Object
    ...
    def initialize(*, @allow_volume_expansion : Bool | Nil = nil, @metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, @mount_options : Array | Nil = nil, @parameters : Hash(String, String) | Nil = nil, @provisioner : String, @reclaim_policy : String | Nil = nil)
    end
  end
end
