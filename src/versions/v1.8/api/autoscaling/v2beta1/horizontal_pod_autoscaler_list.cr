...
module Pyrite
  ...
  class Api::Autoscaling::V2beta1::HorizontalPodAutoscalerList
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Autoscaling::V2beta1::HorizontalPodAutoscalerSpec | Nil = nil, status : Api::Autoscaling::V2beta1::HorizontalPodAutoscalerStatus | Nil = nil, context : String | Nil = nil)
    end
