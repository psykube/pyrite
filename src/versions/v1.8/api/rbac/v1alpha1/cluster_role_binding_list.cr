...
module Pyrite
  ...
  class Api::Rbac::V1alpha1::ClusterRoleBindingList
    ...
    def create_rbac_authorization_v1alpha1_cluster_role_binding(role_ref : Api::Rbac::V1alpha1::RoleRef, subjects : Array, metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, context : String | Nil = nil)
    end
