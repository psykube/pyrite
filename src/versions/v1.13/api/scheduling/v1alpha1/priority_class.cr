...
module Pyrite
  ...
  class Api::Scheduling::V1alpha1::PriorityClass
    ...
    @[::JSON::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("scheduling/v1alpha1"))]
    @[::YAML::Field(key: "apiVersion", converter: ::Pyrite::StringChecker.new("scheduling/v1alpha1"))]
