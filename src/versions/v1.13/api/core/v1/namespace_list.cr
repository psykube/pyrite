...
module Pyrite
  ...
  class Api::Core::V1::NamespaceList
    ...
    # create a Namespace
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Core::V1::NamespaceSpec | Nil = nil, status : Api::Core::V1::NamespaceStatus | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
