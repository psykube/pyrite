...
module Pyrite
  ...
  class Api::Core::V1::SecurityContext
    ...
    def initialize(*, @allow_privilege_escalation : Bool | Nil = nil, @capabilities : Api::Core::V1::Capabilities | Nil = nil, @privileged : Bool | Nil = nil, @proc_mount : String | Nil = nil, @read_only_root_filesystem : Bool | Nil = nil, @run_as_group : Int32 | Nil = nil, @run_as_non_root : Bool | Nil = nil, @run_as_user : Int32 | Nil = nil, @se_linux_options : Api::Core::V1::SELinuxOptions | Nil = nil)
    end
  end
end
