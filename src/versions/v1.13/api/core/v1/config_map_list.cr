...
module Pyrite
  ...
  class Api::Core::V1::ConfigMapList
    ...
    # create a ConfigMap
    def create(binary_data : Hash(String, String) | Nil = nil, data : Hash(String, String) | Nil = nil, metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
