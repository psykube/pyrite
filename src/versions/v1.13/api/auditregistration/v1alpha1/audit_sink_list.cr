...
module Pyrite
  ...
  class Api::Auditregistration::V1alpha1::AuditSinkList
    ...
    # create an AuditSink
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Auditregistration::V1alpha1::AuditSinkSpec | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
