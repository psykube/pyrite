...
module Pyrite
  ...
  class Api::Storage::V1alpha1::VolumeAttachmentList
    ...
    def create(spec : Api::Storage::V1alpha1::VolumeAttachmentSpec, metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, status : Api::Storage::V1alpha1::VolumeAttachmentStatus | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
