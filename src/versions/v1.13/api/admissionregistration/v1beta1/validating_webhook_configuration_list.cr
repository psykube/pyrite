...
module Pyrite
  ...
  class Api::Admissionregistration::V1beta1::ValidatingWebhookConfigurationList
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, webhooks : Array | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
