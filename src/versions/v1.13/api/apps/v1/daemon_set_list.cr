...
module Pyrite
  ...
  class Api::Apps::V1::DaemonSetList
    ...
    # create a DaemonSet
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Apps::V1::DaemonSetSpec | Nil = nil, status : Api::Apps::V1::DaemonSetStatus | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
