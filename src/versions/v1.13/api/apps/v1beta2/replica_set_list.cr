...
module Pyrite
  ...
  class Api::Apps::V1beta2::ReplicaSetList
    ...
    # create a ReplicaSet
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : Api::Apps::V1beta2::ReplicaSetSpec | Nil = nil, status : Api::Apps::V1beta2::ReplicaSetStatus | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
