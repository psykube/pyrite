...
module Pyrite
  ...
  class Apimachinery::Apis::Meta::V1::APIGroup < Kubernetes::Spec
    ...
    def initialize(*, @api_version : String | Nil = nil, @kind : String | Nil = nil, @name : String, @preferred_version : Apimachinery::Apis::Meta::V1::GroupVersionForDiscovery | Nil = nil, @server_address_by_client_cidrs : Array | Nil = nil, @versions : Array)
    end
  end
end
