...
module Pyrite
  ...
  class KubeAggregator::Apis::Apiregistration::V1::APIServiceList
    ...
    def create(metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, spec : KubeAggregator::Apis::Apiregistration::V1::APIServiceSpec | Nil = nil, status : KubeAggregator::Apis::Apiregistration::V1::APIServiceStatus | Nil = nil, context : String | Nil = nil, include_uninitialized : Bool | Nil = nil, dry_run : String | Nil = nil)
    end
