...
module Pyrite::V1_5_6
  ...
  class Definitions::V1::ObjectMeta
    ...
    property creation_timestamp : Unversioned::Time
    ...
    property deletion_timestamp : Unversioned::Time
    ...
    property owner_references : Array(V1::OwnerReference)?
    ...
    YAML.mapping({annotations:                   {type: Hash(String, String), nilable: true, key: annotations, getter: false, setter: false},
                  ...
                  creation_timestamp:            {type: Unversioned::Time, nilable: true, key: creationTimestamp, getter: false, setter: false},
                  deletion_grace_period_seconds: {type: Int32, nilable: true, key: deletionGracePeriodSeconds, getter: false, setter: false},
                  deletion_timestamp:            {type: Unversioned::Time, nilable: true, key: deletionTimestamp, getter: false, setter: false},
                  ...
                  owner_references:              {type: Array(V1::OwnerReference), nilable: true, key: ownerReferences, getter: false, setter: false},
