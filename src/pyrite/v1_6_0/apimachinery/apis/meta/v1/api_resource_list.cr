...
class Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::APIResourceList
  # groupVersion is the group and version this APIResourceList is for.
  property group_version : String

  # resources contains the name of the resources and if they are namespaced.
  property resources : Array(::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::APIResource)
  ...
  YAML.mapping({
    ...
    resources:     {type: Array(::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::APIResource), nilable: false, key: resources, getter: false, setter: false},
  }, true)
