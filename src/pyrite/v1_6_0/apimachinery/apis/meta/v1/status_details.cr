...
class Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::StatusDetails
  ...
  YAML.mapping({causes:              {type: Array(::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::StatusCause), nilable: true, key: causes, getter: false, setter: false},
  ...
  JSON.mapping({causes:              {type: Array(::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::StatusCause), nilable: true, key: causes, getter: false, setter: false},
                group:               {type: String, nilable: true, key: group, getter: false, setter: false},
                kind:                {type: String, nilable: true, key: kind, getter: false, setter: false},
                name:                {type: String, nilable: true, key: name, getter: false, setter: false},
                retry_after_seconds: {type: Int32, nilable: true, key: retryAfterSeconds, getter: false, setter: false}}, true)
