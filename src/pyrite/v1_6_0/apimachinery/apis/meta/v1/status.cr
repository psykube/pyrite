...
module Pyrite::V1_6_0
  ...
  class Definitions::Apimachinery::Apis::Meta::V1::Status
    # Suggested HTTP return code for this status, 0 if not set.
    property code : Int32?

    # Extended data associated with the reason.  Each reason may define its own extended details. This field is optional and the data returned is not guaranteed to conform to any schema except that defined by the reason type.
    property details : Apimachinery::Apis::Meta::V1::StatusDetails
    ...
    def initialize(@api_version : String? = nil, @code : Int32? = nil, @details : Apimachinery::Apis::Meta::V1::StatusDetails = nil, @kind : String? = nil, @message : String? = nil, @metadata : Apimachinery::Apis::Meta::V1::ListMeta = nil, @reason : String? = nil, @status : String? = nil)
      @api_version = "meta/v1"
      @kind = "Status"
    end
  end
  ...
  module Resources::Meta::V1
    include Resource
    alias Status = Definitions::Apimachinery::Apis::Meta::V1::Status
  end
end
