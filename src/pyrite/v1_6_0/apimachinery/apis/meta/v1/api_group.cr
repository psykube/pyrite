...
class Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::APIGroup
  ...
  property versions : Array(::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::GroupVersionForDiscovery)

  YAML.mapping({
    api_version:                     {type: String, default: "APIGroup", key: apiVersion, getter: false, setter: false},
    kind:                            {type: String, default: "v1", getter: false, setter: false},
    name:                            {type: String, nilable: false, key: name, getter: false, setter: false},
    preferred_version:               {type: ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::GroupVersionForDiscovery, nilable: true, key: preferredVersion, getter: false, setter: false},
    server_address_by_client_cid_rs: {type: Array(::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ServerAddressByClientCIDR), nilable: false, key: serverAddressByClientCIDRs, getter: false, setter: false},
