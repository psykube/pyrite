...
class Pyrite::V1_6_0::Kubernetes::Api::V1::ResourceQuota
  ...
  property spec : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ResourceQuotaSpec
  ...
  property status : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ResourceQuotaStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::Pyrite::V1_6_0::Kubernetes::Api::V1::ResourceQuotaSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::Pyrite::V1_6_0::Kubernetes::Api::V1::ResourceQuotaStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ResourceQuotaSpec = nil, @status : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ResourceQuotaStatus = nil)
