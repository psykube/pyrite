...
class Pyrite::V1_6_0::Kubernetes::Api::V1::Binding
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @target : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ObjectReference = nil)
    @api_version = "Binding"
    @kind = "v1"
  end
