...
class Pyrite::V1_6_0::Kubernetes::Api::V1::CephFSVolumeSource
  ...
  def initialize(@monitors : Array? = nil, @path : String? = nil, @read_only : Bool? = nil, @secret_file : String? = nil, @secret_ref : ::Pyrite::V1_6_0::Kubernetes::Api::V1::LocalObjectReference = nil, @user : String? = nil)
  end
end
