...
class Pyrite::V1_6_0::Kubernetes::Api::V1::PersistentVolumeSpec
  ...
  property claim_ref : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ObjectReference
  ...
  YAML.mapping({access_modes:                     {type: Array(String), nilable: true, key: accessModes, getter: false, setter: false},
                aws_elastic_block_store:          {type: ::Pyrite::V1_6_0::Kubernetes::Api::V1::AWSElasticBlockStoreVolumeSource, nilable: true, key: awsElasticBlockStore, getter: false, setter: false},
                ...
                claim_ref:                        {type: ::Pyrite::V1_6_0::Kubernetes::Api::V1::ObjectReference, nilable: true, key: claimRef, getter: false, setter: false},
