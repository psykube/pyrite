...
class Pyrite::V1_6_0::Kubernetes::Api::V1::ContainerStateTerminated
  ...
  property finished_at : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::Time
  ...
  property started_at : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::Time
  ...
  YAML.mapping({container_id: {type: String, nilable: true, key: containerID, getter: false, setter: false},
                ...
                finished_at:  {type: ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: finishedAt, getter: false, setter: false},
