...
class Pyrite::V1_6_0::Kubernetes::Api::V1::Namespace
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : ::Pyrite::V1_6_0::Kubernetes::Api::V1::NamespaceSpec = nil, @status : ::Pyrite::V1_6_0::Kubernetes::Api::V1::NamespaceStatus = nil)
