...
class Pyrite::V1_6_0::Kubernetes::Api::V1::NodeList
  # List of nodes
  property items : Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::Node)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::Node), nilable: false, key: items, getter: false, setter: false},
  ...
  # create a Node
  def create(metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_0::Kubernetes::Api::V1::NodeSpec = nil, status : ::Pyrite::V1_6_0::Kubernetes::Api::V1::NodeStatus = nil, context : String? = nil)
  end
