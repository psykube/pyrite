...
module Pyrite::V1_6_0
  ...
  class Definitions::Kubernetes::Api::V1::Secret
    ...
    def initialize(@api_version : String? = nil, @data : Hash(String, String)? = nil, @kind : String? = nil, @metadata : Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @string_data : Hash(String, String)? = nil, @type : String? = nil)
      @api_version = "v1"
      @kind = "Secret"
    end
  end
  ...
  module Resources::V1
    include Resource
    alias Secret = Definitions::Kubernetes::Api::V1::Secret
  end
end
