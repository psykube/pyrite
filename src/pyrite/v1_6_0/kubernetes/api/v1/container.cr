...
class Pyrite::V1_6_0::Kubernetes::Api::V1::Container
  ...
  property env : Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::EnvVar)?
  ...
  property lifecycle : ::Pyrite::V1_6_0::Kubernetes::Api::V1::Lifecycle
  ...
  property liveness_probe : ::Pyrite::V1_6_0::Kubernetes::Api::V1::Probe

  # Name of the container specified as a DNS_LABEL. Each container in a pod must have a unique name (DNS_LABEL). Cannot be updated.
  property name : String

  # List of ports to expose from the container. Exposing a port here gives the system additional information about the network connections a container uses, but is primarily informational. Not specifying a port here DOES NOT prevent that port from being exposed. Any port which is listening on the default "0.0.0.0" address inside a container will be accessible from the network. Cannot be updated.
  property ports : Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::ContainerPort)?
  ...
  property readiness_probe : ::Pyrite::V1_6_0::Kubernetes::Api::V1::Probe
  ...
  property security_context : ::Pyrite::V1_6_0::Kubernetes::Api::V1::SecurityContext
  ...
  property volume_mounts : Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::VolumeMount)?
  ...
  YAML.mapping({args:                       {type: Array(String), nilable: true, key: args, getter: false, setter: false},
                ...
                env:                        {type: Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::EnvVar), nilable: true, key: env, getter: false, setter: false},
                env_from:                   {type: Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::EnvFromSource), nilable: true, key: envFrom, getter: false, setter: false},
                ...
                lifecycle:                  {type: ::Pyrite::V1_6_0::Kubernetes::Api::V1::Lifecycle, nilable: true, key: lifecycle, getter: false, setter: false},
                liveness_probe:             {type: ::Pyrite::V1_6_0::Kubernetes::Api::V1::Probe, nilable: true, key: livenessProbe, getter: false, setter: false},
                name:                       {type: String, nilable: false, key: name, getter: false, setter: false},
                ports:                      {type: Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::ContainerPort), nilable: true, key: ports, getter: false, setter: false},
                readiness_probe:            {type: ::Pyrite::V1_6_0::Kubernetes::Api::V1::Probe, nilable: true, key: readinessProbe, getter: false, setter: false},
                resources:                  {type: ::Pyrite::V1_6_0::Kubernetes::Api::V1::ResourceRequirements, nilable: true, key: resources, getter: false, setter: false},
                security_context:           {type: ::Pyrite::V1_6_0::Kubernetes::Api::V1::SecurityContext, nilable: true, key: securityContext, getter: false, setter: false},
  ...
  def initialize(@args : Array? = nil, @command : Array? = nil, @env : Array? = nil, @env_from : Array? = nil, @image : String? = nil, @image_pull_policy : String? = nil, @lifecycle : ::Pyrite::V1_6_0::Kubernetes::Api::V1::Lifecycle = nil, @liveness_probe : ::Pyrite::V1_6_0::Kubernetes::Api::V1::Probe = nil, @name : String? = nil, @ports : Array? = nil, @readiness_probe : ::Pyrite::V1_6_0::Kubernetes::Api::V1::Probe = nil, @resources : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ResourceRequirements = nil, @security_context : ::Pyrite::V1_6_0::Kubernetes::Api::V1::SecurityContext = nil, @stdin : Bool? = nil, @stdin_once : Bool? = nil, @termination_message_path : String? = nil, @termination_message_policy : String? = nil, @tty : Bool? = nil, @volume_mounts : Array? = nil, @working_dir : String? = nil)
  end
end
