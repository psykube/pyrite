...
class Pyrite::V1_6_0::Kubernetes::Api::V1::RBDVolumeSource
  ...
  YAML.mapping({fs_type:    {type: String, nilable: true, key: fsType, getter: false, setter: false},
                ...
                secret_ref: {type: ::Pyrite::V1_6_0::Kubernetes::Api::V1::LocalObjectReference, nilable: true, key: secretRef, getter: false, setter: false},
  ...
  def initialize(@fs_type : String? = nil, @image : String? = nil, @keyring : String? = nil, @monitors : Array? = nil, @pool : String? = nil, @read_only : Bool? = nil, @secret_ref : ::Pyrite::V1_6_0::Kubernetes::Api::V1::LocalObjectReference = nil, @user : String? = nil)
  end
end
