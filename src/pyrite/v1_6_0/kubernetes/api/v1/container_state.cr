...
class Pyrite::V1_6_0::Kubernetes::Api::V1::ContainerState
  ...
  def initialize(@running : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ContainerStateRunning = nil, @terminated : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ContainerStateTerminated = nil, @waiting : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ContainerStateWaiting = nil)
  end
end
