...
class Pyrite::V1_6_0::Kubernetes::Api::V1::Handler
  ...
  def initialize(@exec : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ExecAction = nil, @http_get : ::Pyrite::V1_6_0::Kubernetes::Api::V1::HTTPGetAction = nil, @tcp_socket : ::Pyrite::V1_6_0::Kubernetes::Api::V1::TCPSocketAction = nil)
  end
end
