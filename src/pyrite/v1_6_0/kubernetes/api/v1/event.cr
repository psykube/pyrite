...
class Pyrite::V1_6_0::Kubernetes::Api::V1::Event
  ...
  def initialize(@api_version : String? = nil, @count : Int32? = nil, @first_timestamp : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::Time = nil, @involved_object : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ObjectReference = nil, @kind : String? = nil, @last_timestamp : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::Time = nil, @message : String? = nil, @metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @reason : String? = nil, @source : ::Pyrite::V1_6_0::Kubernetes::Api::V1::EventSource = nil, @type : String? = nil)
    @api_version = "Event"
    @kind = "v1"
  end
