...
class Pyrite::V1_6_0::Kubernetes::Api::V1::PodTemplateList
  ...
  def create(metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, template : ::Pyrite::V1_6_0::Kubernetes::Api::V1::PodTemplateSpec = nil, context : String? = nil)
  end
