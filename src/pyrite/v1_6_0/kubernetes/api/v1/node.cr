...
class Pyrite::V1_6_0::Kubernetes::Api::V1::Node
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : ::Pyrite::V1_6_0::Kubernetes::Api::V1::NodeSpec = nil, @status : ::Pyrite::V1_6_0::Kubernetes::Api::V1::NodeStatus = nil)
    @api_version = "Node"
    @kind = "v1"
  end
