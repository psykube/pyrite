...
class Pyrite::V1_6_0::Kubernetes::Api::V1::ServicePort
  ...
  property target_port : ::Pyrite::V1_6_0::Apimachinery::Util::Intstr::IntOrString
  ...
  YAML.mapping({name:        {type: String, nilable: true, key: name, getter: false, setter: false},
                ...
                target_port: {type: ::Pyrite::V1_6_0::Apimachinery::Util::Intstr::IntOrString, nilable: true, key: targetPort, getter: false, setter: false}}, true)
  ...
  def initialize(@name : String? = nil, @node_port : Int32? = nil, @port : Int32? = nil, @protocol : String? = nil, @target_port : ::Pyrite::V1_6_0::Apimachinery::Util::Intstr::IntOrString = nil)
  end
end
