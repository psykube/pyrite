...
class Pyrite::V1_6_0::Kubernetes::Api::V1::EndpointAddress
  ...
  property target_ref : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ObjectReference
  ...
  YAML.mapping({hostname:   {type: String, nilable: true, key: hostname, getter: false, setter: false},
                ...
                target_ref: {type: ::Pyrite::V1_6_0::Kubernetes::Api::V1::ObjectReference, nilable: true, key: targetRef, getter: false, setter: false}}, true)
  ...
  def initialize(@hostname : String? = nil, @ip : String? = nil, @node_name : String? = nil, @target_ref : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ObjectReference = nil)
  end
end
