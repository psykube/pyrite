...
class Pyrite::V1_6_0::Kubernetes::Api::V1::ServiceAccount
  ...
  property secrets : Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::ObjectReference)?
  ...
  YAML.mapping({
    ...
    secrets:                         {type: Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::ObjectReference), nilable: true, key: secrets, getter: false, setter: false},
  }, true)
  ...
  def initialize(@api_version : String? = nil, @automount_service_account_token : Bool? = nil, @image_pull_secrets : Array? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @secrets : Array? = nil)
