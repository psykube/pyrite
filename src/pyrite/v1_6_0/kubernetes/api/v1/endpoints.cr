...
module Pyrite::V1_6_0
  ...
  #     },
  #  ]
  class Definitions::Kubernetes::Api::V1::Endpoints
    ...
    def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @subsets : Array? = nil)
      @api_version = "v1"
      @kind = "Endpoints"
    end
  end
  ...
  module Resources::V1
    include Resource
    alias Endpoints = Definitions::Kubernetes::Api::V1::Endpoints
  end
end
