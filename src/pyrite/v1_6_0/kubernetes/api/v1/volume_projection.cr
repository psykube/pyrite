...
class Pyrite::V1_6_0::Kubernetes::Api::V1::VolumeProjection
  ...
  def initialize(@config_map : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ConfigMapProjection = nil, @downward_api : ::Pyrite::V1_6_0::Kubernetes::Api::V1::DownwardAPIProjection = nil, @secret : ::Pyrite::V1_6_0::Kubernetes::Api::V1::SecretProjection = nil)
  end
end
