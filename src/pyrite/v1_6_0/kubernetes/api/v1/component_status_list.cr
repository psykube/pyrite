...
class Pyrite::V1_6_0::Kubernetes::Api::V1::ComponentStatusList
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::ComponentStatus), nilable: false, key: items, getter: false, setter: false},
