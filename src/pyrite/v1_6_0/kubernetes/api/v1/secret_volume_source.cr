...
class Pyrite::V1_6_0::Kubernetes::Api::V1::SecretVolumeSource
  ...
  YAML.mapping({default_mode: {type: Int32, nilable: true, key: defaultMode, getter: false, setter: false},
                items:        {type: Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::KeyToPath), nilable: true, key: items, getter: false, setter: false},
  ...
  def initialize(@default_mode : Int32? = nil, @items : Array? = nil, @optional : Bool? = nil, @secret_name : String? = nil)
  end
end
