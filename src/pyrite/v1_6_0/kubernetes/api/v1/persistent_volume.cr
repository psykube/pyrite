...
class Pyrite::V1_6_0::Kubernetes::Api::V1::PersistentVolume
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : ::Pyrite::V1_6_0::Kubernetes::Api::V1::PersistentVolumeSpec = nil, @status : ::Pyrite::V1_6_0::Kubernetes::Api::V1::PersistentVolumeStatus = nil)
