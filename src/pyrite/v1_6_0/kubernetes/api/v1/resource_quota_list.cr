...
class Pyrite::V1_6_0::Kubernetes::Api::V1::ResourceQuotaList
  ...
  def create(metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ResourceQuotaSpec = nil, status : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ResourceQuotaStatus = nil, context : String? = nil)
  end
