...
class Pyrite::V1_6_0::Kubernetes::Api::V1::ServiceSpec
  ...
  property ports : Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::ServicePort)?
  ...
  YAML.mapping({cluster_ip:                  {type: String, nilable: true, key: clusterIP, getter: false, setter: false},
                ...
                ports:                       {type: Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::ServicePort), nilable: true, key: ports, getter: false, setter: false},
  ...
  def initialize(@cluster_ip = nil, @deprecated_public_i_ps = nil, @external_i_ps = nil, @external_name = nil, @load_balancer_ip = nil, @load_balancer_source_ranges = nil, @ports = nil, @selector = nil, @session_affinity = nil, @type = nil)
  end
end
