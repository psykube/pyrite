...
class Pyrite::V1_6_0::Kubernetes::Api::V1::SecretList
  ...
  # create a Secret
  def create(data : Hash(String, String)? = nil, metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, string_data : Hash(String, String)? = nil, type : String? = nil, context : String? = nil)
  end
