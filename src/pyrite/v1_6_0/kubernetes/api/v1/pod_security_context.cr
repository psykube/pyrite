...
module Pyrite::V1_6_0
  ...
  class Definitions::Kubernetes::Api::V1::PodSecurityContext
    ...
    def initialize(@fs_group : Int32? = nil, @run_as_non_root : Bool? = nil, @run_as_user : Int32? = nil, @se_linux_options : Kubernetes::Api::V1::SELinuxOptions = nil, @supplemental_groups : Array? = nil)
    end
  end
end
