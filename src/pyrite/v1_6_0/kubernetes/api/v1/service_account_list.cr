...
class Pyrite::V1_6_0::Kubernetes::Api::V1::ServiceAccountList
  ...
  property items : Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::ServiceAccount)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::ServiceAccount), nilable: false, key: items, getter: false, setter: false},
  ...
  def create(automount_service_account_token : Bool? = nil, image_pull_secrets : Array? = nil, metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, secrets : Array? = nil, context : String? = nil)
  end
