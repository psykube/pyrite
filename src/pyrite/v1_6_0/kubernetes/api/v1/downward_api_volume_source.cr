...
module Pyrite::V1_6_0
  ...
  class Definitions::Kubernetes::Api::V1::DownwardAPIVolumeSource
    ...
    YAML.mapping({default_mode: {type: Int32, nilable: true, key: defaultMode, getter: false, setter: false},
                  items:        {type: Array(Kubernetes::Api::V1::DownwardAPIVolumeFile), nilable: true, key: items, getter: false, setter: false}}, true)
