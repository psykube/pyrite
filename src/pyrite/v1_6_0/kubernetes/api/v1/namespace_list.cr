...
class Pyrite::V1_6_0::Kubernetes::Api::V1::NamespaceList
  ...
  property items : Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::Namespace)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::Namespace), nilable: false, key: items, getter: false, setter: false},
  ...
  # create a Namespace
  def create(metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_0::Kubernetes::Api::V1::NamespaceSpec = nil, status : ::Pyrite::V1_6_0::Kubernetes::Api::V1::NamespaceStatus = nil, context : String? = nil)
  end
