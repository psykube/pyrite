...
class Pyrite::V1_6_0::Kubernetes::Api::V1::ReplicationControllerList
  ...
  def create(metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ReplicationControllerSpec = nil, status : ::Pyrite::V1_6_0::Kubernetes::Api::V1::ReplicationControllerStatus = nil, context : String? = nil)
  end
