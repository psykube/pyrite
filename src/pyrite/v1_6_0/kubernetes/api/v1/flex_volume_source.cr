...
class Pyrite::V1_6_0::Kubernetes::Api::V1::FlexVolumeSource
  ...
  YAML.mapping({driver:     {type: String, nilable: false, key: driver, getter: false, setter: false},
                ...
                secret_ref: {type: ::Pyrite::V1_6_0::Kubernetes::Api::V1::LocalObjectReference, nilable: true, key: secretRef, getter: false, setter: false}}, true)
  ...
  def initialize(@driver : String? = nil, @fs_type : String? = nil, @options : Hash(String, String)? = nil, @read_only : Bool? = nil, @secret_ref : ::Pyrite::V1_6_0::Kubernetes::Api::V1::LocalObjectReference = nil)
  end
end
