...
module Pyrite::V1_6_0
  ...
  class Definitions::Kubernetes::Apis::Autoscaling::V1::CrossVersionObjectReference
  ...
  module Resources::Autoscaling::V1
    include Resource
    alias CrossVersionObjectReference = Definitions::Kubernetes::Apis::Autoscaling::V1::CrossVersionObjectReference
  end
end
