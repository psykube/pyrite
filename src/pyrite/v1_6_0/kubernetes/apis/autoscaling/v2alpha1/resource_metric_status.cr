...
module Pyrite::V1_6_0
  ...
  class Definitions::Kubernetes::Apis::Autoscaling::V2alpha1::ResourceMetricStatus
    ...
    YAML.mapping({current_average_utilization: {type: Int32, nilable: true, key: currentAverageUtilization, getter: false, setter: false},
                  current_average_value:       {type: Apimachinery::Api::Resource::Quantity, nilable: false, key: currentAverageValue, getter: false, setter: false},
    ...
    def initialize(@current_average_utilization : Int32? = nil, @current_average_value : Apimachinery::Api::Resource::Quantity = nil, @name : String? = nil)
    end
  end
end
