...
class Pyrite::V1_6_0::Kubernetes::Apis::Autoscaling::V2alpha1::ObjectMetricSource
  ...
  def initialize(@metric_name : String? = nil, @target : ::Pyrite::V1_6_0::Kubernetes::Apis::Autoscaling::V2alpha1::CrossVersionObjectReference = nil, @target_value : ::Pyrite::V1_6_0::Apimachinery::Api::Resource::Quantity = nil)
  end
end
