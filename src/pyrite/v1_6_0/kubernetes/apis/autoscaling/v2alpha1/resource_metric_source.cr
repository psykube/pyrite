...
class Pyrite::V1_6_0::Kubernetes::Apis::Autoscaling::V2alpha1::ResourceMetricSource
  ...
  property target_average_value : ::Pyrite::V1_6_0::Apimachinery::Api::Resource::Quantity
  ...
  YAML.mapping({name:                       {type: String, nilable: false, key: name, getter: false, setter: false},
                ...
                target_average_value:       {type: ::Pyrite::V1_6_0::Apimachinery::Api::Resource::Quantity, nilable: true, key: targetAverageValue, getter: false, setter: false}}, true)

  JSON.mapping({name:                       {type: String, nilable: false, key: name, getter: false, setter: false},
                target_average_utilization: {type: Int32, nilable: true, key: targetAverageUtilization, getter: false, setter: false},
                target_average_value:       {type: ::Pyrite::V1_6_0::Apimachinery::Api::Resource::Quantity, nilable: true, key: targetAverageValue, getter: false, setter: false}}, true)

  def initialize(@name : String? = nil, @target_average_utilization : Int32? = nil, @target_average_value : ::Pyrite::V1_6_0::Apimachinery::Api::Resource::Quantity = nil)
  end
end
