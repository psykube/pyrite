...
class Pyrite::V1_6_0::Kubernetes::Apis::Authorization::V1beta1::SubjectAccessReviewSpec
  ...
  def initialize(@extra : Hash(String, String)? = nil, @group : Array? = nil, @non_resource_attributes : ::Pyrite::V1_6_0::Kubernetes::Apis::Authorization::V1beta1::NonResourceAttributes = nil, @resource_attributes : ::Pyrite::V1_6_0::Kubernetes::Apis::Authorization::V1beta1::ResourceAttributes = nil, @user : String? = nil)
  end
end
