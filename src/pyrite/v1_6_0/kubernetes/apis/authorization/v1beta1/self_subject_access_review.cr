...
module Pyrite::V1_6_0
  ...
  class Definitions::Kubernetes::Apis::Authorization::V1beta1::SelfSubjectAccessReview
    ...
    def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : Kubernetes::Apis::Authorization::V1beta1::SelfSubjectAccessReviewSpec = nil, @status : Kubernetes::Apis::Authorization::V1beta1::SubjectAccessReviewStatus = nil)
  ...
  module Resources::Authorization::V1beta1
    include Resource
    alias SelfSubjectAccessReview = Definitions::Kubernetes::Apis::Authorization::V1beta1::SelfSubjectAccessReview
  end
end
