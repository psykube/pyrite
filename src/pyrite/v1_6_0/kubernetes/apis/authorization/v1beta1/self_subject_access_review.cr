...
class Pyrite::V1_6_0::Kubernetes::Apis::Authorization::V1beta1::SelfSubjectAccessReview
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Authorization::V1beta1::SelfSubjectAccessReviewSpec = nil, @status : ::Pyrite::V1_6_0::Kubernetes::Apis::Authorization::V1beta1::SubjectAccessReviewStatus = nil)
