...
class Pyrite::V1_6_0::Kubernetes::Apis::Policy::V1beta1::PodDisruptionBudgetStatus
  ...
  def initialize(@current_healthy : Int32? = nil, @desired_healthy : Int32? = nil, @disrupted_pods : Hash(String, String)? = nil, @disruptions_allowed : Int32? = nil, @expected_pods : Int32? = nil, @observed_generation : Int32? = nil)
  end
end
