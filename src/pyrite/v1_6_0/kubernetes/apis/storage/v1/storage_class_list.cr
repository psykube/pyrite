...
class Pyrite::V1_6_0::Kubernetes::Apis::Storage::V1::StorageClassList
  # Items is the list of StorageClasses
  property items : Array(::Pyrite::V1_6_0::Kubernetes::Apis::Storage::V1::StorageClass)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_0::Kubernetes::Apis::Storage::V1::StorageClass), nilable: false, key: items, getter: false, setter: false},
