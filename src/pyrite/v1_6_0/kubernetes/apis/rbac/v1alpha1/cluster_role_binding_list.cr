...
class Pyrite::V1_6_0::Kubernetes::Apis::Rbac::V1alpha1::ClusterRoleBindingList
  # Items is a list of ClusterRoleBindings
  property items : Array(::Pyrite::V1_6_0::Kubernetes::Apis::Rbac::V1alpha1::ClusterRoleBinding)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_0::Kubernetes::Apis::Rbac::V1alpha1::ClusterRoleBinding), nilable: false, key: items, getter: false, setter: false},
  ...
  def create_rbac_authorization_v1alpha1cluster_role_binding(role_ref : ::Pyrite::V1_6_0::Kubernetes::Apis::Rbac::V1alpha1::RoleRef, subjects : Array, metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, context : String? = nil)
  end
