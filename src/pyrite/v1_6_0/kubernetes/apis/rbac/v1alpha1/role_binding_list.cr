...
class Pyrite::V1_6_0::Kubernetes::Apis::Rbac::V1alpha1::RoleBindingList
  # Items is a list of RoleBindings
  property items : Array(::Pyrite::V1_6_0::Kubernetes::Apis::Rbac::V1alpha1::RoleBinding)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_0::Kubernetes::Apis::Rbac::V1alpha1::RoleBinding), nilable: false, key: items, getter: false, setter: false},
  ...
  def create_rbac_authorization_v1alpha1role_binding(role_ref : ::Pyrite::V1_6_0::Kubernetes::Apis::Rbac::V1alpha1::RoleRef, subjects : Array, metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, context : String? = nil)
  end
