...
module Pyrite::V1_6_0
  ...
  class Definitions::Kubernetes::Apis::Rbac::V1beta1::ClusterRoleBindingList
  ...
  module Resources::Rbac::V1beta1
    include Resource
    alias ClusterRoleBindingList = Definitions::Kubernetes::Apis::Rbac::V1beta1::ClusterRoleBindingList
  end
end
