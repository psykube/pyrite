...
class Pyrite::V1_6_0::Kubernetes::Apis::Settings::V1alpha1::PodPresetSpec
  ...
  YAML.mapping({env:           {type: Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::EnvVar), nilable: true, key: env, getter: false, setter: false},
  ...
  JSON.mapping({env:           {type: Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::EnvVar), nilable: true, key: env, getter: false, setter: false},
                env_from:      {type: Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::EnvFromSource), nilable: true, key: envFrom, getter: false, setter: false},
                selector:      {type: ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::LabelSelector, nilable: true, key: selector, getter: false, setter: false},
                volume_mounts: {type: Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::VolumeMount), nilable: true, key: volumeMounts, getter: false, setter: false},
                volumes:       {type: Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::Volume), nilable: true, key: volumes, getter: false, setter: false}}, true)
