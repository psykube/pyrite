...
class Pyrite::V1_6_0::Kubernetes::Apis::Settings::V1alpha1::PodPresetList
  # Items is a list of schema objects.
  property items : Array(::Pyrite::V1_6_0::Kubernetes::Apis::Settings::V1alpha1::PodPreset)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_0::Kubernetes::Apis::Settings::V1alpha1::PodPreset), nilable: false, key: items, getter: false, setter: false},
  ...
  # create a PodPreset
  def create(metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Settings::V1alpha1::PodPresetSpec = nil, context : String? = nil)
  end
