...
class Pyrite::V1_6_0::Kubernetes::Apis::Batch::V2alpha1::JobTemplateSpec
  ...
  YAML.mapping({metadata: {type: ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta, nilable: true, key: metadata, getter: false, setter: false},
                spec:     {type: ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V1::JobSpec, nilable: true, key: spec, getter: false, setter: false}}, true)
  ...
  def initialize(@metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V1::JobSpec = nil)
  end
end
