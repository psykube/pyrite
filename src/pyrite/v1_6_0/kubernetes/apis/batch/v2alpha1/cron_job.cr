...
class Pyrite::V1_6_0::Kubernetes::Apis::Batch::V2alpha1::CronJob
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V2alpha1::CronJobSpec = nil, @status : ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V2alpha1::CronJobStatus = nil)
    @api_version = "CronJob"
    @kind = "v2alpha1"
  end
  ...
  def delete_batch_v2alpha1scheduled_job(grace_period_seconds : Int32? = nil, orphan_dependents : Bool? = nil, preconditions : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::Preconditions = nil, propagation_policy : String? = nil, context : String? = nil)
  end
