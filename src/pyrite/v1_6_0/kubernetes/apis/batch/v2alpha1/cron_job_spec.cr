...
class Pyrite::V1_6_0::Kubernetes::Apis::Batch::V2alpha1::CronJobSpec
  ...
  property job_template : ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V2alpha1::JobTemplateSpec
  ...
  YAML.mapping({concurrency_policy:            {type: String, nilable: true, key: concurrencyPolicy, getter: false, setter: false},
                ...
                job_template:                  {type: ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V2alpha1::JobTemplateSpec, nilable: false, key: jobTemplate, getter: false, setter: false},
  ...
  def initialize(@concurrency_policy : String? = nil, @failed_jobs_history_limit : Int32? = nil, @job_template : ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V2alpha1::JobTemplateSpec = nil, @schedule : String? = nil, @starting_deadline_seconds : Int32? = nil, @successful_jobs_history_limit : Int32? = nil, @suspend : Bool? = nil)
  end
end
