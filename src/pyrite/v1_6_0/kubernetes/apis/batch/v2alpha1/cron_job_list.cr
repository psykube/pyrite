...
class Pyrite::V1_6_0::Kubernetes::Apis::Batch::V2alpha1::CronJobList
  # Items is the list of CronJob.
  property items : Array(::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V2alpha1::CronJob)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V2alpha1::CronJob), nilable: false, key: items, getter: false, setter: false},
  ...
  # create a CronJob
  def create(metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V2alpha1::CronJobSpec = nil, status : ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V2alpha1::CronJobStatus = nil, context : String? = nil)
  end
  ...
  def create_batch_v2alpha1scheduled_job(metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V2alpha1::CronJobSpec = nil, status : ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V2alpha1::CronJobStatus = nil, context : String? = nil)
  end
