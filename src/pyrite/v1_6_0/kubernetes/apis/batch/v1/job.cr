...
class Pyrite::V1_6_0::Kubernetes::Apis::Batch::V1::Job
  ...
  property spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V1::JobSpec
  ...
  property status : ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V1::JobStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V1::JobSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V1::JobStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V1::JobSpec = nil, @status : ::Pyrite::V1_6_0::Kubernetes::Apis::Batch::V1::JobStatus = nil)
    @api_version = "Job"
    @kind = "v1"
  end
