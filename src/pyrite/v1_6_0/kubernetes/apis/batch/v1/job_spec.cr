...
class Pyrite::V1_6_0::Kubernetes::Apis::Batch::V1::JobSpec
  ...
  def initialize(@active_deadline_seconds : Int32? = nil, @completions : Int32? = nil, @manual_selector : Bool? = nil, @parallelism : Int32? = nil, @selector : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::LabelSelector = nil, @template : ::Pyrite::V1_6_0::Kubernetes::Api::V1::PodTemplateSpec = nil)
  end
end
