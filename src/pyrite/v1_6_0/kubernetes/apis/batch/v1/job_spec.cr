...
module Pyrite::V1_6_0
  ...
  class Definitions::Kubernetes::Apis::Batch::V1::JobSpec
    ...
    def initialize(@active_deadline_seconds : Int32? = nil, @completions : Int32? = nil, @manual_selector : Bool? = nil, @parallelism : Int32? = nil, @selector : Apimachinery::Apis::Meta::V1::LabelSelector = nil, @template : Kubernetes::Api::V1::PodTemplateSpec = nil)
    end
  end
end
