...
class Pyrite::V1_6_0::Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequestSpec
  ...
  def initialize(@request, @extra = nil, @groups = nil, @uid = nil, @usages = nil, @username = nil)
  end
end
