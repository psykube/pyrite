...
class Pyrite::V1_6_0::Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequestStatus
  # If request was approved, the controller will place the issued certificate here.
  property certificate : String?

  # Conditions applied to the request, such as approval or denial.
  property conditions : Array(::Pyrite::V1_6_0::Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequestCondition)?
