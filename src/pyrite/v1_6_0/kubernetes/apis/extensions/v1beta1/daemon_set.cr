...
class Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::DaemonSet
  ...
  property spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::DaemonSetSpec
  ...
  property status : ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::DaemonSetStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::DaemonSetSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::DaemonSetStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::DaemonSetSpec = nil, @status : ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::DaemonSetStatus = nil)
