...
class Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::DeploymentCondition
  ...
  YAML.mapping({last_transition_time: {type: ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: lastTransitionTime, getter: false, setter: false},
                last_update_time:     {type: ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: lastUpdateTime, getter: false, setter: false},
  ...
  def initialize(@last_transition_time : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::Time = nil, @last_update_time : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::Time = nil, @message : String? = nil, @reason : String? = nil, @status : String? = nil, @type : String? = nil)
  end
end
