...
class Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::PodSecurityPolicyList
  ...
  def create(metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::PodSecurityPolicySpec = nil, context : String? = nil)
  end
