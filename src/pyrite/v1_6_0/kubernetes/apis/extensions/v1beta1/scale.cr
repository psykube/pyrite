...
class Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::Scale
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::ScaleSpec = nil, @status : ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::ScaleStatus = nil)
    @api_version = "Scale"
    @kind = "v1beta1"
  end
