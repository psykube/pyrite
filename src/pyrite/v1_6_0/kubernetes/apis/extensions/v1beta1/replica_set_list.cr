...
class Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::ReplicaSetList
  ...
  # create a ReplicaSet
  def create(metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::ReplicaSetSpec = nil, status : ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::ReplicaSetStatus = nil, context : String? = nil)
  end
