...
class Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::ReplicaSetSpec
  ...
  def initialize(@min_ready_seconds : Int32? = nil, @replicas : Int32? = nil, @selector : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::LabelSelector = nil, @template : ::Pyrite::V1_6_0::Kubernetes::Api::V1::PodTemplateSpec = nil)
  end
end
