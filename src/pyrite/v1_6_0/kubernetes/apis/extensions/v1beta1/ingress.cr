...
class Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::Ingress
  ...
  property spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::IngressSpec
  ...
  property status : ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::IngressStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::IngressSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::IngressStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::IngressSpec = nil, @status : ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::IngressStatus = nil)
    @api_version = "Ingress"
    @kind = "v1beta1"
  end
