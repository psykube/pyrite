...
class Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::IngressList
  ...
  # create an Ingress
  def create(metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::IngressSpec = nil, status : ::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::IngressStatus = nil, context : String? = nil)
  end
