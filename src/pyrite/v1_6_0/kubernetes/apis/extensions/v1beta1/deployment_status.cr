...
class Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::DeploymentStatus
  # Total number of available pods (ready for at least minReadySeconds) targeted by this deployment.
  property available_replicas : Int32?

  # Represents the latest available observations of a deployment's current state.
  property conditions : Array(::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::DeploymentCondition)?
  ...
  YAML.mapping({available_replicas:   {type: Int32, nilable: true, key: availableReplicas, getter: false, setter: false},
                conditions:           {type: Array(::Pyrite::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::DeploymentCondition), nilable: true, key: conditions, getter: false, setter: false},
