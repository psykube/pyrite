...
class Pyrite::V1_6_0::Kubernetes::Apis::Authentication::V1beta1::TokenReview
  ...
  property spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Authentication::V1beta1::TokenReviewSpec

  # Status is filled in by the server and indicates whether the request can be authenticated.
  property status : ::Pyrite::V1_6_0::Kubernetes::Apis::Authentication::V1beta1::TokenReviewStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::Pyrite::V1_6_0::Kubernetes::Apis::Authentication::V1beta1::TokenReviewSpec, nilable: false, key: spec, getter: false, setter: false},
