...
class Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::Deployment
  # Standard object metadata.
  property metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta

  # Specification of the desired behavior of the Deployment.
  property spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentSpec

  # Most recently observed status of the Deployment.
  property status : ::Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentSpec = nil, @status : ::Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentStatus = nil)
