...
class Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentSpec
  ...
  property rollback_to : ::Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::RollbackConfig

  # Label selector for pods. Existing ReplicaSets whose pods are selected by this will be the ones affected by this deployment.
  property selector : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::LabelSelector

  # The deployment strategy to use to replace existing pods with new ones.
  property strategy : ::Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentStrategy
  ...
  YAML.mapping({min_ready_seconds:         {type: Int32, nilable: true, key: minReadySeconds, getter: false, setter: false},
                ...
                rollback_to:               {type: ::Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::RollbackConfig, nilable: true, key: rollbackTo, getter: false, setter: false},
                selector:                  {type: ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::LabelSelector, nilable: true, key: selector, getter: false, setter: false},
                strategy:                  {type: ::Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentStrategy, nilable: true, key: strategy, getter: false, setter: false},
                template:                  {type: ::Pyrite::V1_6_0::Kubernetes::Api::V1::PodTemplateSpec, nilable: false, key: template, getter: false, setter: false}}, true)
  ...
  def initialize(@min_ready_seconds : Int32? = nil, @paused : Bool? = nil, @progress_deadline_seconds : Int32? = nil, @replicas : Int32? = nil, @revision_history_limit : Int32? = nil, @rollback_to : ::Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::RollbackConfig = nil, @selector : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::LabelSelector = nil, @strategy : ::Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentStrategy = nil, @template : ::Pyrite::V1_6_0::Kubernetes::Api::V1::PodTemplateSpec = nil)
  end
end
