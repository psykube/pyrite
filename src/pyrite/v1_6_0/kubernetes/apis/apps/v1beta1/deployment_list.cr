...
class Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentList
  # Items is the list of Deployments.
  property items : Array(::Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::Deployment)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::Deployment), nilable: false, key: items, getter: false, setter: false},
  ...
  # create a Deployment
  def create(metadata : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentSpec = nil, status : ::Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentStatus = nil, context : String? = nil)
  end
