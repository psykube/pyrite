...
module Pyrite::V1_6_0
  ...
  class Definitions::Kubernetes::Apis::Apps::V1beta1::StatefulSetSpec
    ...
    property volume_claim_templates : Array(Kubernetes::Api::V1::PersistentVolumeClaim)?
    ...
    YAML.mapping({replicas:               {type: Int32, nilable: true, key: replicas, getter: false, setter: false},
                  ...
                  volume_claim_templates: {type: Array(Kubernetes::Api::V1::PersistentVolumeClaim), nilable: true, key: volumeClaimTemplates, getter: false, setter: false}}, true)
    ...
    def initialize(@replicas : Int32? = nil, @selector : Apimachinery::Apis::Meta::V1::LabelSelector = nil, @service_name : String? = nil, @template : Kubernetes::Api::V1::PodTemplateSpec = nil, @volume_claim_templates : Array? = nil)
    end
  end
end
