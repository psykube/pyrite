...
class Pyrite::V1_6_0::Kubernetes::Apis::Apps::V1beta1::StatefulSetSpec
  ...
  property volume_claim_templates : Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::PersistentVolumeClaim)?
  ...
  YAML.mapping({replicas:               {type: Int32, nilable: true, key: replicas, getter: false, setter: false},
                ...
                volume_claim_templates: {type: Array(::Pyrite::V1_6_0::Kubernetes::Api::V1::PersistentVolumeClaim), nilable: true, key: volumeClaimTemplates, getter: false, setter: false}}, true)
  ...
  def initialize(@replicas : Int32? = nil, @selector : ::Pyrite::V1_6_0::Apimachinery::Apis::Meta::V1::LabelSelector = nil, @service_name : String? = nil, @template : ::Pyrite::V1_6_0::Kubernetes::Api::V1::PodTemplateSpec = nil, @volume_claim_templates : Array? = nil)
  end
end
