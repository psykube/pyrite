...
module Pyrite::V1_5_2
  ...
  class Definitions::V1alpha1::PolicyRule
    # APIGroups is the name of the APIGroup that contains the resources.  If multiple API groups are specified, any action requested against one of the enumerated resources in any API group will be allowed.
    property api_groups : Array(String)?

    # AttributeRestrictions will vary depending on what the [Authorizer/AuthorizationAttributeBuilder pair supports. If the Authorizer does not recognize how to handle the AttributeRestrictions, the Authorizer should report an error.](Authorizer/AuthorizationAttributeBuilder pair supports. If the Authorizer does not recognize how to handle the AttributeRestrictions, the Authorizer should report an error.)
    property attribute_restrictions : Runtime::RawExtension
    ...
    YAML.mapping({api_groups:             {type: Array(String), nilable: true, key: apiGroups, getter: false, setter: false},
                  attribute_restrictions: {type: Runtime::RawExtension, nilable: true, key: attributeRestrictions, getter: false, setter: false},
    ...
    def initialize(@api_groups : Array? = nil, @attribute_restrictions : Runtime::RawExtension = nil, @non_resource_ur_ls : Array? = nil, @resource_names : Array? = nil, @resources : Array? = nil, @verbs : Array? = nil)
    end
  end
end
