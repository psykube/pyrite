...
module Pyrite::V1_5_2
  ...
  class Definitions::V1::ServicePort
    ...
    property target_port : Intstr::IntOrString
    ...
    YAML.mapping({name:        {type: String, nilable: true, key: name, getter: false, setter: false},
                  ...
                  target_port: {type: Intstr::IntOrString, nilable: true, key: targetPort, getter: false, setter: false}}, true)
    ...
    def initialize(@name : String? = nil, @node_port : Int32? = nil, @port : Int32? = nil, @protocol : String? = nil, @target_port : Intstr::IntOrString = nil)
    end
  end
end
