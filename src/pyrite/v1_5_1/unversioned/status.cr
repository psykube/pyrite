...
module Pyrite::V1_5_1
  ...
  class Definitions::Unversioned::Status
    ...
    YAML.mapping({code:     {type: Int32, nilable: true, key: code, getter: false, setter: false},
                  ...
                  status:   {type: String, nilable: true, key: status, getter: false, setter: false}}, true)

    JSON.mapping({code:     {type: Int32, nilable: true, key: code, getter: false, setter: false},
                  details:  {type: Unversioned::StatusDetails, nilable: true, key: details, getter: false, setter: false},
                  message:  {type: String, nilable: true, key: message, getter: false, setter: false},
                  metadata: {type: Unversioned::ListMeta, nilable: true, key: metadata, getter: false, setter: false},
                  reason:   {type: String, nilable: true, key: reason, getter: false, setter: false},
    ...
    def initialize(@code : Int32? = nil, @details : Unversioned::StatusDetails = nil, @message : String? = nil, @metadata : Unversioned::ListMeta = nil, @reason : String? = nil, @status : String? = nil)
    end
  end
end
