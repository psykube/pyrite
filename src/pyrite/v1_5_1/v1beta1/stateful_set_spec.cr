...
module Pyrite::V1_5_1
  ...
  class Definitions::V1beta1::StatefulSetSpec
    ...
    property volume_claim_templates : Array(V1::PersistentVolumeClaim)?
    ...
    YAML.mapping({replicas:               {type: Int32, nilable: true, key: replicas, getter: false, setter: false},
                  ...
                  template:               {type: V1::PodTemplateSpec, nilable: false, key: template, getter: false, setter: false},
                  volume_claim_templates: {type: Array(V1::PersistentVolumeClaim), nilable: true, key: volumeClaimTemplates, getter: false, setter: false}}, true)
    ...
    def initialize(@replicas : Int32? = nil, @selector : Unversioned::LabelSelector = nil, @service_name : String? = nil, @template : V1::PodTemplateSpec = nil, @volume_claim_templates : Array? = nil)
    end
  end
end
