...
module Pyrite::V1_5_1
  ...
  class Definitions::V1::JobStatus
    ...
    property conditions : Array(V1::JobCondition)?
    ...
    YAML.mapping({active:          {type: Int32, nilable: true, key: active, getter: false, setter: false},
                  ...
                  conditions:      {type: Array(V1::JobCondition), nilable: true, key: conditions, getter: false, setter: false},
