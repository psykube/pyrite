...
module Pyrite::V1_5_1
  ...
  class Definitions::V1::EnvVar
    ...
    property value_from : V1::EnvVarSource
    ...
    YAML.mapping({name:       {type: String, nilable: false, key: name, getter: false, setter: false},
                  ...
                  value_from: {type: V1::EnvVarSource, nilable: true, key: valueFrom, getter: false, setter: false}}, true)

    JSON.mapping({name:       {type: String, nilable: false, key: name, getter: false, setter: false},
                  value:      {type: String, nilable: true, key: value, getter: false, setter: false},
                  value_from: {type: V1::EnvVarSource, nilable: true, key: valueFrom, getter: false, setter: false}}, true)

    def initialize(@name : String? = nil, @value : String? = nil, @value_from : V1::EnvVarSource = nil)
    end
  end
end
