...
module Pyrite::V1_5_1
  ...
  class Definitions::V1::Event
    ...
    YAML.mapping({count:           {type: Int32, nilable: true, key: count, getter: false, setter: false},
    ...
    JSON.mapping({count:           {type: Int32, nilable: true, key: count, getter: false, setter: false},
                  first_timestamp: {type: Unversioned::Time, nilable: true, key: firstTimestamp, getter: false, setter: false},
                  involved_object: {type: V1::ObjectReference, nilable: false, key: involvedObject, getter: false, setter: false},
                  last_timestamp:  {type: Unversioned::Time, nilable: true, key: lastTimestamp, getter: false, setter: false},
                  message:         {type: String, nilable: true, key: message, getter: false, setter: false},
    ...
    def initialize(@count : Int32? = nil, @first_timestamp : Unversioned::Time = nil, @involved_object : V1::ObjectReference = nil, @last_timestamp : Unversioned::Time = nil, @message : String? = nil, @metadata : V1::ObjectMeta = nil, @reason : String? = nil, @source : V1::EventSource = nil, @type : String? = nil)
    end
  end
end
