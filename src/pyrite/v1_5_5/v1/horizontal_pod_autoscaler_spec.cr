...
module Pyrite::V1_5_5
  ...
  class Definitions::V1::HorizontalPodAutoscalerSpec
    ...
    property scale_target_ref : V1::CrossVersionObjectReference
    ...
    YAML.mapping({max_replicas:                      {type: Int32, nilable: false, key: maxReplicas, getter: false, setter: false},
                  ...
                  scale_target_ref:                  {type: V1::CrossVersionObjectReference, nilable: false, key: scaleTargetRef, getter: false, setter: false},
    ...
    def initialize(@max_replicas : Int32? = nil, @min_replicas : Int32? = nil, @scale_target_ref : V1::CrossVersionObjectReference = nil, @target_cpu_utilization_percentage : Int32? = nil)
    end
  end
end
