...
module Pyrite::V1_5_0
  ...
  class Definitions::V1::ReplicationControllerSpec
    ...
    def initialize(@min_ready_seconds : Int32? = nil, @replicas : Int32? = nil, @selector : Hash(String, String)? = nil, @template : V1::PodTemplateSpec = nil)
    end
  end
end
