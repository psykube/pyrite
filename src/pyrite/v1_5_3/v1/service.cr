...
module Pyrite::V1_5_3
  ...
  class Definitions::V1::Service
    ...
    YAML.mapping({
      ...
      status:      {type: V1::ServiceStatus, nilable: true, key: status, getter: false, setter: false},
    }, true)
    ...
    def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : V1::ObjectMeta = nil, @spec : V1::ServiceSpec = nil, @status : V1::ServiceStatus = nil)
      @api_version = "v1"
      @kind = "Service"
    end
  end
  ...
  module Resources::V1
    include Resource
    alias Service = Definitions::V1::Service
  end
end
