...
module Pyrite::V1_5_3
  ...
  class Definitions::V1::Probe
    ...
    YAML.mapping({exec:                  {type: V1::ExecAction, nilable: true, key: exec, getter: false, setter: false},
                  ...
                  tcp_socket:            {type: V1::TCPSocketAction, nilable: true, key: tcpSocket, getter: false, setter: false},
    ...
    def initialize(@exec : V1::ExecAction = nil, @failure_threshold : Int32? = nil, @http_get : V1::HTTPGetAction = nil, @initial_delay_seconds : Int32? = nil, @period_seconds : Int32? = nil, @success_threshold : Int32? = nil, @tcp_socket : V1::TCPSocketAction = nil, @timeout_seconds : Int32? = nil)
    end
  end
end
