...
module Pyrite::V1_6_1
  ...
  class Definitions::Kubernetes::Api::V1::RBDVolumeSource
    ...
    def initialize(@fs_type : String? = nil, @image : String? = nil, @keyring : String? = nil, @monitors : Array? = nil, @pool : String? = nil, @read_only : Bool? = nil, @secret_ref : Kubernetes::Api::V1::LocalObjectReference = nil, @user : String? = nil)
    end
  end
end
