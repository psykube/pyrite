...
class Pyrite::V1_6_1::Kubernetes::Api::V1::PodStatus
  ...
  property conditions : Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::PodCondition)?
  ...
  property container_statuses : Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerStatus)?
  ...
  property init_container_statuses : Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerStatus)?
  ...
  YAML.mapping({conditions:              {type: Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::PodCondition), nilable: true, key: conditions, getter: false, setter: false},
                container_statuses:      {type: Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerStatus), nilable: true, key: containerStatuses, getter: false, setter: false},
                host_ip:                 {type: String, nilable: true, key: hostIP, getter: false, setter: false},
                init_container_statuses: {type: Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerStatus), nilable: true, key: initContainerStatuses, getter: false, setter: false},
                ...
                start_time:              {type: ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: startTime, getter: false, setter: false}}, true)

  JSON.mapping({conditions:              {type: Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::PodCondition), nilable: true, key: conditions, getter: false, setter: false},
                container_statuses:      {type: Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerStatus), nilable: true, key: containerStatuses, getter: false, setter: false},
                host_ip:                 {type: String, nilable: true, key: hostIP, getter: false, setter: false},
                init_container_statuses: {type: Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerStatus), nilable: true, key: initContainerStatuses, getter: false, setter: false},
                message:                 {type: String, nilable: true, key: message, getter: false, setter: false},
  ...
  def initialize(@conditions : Array? = nil, @container_statuses : Array? = nil, @host_ip : String? = nil, @init_container_statuses : Array? = nil, @message : String? = nil, @phase : String? = nil, @pod_ip : String? = nil, @qos_class : String? = nil, @reason : String? = nil, @start_time : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Time = nil)
  end
end
