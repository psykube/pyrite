...
class Pyrite::V1_6_1::Kubernetes::Api::V1::PersistentVolumeClaimList
  ...
  def create(metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_1::Kubernetes::Api::V1::PersistentVolumeClaimSpec = nil, status : ::Pyrite::V1_6_1::Kubernetes::Api::V1::PersistentVolumeClaimStatus = nil, context : String? = nil)
  end
