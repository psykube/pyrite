...
class Pyrite::V1_6_1::Kubernetes::Api::V1::ComponentStatus
  ...
  YAML.mapping({
    ...
    conditions:  {type: Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::ComponentCondition), nilable: true, key: conditions, getter: false, setter: false},
