...
class Pyrite::V1_6_1::Kubernetes::Api::V1::ISCSIVolumeSource
  ...
  def initialize(@fs_type : String? = nil, @iqn : String? = nil, @iscsi_interface : String? = nil, @lun : Int32? = nil, @portals : Array? = nil, @read_only : Bool? = nil, @target_portal : String? = nil)
  end
end
