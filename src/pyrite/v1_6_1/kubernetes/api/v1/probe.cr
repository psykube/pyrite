...
class Pyrite::V1_6_1::Kubernetes::Api::V1::Probe
  # One and only one of the following should be specified. Exec specifies the action to take.
  property exec : ::Pyrite::V1_6_1::Kubernetes::Api::V1::ExecAction

  # Minimum consecutive failures for the probe to be considered failed after having succeeded. Defaults to 3. Minimum value is 1.
  property failure_threshold : Int32?

  # HTTPGet specifies the http request to perform.
  property http_get : ::Pyrite::V1_6_1::Kubernetes::Api::V1::HTTPGetAction
  ...
  property tcp_socket : ::Pyrite::V1_6_1::Kubernetes::Api::V1::TCPSocketAction
  ...
  YAML.mapping({exec:                  {type: ::Pyrite::V1_6_1::Kubernetes::Api::V1::ExecAction, nilable: true, key: exec, getter: false, setter: false},
                failure_threshold:     {type: Int32, nilable: true, key: failureThreshold, getter: false, setter: false},
                http_get:              {type: ::Pyrite::V1_6_1::Kubernetes::Api::V1::HTTPGetAction, nilable: true, key: httpGet, getter: false, setter: false},
                ...
                tcp_socket:            {type: ::Pyrite::V1_6_1::Kubernetes::Api::V1::TCPSocketAction, nilable: true, key: tcpSocket, getter: false, setter: false},
                timeout_seconds:       {type: Int32, nilable: true, key: timeoutSeconds, getter: false, setter: false}}, true)

  JSON.mapping({exec:                  {type: ::Pyrite::V1_6_1::Kubernetes::Api::V1::ExecAction, nilable: true, key: exec, getter: false, setter: false},
                failure_threshold:     {type: Int32, nilable: true, key: failureThreshold, getter: false, setter: false},
                http_get:              {type: ::Pyrite::V1_6_1::Kubernetes::Api::V1::HTTPGetAction, nilable: true, key: httpGet, getter: false, setter: false},
                initial_delay_seconds: {type: Int32, nilable: true, key: initialDelaySeconds, getter: false, setter: false},
                period_seconds:        {type: Int32, nilable: true, key: periodSeconds, getter: false, setter: false},
  ...
  def initialize(@exec : ::Pyrite::V1_6_1::Kubernetes::Api::V1::ExecAction = nil, @failure_threshold : Int32? = nil, @http_get : ::Pyrite::V1_6_1::Kubernetes::Api::V1::HTTPGetAction = nil, @initial_delay_seconds : Int32? = nil, @period_seconds : Int32? = nil, @success_threshold : Int32? = nil, @tcp_socket : ::Pyrite::V1_6_1::Kubernetes::Api::V1::TCPSocketAction = nil, @timeout_seconds : Int32? = nil)
  end
end
