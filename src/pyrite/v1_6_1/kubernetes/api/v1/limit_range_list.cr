...
class Pyrite::V1_6_1::Kubernetes::Api::V1::LimitRangeList
  ...
  property items : Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::LimitRange)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::LimitRange), nilable: false, key: items, getter: false, setter: false},
  ...
  # create a LimitRange
  def create(metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_1::Kubernetes::Api::V1::LimitRangeSpec = nil, context : String? = nil)
  end
