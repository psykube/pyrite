...
module Pyrite::V1_6_1
  ...
  class Definitions::Kubernetes::Api::V1::ScaleIOVolumeSource
    ...
    def initialize(@fs_type : String? = nil, @gateway : String? = nil, @protection_domain : String? = nil, @read_only : Bool? = nil, @secret_ref : Kubernetes::Api::V1::LocalObjectReference = nil, @ssl_enabled : Bool? = nil, @storage_mode : String? = nil, @storage_pool : String? = nil, @system : String? = nil, @volume_name : String? = nil)
    end
  end
end
