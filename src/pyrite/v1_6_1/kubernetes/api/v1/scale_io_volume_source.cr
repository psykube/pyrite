...
class Pyrite::V1_6_1::Kubernetes::Api::V1::ScaleIOVolumeSource
  ...
  YAML.mapping({fs_type:           {type: String, nilable: true, key: fsType, getter: false, setter: false},
                ...
                secret_ref:        {type: ::Pyrite::V1_6_1::Kubernetes::Api::V1::LocalObjectReference, nilable: false, key: secretRef, getter: false, setter: false},
  ...
  def initialize(@fs_type : String? = nil, @gateway : String? = nil, @protection_domain : String? = nil, @read_only : Bool? = nil, @secret_ref : ::Pyrite::V1_6_1::Kubernetes::Api::V1::LocalObjectReference = nil, @ssl_enabled : Bool? = nil, @storage_mode : String? = nil, @storage_pool : String? = nil, @system : String? = nil, @volume_name : String? = nil)
  end
end
