...
class Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerState
  ...
  property terminated : ::Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerStateTerminated

  # Details about a waiting container
  property waiting : ::Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerStateWaiting

  YAML.mapping({running:    {type: ::Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerStateRunning, nilable: true, key: running, getter: false, setter: false},
  ...
  JSON.mapping({running:    {type: ::Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerStateRunning, nilable: true, key: running, getter: false, setter: false},
                terminated: {type: ::Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerStateTerminated, nilable: true, key: terminated, getter: false, setter: false},
                waiting:    {type: ::Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerStateWaiting, nilable: true, key: waiting, getter: false, setter: false}}, true)
