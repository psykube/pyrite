...
class Pyrite::V1_6_1::Kubernetes::Api::V1::Service
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : ::Pyrite::V1_6_1::Kubernetes::Api::V1::ServiceSpec = nil, @status : ::Pyrite::V1_6_1::Kubernetes::Api::V1::ServiceStatus = nil)
    @api_version = "Service"
    @kind = "v1"
  end
