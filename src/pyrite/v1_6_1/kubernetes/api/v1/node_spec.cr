...
class Pyrite::V1_6_1::Kubernetes::Api::V1::NodeSpec
  ...
  property taints : Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::Taint)?
  ...
  YAML.mapping({external_id:   {type: String, nilable: true, key: externalID, getter: false, setter: false},
                ...
                taints:        {type: Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::Taint), nilable: true, key: taints, getter: false, setter: false},
