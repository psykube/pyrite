...
class Pyrite::V1_6_1::Kubernetes::Api::V1::ServiceList
  ...
  # create a Service
  def create(metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_1::Kubernetes::Api::V1::ServiceSpec = nil, status : ::Pyrite::V1_6_1::Kubernetes::Api::V1::ServiceStatus = nil, context : String? = nil)
  end
