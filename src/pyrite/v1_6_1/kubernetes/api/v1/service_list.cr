...
class Pyrite::V1_6_1::Kubernetes::Api::V1::ServiceList
  # List of services
  property items : Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::Service)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::Service), nilable: false, key: items, getter: false, setter: false},
