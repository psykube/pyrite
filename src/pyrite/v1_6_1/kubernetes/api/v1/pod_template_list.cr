...
class Pyrite::V1_6_1::Kubernetes::Api::V1::PodTemplateList
  # List of pod templates
  property items : Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::PodTemplate)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::PodTemplate), nilable: false, key: items, getter: false, setter: false},
  ...
  def create(metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, template : ::Pyrite::V1_6_1::Kubernetes::Api::V1::PodTemplateSpec = nil, context : String? = nil)
  end
