...
class Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerStatus
  ...
  def initialize(@container_id : String? = nil, @image : String? = nil, @image_id : String? = nil, @last_state : ::Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerState = nil, @name : String? = nil, @ready : Bool? = nil, @restart_count : Int32? = nil, @state : ::Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerState = nil)
  end
end
