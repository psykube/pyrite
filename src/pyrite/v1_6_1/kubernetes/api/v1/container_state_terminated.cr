...
class Pyrite::V1_6_1::Kubernetes::Api::V1::ContainerStateTerminated
  ...
  def initialize(@container_id : String? = nil, @exit_code : Int32? = nil, @finished_at : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Time = nil, @message : String? = nil, @reason : String? = nil, @signal : Int32? = nil, @started_at : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Time = nil)
  end
end
