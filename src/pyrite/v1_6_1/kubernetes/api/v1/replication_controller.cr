...
class Pyrite::V1_6_1::Kubernetes::Api::V1::ReplicationController
  ...
  property spec : ::Pyrite::V1_6_1::Kubernetes::Api::V1::ReplicationControllerSpec
  ...
  property status : ::Pyrite::V1_6_1::Kubernetes::Api::V1::ReplicationControllerStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::Pyrite::V1_6_1::Kubernetes::Api::V1::ReplicationControllerSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::Pyrite::V1_6_1::Kubernetes::Api::V1::ReplicationControllerStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : ::Pyrite::V1_6_1::Kubernetes::Api::V1::ReplicationControllerSpec = nil, @status : ::Pyrite::V1_6_1::Kubernetes::Api::V1::ReplicationControllerStatus = nil)
