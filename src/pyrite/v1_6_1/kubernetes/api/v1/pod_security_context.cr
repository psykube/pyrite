...
class Pyrite::V1_6_1::Kubernetes::Api::V1::PodSecurityContext
  ...
  YAML.mapping({fs_group:            {type: Int32, nilable: true, key: fsGroup, getter: false, setter: false},
                ...
                se_linux_options:    {type: ::Pyrite::V1_6_1::Kubernetes::Api::V1::SELinuxOptions, nilable: true, key: seLinuxOptions, getter: false, setter: false},
  ...
  def initialize(@fs_group : Int32? = nil, @run_as_non_root : Bool? = nil, @run_as_user : Int32? = nil, @se_linux_options : ::Pyrite::V1_6_1::Kubernetes::Api::V1::SELinuxOptions = nil, @supplemental_groups : Array? = nil)
  end
end
