...
module Pyrite::V1_6_1
  ...
  class Definitions::Kubernetes::Api::V1::PodSpec
    # Optional duration in seconds the pod may be active on the node relative to StartTime before the system will actively try to mark it failed and kill associated containers. Value must be a positive integer.
    property active_deadline_seconds : Int32?

    # If specified, the pod's scheduling constraints
    property affinity : Kubernetes::Api::V1::Affinity
    ...
    property init_containers : Array(Kubernetes::Api::V1::Container)?
    ...
    property security_context : Kubernetes::Api::V1::PodSecurityContext
    ...
    property tolerations : Array(Kubernetes::Api::V1::Toleration)?
    ...
    YAML.mapping({active_deadline_seconds:          {type: Int32, nilable: true, key: activeDeadlineSeconds, getter: false, setter: false},
                  ...
                  containers:                       {type: Array(Kubernetes::Api::V1::Container), nilable: false, key: containers, getter: false, setter: false},
                  ...
                  init_containers:                  {type: Array(Kubernetes::Api::V1::Container), nilable: true, key: initContainers, getter: false, setter: false},
                  ...
                  security_context:                 {type: Kubernetes::Api::V1::PodSecurityContext, nilable: true, key: securityContext, getter: false, setter: false},
                  ...
                  tolerations:                      {type: Array(Kubernetes::Api::V1::Toleration), nilable: true, key: tolerations, getter: false, setter: false},
