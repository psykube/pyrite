...
class Pyrite::V1_6_1::Kubernetes::Api::V1::PodTemplate
  ...
  YAML.mapping({
    ...
    template:    {type: ::Pyrite::V1_6_1::Kubernetes::Api::V1::PodTemplateSpec, nilable: true, key: template, getter: false, setter: false},
  }, true)
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @template : ::Pyrite::V1_6_1::Kubernetes::Api::V1::PodTemplateSpec = nil)
