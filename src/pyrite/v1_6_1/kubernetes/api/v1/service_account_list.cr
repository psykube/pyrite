...
class Pyrite::V1_6_1::Kubernetes::Api::V1::ServiceAccountList
  ...
  def create(automount_service_account_token : Bool? = nil, image_pull_secrets : Array? = nil, metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, secrets : Array? = nil, context : String? = nil)
  end
