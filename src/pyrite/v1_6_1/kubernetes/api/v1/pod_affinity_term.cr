...
class Pyrite::V1_6_1::Kubernetes::Api::V1::PodAffinityTerm
  # A label query over a set of resources, in this case pods.
  property label_selector : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::LabelSelector
  ...
  JSON.mapping({label_selector: {type: ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::LabelSelector, nilable: true, key: labelSelector, getter: false, setter: false},
                namespaces:     {type: Array(String), nilable: true, key: namespaces, getter: false, setter: false},
                topology_key:   {type: String, nilable: true, key: topologyKey, getter: false, setter: false}}, true)
