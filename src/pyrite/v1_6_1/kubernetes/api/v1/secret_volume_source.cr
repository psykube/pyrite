...
class Pyrite::V1_6_1::Kubernetes::Api::V1::SecretVolumeSource
  ...
  YAML.mapping({default_mode: {type: Int32, nilable: true, key: defaultMode, getter: false, setter: false},
                items:        {type: Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::KeyToPath), nilable: true, key: items, getter: false, setter: false},
