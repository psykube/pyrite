...
module Pyrite::V1_6_1
  ...
  class Definitions::Kubernetes::Api::V1::SecurityContext
    ...
    property capabilities : Kubernetes::Api::V1::Capabilities
    ...
    YAML.mapping({capabilities:              {type: Kubernetes::Api::V1::Capabilities, nilable: true, key: capabilities, getter: false, setter: false},
    ...
    JSON.mapping({capabilities:              {type: Kubernetes::Api::V1::Capabilities, nilable: true, key: capabilities, getter: false, setter: false},
                  privileged:                {type: Bool, nilable: true, key: privileged, getter: false, setter: false},
                  read_only_root_filesystem: {type: Bool, nilable: true, key: readOnlyRootFilesystem, getter: false, setter: false},
                  run_as_non_root:           {type: Bool, nilable: true, key: runAsNonRoot, getter: false, setter: false},
                  run_as_user:               {type: Int32, nilable: true, key: runAsUser, getter: false, setter: false},
    ...
    def initialize(@capabilities : Kubernetes::Api::V1::Capabilities = nil, @privileged : Bool? = nil, @read_only_root_filesystem : Bool? = nil, @run_as_non_root : Bool? = nil, @run_as_user : Int32? = nil, @se_linux_options : Kubernetes::Api::V1::SELinuxOptions = nil)
    end
  end
end
