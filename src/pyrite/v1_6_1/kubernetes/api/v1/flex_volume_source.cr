...
class Pyrite::V1_6_1::Kubernetes::Api::V1::FlexVolumeSource
  ...
  def initialize(@driver : String? = nil, @fs_type : String? = nil, @options : Hash(String, String)? = nil, @read_only : Bool? = nil, @secret_ref : ::Pyrite::V1_6_1::Kubernetes::Api::V1::LocalObjectReference = nil)
  end
end
