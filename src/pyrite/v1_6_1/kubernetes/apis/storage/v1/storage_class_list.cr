...
class Pyrite::V1_6_1::Kubernetes::Apis::Storage::V1::StorageClassList
  # Items is the list of StorageClasses
  property items : Array(::Pyrite::V1_6_1::Kubernetes::Apis::Storage::V1::StorageClass)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_1::Kubernetes::Apis::Storage::V1::StorageClass), nilable: false, key: items, getter: false, setter: false},
  ...
  def create(provisioner : String, metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, parameters : Hash(String, String)? = nil, context : String? = nil)
  end
