...
class Pyrite::V1_6_1::Kubernetes::Apis::Policy::V1beta1::PodDisruptionBudgetList
  ...
  def create(metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_1::Kubernetes::Apis::Policy::V1beta1::PodDisruptionBudgetSpec = nil, status : ::Pyrite::V1_6_1::Kubernetes::Apis::Policy::V1beta1::PodDisruptionBudgetStatus = nil, context : String? = nil)
  end
