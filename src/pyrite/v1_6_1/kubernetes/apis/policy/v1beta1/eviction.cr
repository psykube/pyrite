...
class Pyrite::V1_6_1::Kubernetes::Apis::Policy::V1beta1::Eviction
  # DeleteOptions may be provided
  property delete_options : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::DeleteOptions
  ...
  YAML.mapping({
    ...
    delete_options: {type: ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::DeleteOptions, nilable: true, key: deleteOptions, getter: false, setter: false},
  ...
  def initialize(@api_version : String? = nil, @delete_options : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::DeleteOptions = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil)
