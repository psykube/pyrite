...
class Pyrite::V1_6_1::Kubernetes::Apis::Policy::V1beta1::PodDisruptionBudgetSpec
  ...
  def initialize(@min_available : ::Pyrite::V1_6_1::Apimachinery::Util::Intstr::IntOrString = nil, @selector : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::LabelSelector = nil)
  end
end
