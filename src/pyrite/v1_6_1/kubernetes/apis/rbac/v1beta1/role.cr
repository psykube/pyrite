...
class Pyrite::V1_6_1::Kubernetes::Apis::Rbac::V1beta1::Role
  ...
  # delete a Role
  def delete_rbac_authorization_v1beta1role(grace_period_seconds : Int32? = nil, orphan_dependents : Bool? = nil, preconditions : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Preconditions = nil, propagation_policy : String? = nil, context : String? = nil)
  end
end
