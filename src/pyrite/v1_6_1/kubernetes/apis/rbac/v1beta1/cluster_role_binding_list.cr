...
class Pyrite::V1_6_1::Kubernetes::Apis::Rbac::V1beta1::ClusterRoleBindingList
  ...
  def create_rbac_authorization_v1beta1cluster_role_binding(role_ref : ::Pyrite::V1_6_1::Kubernetes::Apis::Rbac::V1beta1::RoleRef, subjects : Array, metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, context : String? = nil)
  end
