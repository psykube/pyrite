...
class Pyrite::V1_6_1::Kubernetes::Apis::Rbac::V1beta1::ClusterRole
  # Standard object's metadata.
  property metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta

  # Rules holds all the PolicyRules for this ClusterRole
  property rules : Array(::Pyrite::V1_6_1::Kubernetes::Apis::Rbac::V1beta1::PolicyRule)
  ...
  YAML.mapping({
    ...
    rules:       {type: Array(::Pyrite::V1_6_1::Kubernetes::Apis::Rbac::V1beta1::PolicyRule), nilable: false, key: rules, getter: false, setter: false},
  }, true)
  ...
  def delete_rbac_authorization_v1beta1cluster_role(grace_period_seconds : Int32? = nil, orphan_dependents : Bool? = nil, preconditions : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Preconditions = nil, propagation_policy : String? = nil, context : String? = nil)
  end
end
