...
class Pyrite::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::ClusterRoleBinding
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @role_ref : ::Pyrite::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::RoleRef = nil, @subjects : Array? = nil)
    @api_version = "ClusterRoleBinding"
    @kind = "v1alpha1"
  end

  # create a ClusterRoleBinding
  def create_rbac_authorization_v1alpha1cluster_role_binding(context : String? = nil)
  end
  ...
  def self.read_rbac_authorization_v1alpha1cluster_role_binding(name : String, context : String? = nil)
  end

  # replace the specified ClusterRoleBinding
  def replace_rbac_authorization_v1alpha1cluster_role_binding(context : String? = nil)
  end

  # partially update the specified ClusterRoleBinding
  def patch_rbac_authorization_v1alpha1cluster_role_binding(context : String? = nil)
  end

  # delete a ClusterRoleBinding
  def delete_rbac_authorization_v1alpha1cluster_role_binding(grace_period_seconds : Int32? = nil, orphan_dependents : Bool? = nil, preconditions : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Preconditions = nil, propagation_policy : String? = nil, context : String? = nil)
  end
end
