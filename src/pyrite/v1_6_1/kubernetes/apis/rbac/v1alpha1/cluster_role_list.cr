...
class Pyrite::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::ClusterRoleList
  # Items is a list of ClusterRoles
  property items : Array(::Pyrite::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::ClusterRole)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::ClusterRole), nilable: false, key: items, getter: false, setter: false},
  ...
  def create_rbac_authorization_v1alpha1cluster_role(rules : Array, metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, context : String? = nil)
  end
