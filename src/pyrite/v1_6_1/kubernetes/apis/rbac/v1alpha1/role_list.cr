...
class Pyrite::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::RoleList
  # Items is a list of Roles
  property items : Array(::Pyrite::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::Role)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::Role), nilable: false, key: items, getter: false, setter: false},
  ...
  # create a Role
  def create_rbac_authorization_v1alpha1role(rules : Array, metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, context : String? = nil)
  end
  ...
  # list or watch objects of kind Role
  def self.list_rbac_authorization_v1alpha1role_for_all_namespaces(context : String? = nil, field_selector : String? = nil, label_selector : String? = nil, resource_version : String? = nil, timeout_seconds : Int32? = nil, watch : Bool? = nil)
  end
end
