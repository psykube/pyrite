...
class Pyrite::V1_6_1::Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequestList
  property items : Array(::Pyrite::V1_6_1::Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequest)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_1::Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequest), nilable: false, key: items, getter: false, setter: false},
  ...
  def create(metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_1::Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequestSpec = nil, status : ::Pyrite::V1_6_1::Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequestStatus = nil, context : String? = nil)
  end
