...
class Pyrite::V1_6_1::Kubernetes::Apis::Batch::V2alpha1::CronJobStatus
  # Active holds pointers to currently running jobs.
  property active : Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::ObjectReference)?

  # LastScheduleTime keeps information of when was the last time the job was successfully scheduled.
  property last_schedule_time : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Time

  YAML.mapping({active:             {type: Array(::Pyrite::V1_6_1::Kubernetes::Api::V1::ObjectReference), nilable: true, key: active, getter: false, setter: false},
