...
class Pyrite::V1_6_1::Kubernetes::Apis::Batch::V1::JobStatus
  ...
  YAML.mapping({active:          {type: Int32, nilable: true, key: active, getter: false, setter: false},
                completion_time: {type: ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: completionTime, getter: false, setter: false},
                conditions:      {type: Array(::Pyrite::V1_6_1::Kubernetes::Apis::Batch::V1::JobCondition), nilable: true, key: conditions, getter: false, setter: false},
