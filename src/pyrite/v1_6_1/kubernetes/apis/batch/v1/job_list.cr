...
class Pyrite::V1_6_1::Kubernetes::Apis::Batch::V1::JobList
  # Items is the list of Job.
  property items : Array(::Pyrite::V1_6_1::Kubernetes::Apis::Batch::V1::Job)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_1::Kubernetes::Apis::Batch::V1::Job), nilable: false, key: items, getter: false, setter: false},
  ...
  # create a Job
  def create(metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_1::Kubernetes::Apis::Batch::V1::JobSpec = nil, status : ::Pyrite::V1_6_1::Kubernetes::Apis::Batch::V1::JobStatus = nil, context : String? = nil)
  end
