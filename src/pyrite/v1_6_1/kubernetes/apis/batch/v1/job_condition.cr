...
class Pyrite::V1_6_1::Kubernetes::Apis::Batch::V1::JobCondition
  ...
  def initialize(@last_probe_time : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Time = nil, @last_transition_time : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Time = nil, @message : String? = nil, @reason : String? = nil, @status : String? = nil, @type : String? = nil)
  end
end
