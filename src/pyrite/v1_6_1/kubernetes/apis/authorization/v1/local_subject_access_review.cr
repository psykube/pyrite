...
class Pyrite::V1_6_1::Kubernetes::Apis::Authorization::V1::LocalSubjectAccessReview
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : ::Pyrite::V1_6_1::Kubernetes::Apis::Authorization::V1::SubjectAccessReviewSpec = nil, @status : ::Pyrite::V1_6_1::Kubernetes::Apis::Authorization::V1::SubjectAccessReviewStatus = nil)
