...
class Pyrite::V1_6_1::Kubernetes::Apis::Authorization::V1beta1::SelfSubjectAccessReviewSpec
  ...
  YAML.mapping({non_resource_attributes: {type: ::Pyrite::V1_6_1::Kubernetes::Apis::Authorization::V1beta1::NonResourceAttributes, nilable: true, key: nonResourceAttributes, getter: false, setter: false},
