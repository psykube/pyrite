...
class Pyrite::V1_6_1::Kubernetes::Apis::Apps::V1beta1::StatefulSetList
  ...
  def create(metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_1::Kubernetes::Apis::Apps::V1beta1::StatefulSetSpec = nil, status : ::Pyrite::V1_6_1::Kubernetes::Apis::Apps::V1beta1::StatefulSetStatus = nil, context : String? = nil)
  end
