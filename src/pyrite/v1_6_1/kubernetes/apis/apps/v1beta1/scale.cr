...
class Pyrite::V1_6_1::Kubernetes::Apis::Apps::V1beta1::Scale
  ...
  property spec : ::Pyrite::V1_6_1::Kubernetes::Apis::Apps::V1beta1::ScaleSpec
  ...
  property status : ::Pyrite::V1_6_1::Kubernetes::Apis::Apps::V1beta1::ScaleStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::Pyrite::V1_6_1::Kubernetes::Apis::Apps::V1beta1::ScaleSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::Pyrite::V1_6_1::Kubernetes::Apis::Apps::V1beta1::ScaleStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : ::Pyrite::V1_6_1::Kubernetes::Apis::Apps::V1beta1::ScaleSpec = nil, @status : ::Pyrite::V1_6_1::Kubernetes::Apis::Apps::V1beta1::ScaleStatus = nil)
    @api_version = "Scale"
    @kind = "v1beta1"
  end
