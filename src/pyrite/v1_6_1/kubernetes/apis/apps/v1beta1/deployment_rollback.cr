...
module Pyrite::V1_6_1
  ...
  class Definitions::Kubernetes::Apis::Apps::V1beta1::DeploymentRollback
    ...
    def initialize(@api_version : String? = nil, @kind : String? = nil, @name : String? = nil, @rollback_to : Kubernetes::Apis::Apps::V1beta1::RollbackConfig = nil, @updated_annotations : Hash(String, String)? = nil)
  ...
  module Resources::Apps::V1beta1
    include Resource
    alias DeploymentRollback = Definitions::Kubernetes::Apis::Apps::V1beta1::DeploymentRollback
  end
end
