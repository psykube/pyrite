...
class Pyrite::V1_6_1::Kubernetes::Apis::Apps::V1beta1::DeploymentRollback
  ...
  def initialize(@api_version : String? = nil, @kind : String? = nil, @name : String? = nil, @rollback_to : ::Pyrite::V1_6_1::Kubernetes::Apis::Apps::V1beta1::RollbackConfig = nil, @updated_annotations : Hash(String, String)? = nil)
