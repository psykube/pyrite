...
module Pyrite::V1_6_1
  ...
  class Definitions::Kubernetes::Apis::Apps::V1beta1::DeploymentSpec
    ...
    property strategy : Kubernetes::Apis::Apps::V1beta1::DeploymentStrategy
    ...
    YAML.mapping({min_ready_seconds:         {type: Int32, nilable: true, key: minReadySeconds, getter: false, setter: false},
                  ...
                  rollback_to:               {type: Kubernetes::Apis::Apps::V1beta1::RollbackConfig, nilable: true, key: rollbackTo, getter: false, setter: false},
                  selector:                  {type: Apimachinery::Apis::Meta::V1::LabelSelector, nilable: true, key: selector, getter: false, setter: false},
                  strategy:                  {type: Kubernetes::Apis::Apps::V1beta1::DeploymentStrategy, nilable: true, key: strategy, getter: false, setter: false},
                  template:                  {type: Kubernetes::Api::V1::PodTemplateSpec, nilable: false, key: template, getter: false, setter: false}}, true)
    ...
    def initialize(@min_ready_seconds : Int32? = nil, @paused : Bool? = nil, @progress_deadline_seconds : Int32? = nil, @replicas : Int32? = nil, @revision_history_limit : Int32? = nil, @rollback_to : Kubernetes::Apis::Apps::V1beta1::RollbackConfig = nil, @selector : Apimachinery::Apis::Meta::V1::LabelSelector = nil, @strategy : Kubernetes::Apis::Apps::V1beta1::DeploymentStrategy = nil, @template : Kubernetes::Api::V1::PodTemplateSpec = nil)
    end
  end
end
