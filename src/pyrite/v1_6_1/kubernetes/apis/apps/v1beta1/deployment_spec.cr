...
class Pyrite::V1_6_1::Kubernetes::Apis::Apps::V1beta1::DeploymentSpec
  ...
  def initialize(@min_ready_seconds : Int32? = nil, @paused : Bool? = nil, @progress_deadline_seconds : Int32? = nil, @replicas : Int32? = nil, @revision_history_limit : Int32? = nil, @rollback_to : ::Pyrite::V1_6_1::Kubernetes::Apis::Apps::V1beta1::RollbackConfig = nil, @selector : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::LabelSelector = nil, @strategy : ::Pyrite::V1_6_1::Kubernetes::Apis::Apps::V1beta1::DeploymentStrategy = nil, @template : ::Pyrite::V1_6_1::Kubernetes::Api::V1::PodTemplateSpec = nil)
  end
end
