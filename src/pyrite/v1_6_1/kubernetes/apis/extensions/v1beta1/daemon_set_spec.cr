...
class Pyrite::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::DaemonSetSpec
  ...
  property update_strategy : ::Pyrite::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::DaemonSetUpdateStrategy
  ...
  YAML.mapping({min_ready_seconds:   {type: Int32, nilable: true, key: minReadySeconds, getter: false, setter: false},
                ...
                template:            {type: ::Pyrite::V1_6_1::Kubernetes::Api::V1::PodTemplateSpec, nilable: false, key: template, getter: false, setter: false},
                template_generation: {type: Int32, nilable: true, key: templateGeneration, getter: false, setter: false},
                update_strategy:     {type: ::Pyrite::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::DaemonSetUpdateStrategy, nilable: true, key: updateStrategy, getter: false, setter: false}}, true)
  ...
  def initialize(@min_ready_seconds : Int32? = nil, @selector : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::LabelSelector = nil, @template : ::Pyrite::V1_6_1::Kubernetes::Api::V1::PodTemplateSpec = nil, @template_generation : Int32? = nil, @update_strategy : ::Pyrite::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::DaemonSetUpdateStrategy = nil)
  end
end
