...
class Pyrite::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::ThirdPartyResourceList
  # Items is the list of ThirdPartyResources.
  property items : Array(::Pyrite::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::ThirdPartyResource)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::ThirdPartyResource), nilable: false, key: items, getter: false, setter: false},
  ...
  def create(description : String? = nil, metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, versions : Array? = nil, context : String? = nil)
  end
