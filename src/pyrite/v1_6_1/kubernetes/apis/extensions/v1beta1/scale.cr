...
module Pyrite::V1_6_1
  ...
  class Definitions::Kubernetes::Apis::Extensions::V1beta1::Scale
    ...
    property spec : Kubernetes::Apis::Extensions::V1beta1::ScaleSpec
    ...
    property status : Kubernetes::Apis::Extensions::V1beta1::ScaleStatus
    ...
    def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : Kubernetes::Apis::Extensions::V1beta1::ScaleSpec = nil, @status : Kubernetes::Apis::Extensions::V1beta1::ScaleStatus = nil)
  ...
  module Resources::Extensions::V1beta1
    include Resource
    alias Scale = Definitions::Kubernetes::Apis::Extensions::V1beta1::Scale
  end
end
