...
class Pyrite::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::DaemonSetList
  # A list of daemon sets.
  property items : Array(::Pyrite::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::DaemonSet)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::DaemonSet), nilable: false, key: items, getter: false, setter: false},
  ...
  # create a DaemonSet
  def create(metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::DaemonSetSpec = nil, status : ::Pyrite::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::DaemonSetStatus = nil, context : String? = nil)
  end
