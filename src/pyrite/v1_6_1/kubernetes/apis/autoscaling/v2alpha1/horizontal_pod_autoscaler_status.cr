...
class Pyrite::V1_6_1::Kubernetes::Apis::Autoscaling::V2alpha1::HorizontalPodAutoscalerStatus
  # currentMetrics is the last read state of the metrics used by this autoscaler.
  property current_metrics : Array(::Pyrite::V1_6_1::Kubernetes::Apis::Autoscaling::V2alpha1::MetricStatus)
  ...
  YAML.mapping({current_metrics:     {type: Array(::Pyrite::V1_6_1::Kubernetes::Apis::Autoscaling::V2alpha1::MetricStatus), nilable: false, key: currentMetrics, getter: false, setter: false},
  ...
  JSON.mapping({current_metrics:     {type: Array(::Pyrite::V1_6_1::Kubernetes::Apis::Autoscaling::V2alpha1::MetricStatus), nilable: false, key: currentMetrics, getter: false, setter: false},
                current_replicas:    {type: Int32, nilable: false, key: currentReplicas, getter: false, setter: false},
                desired_replicas:    {type: Int32, nilable: false, key: desiredReplicas, getter: false, setter: false},
                last_scale_time:     {type: ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: lastScaleTime, getter: false, setter: false},
                observed_generation: {type: Int32, nilable: true, key: observedGeneration, getter: false, setter: false}}, true)
