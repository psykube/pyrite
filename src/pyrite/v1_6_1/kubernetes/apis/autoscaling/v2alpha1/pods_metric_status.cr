...
class Pyrite::V1_6_1::Kubernetes::Apis::Autoscaling::V2alpha1::PodsMetricStatus
  ...
  YAML.mapping({current_average_value: {type: ::Pyrite::V1_6_1::Apimachinery::Api::Resource::Quantity, nilable: false, key: currentAverageValue, getter: false, setter: false},
