...
class Pyrite::V1_6_1::Kubernetes::Apis::Autoscaling::V2alpha1::HorizontalPodAutoscalerList
  # items is the list of horizontal pod autoscaler objects.
  property items : Array(::Pyrite::V1_6_1::Kubernetes::Apis::Autoscaling::V2alpha1::HorizontalPodAutoscaler)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::Pyrite::V1_6_1::Kubernetes::Apis::Autoscaling::V2alpha1::HorizontalPodAutoscaler), nilable: false, key: items, getter: false, setter: false},
  ...
  def create(metadata : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta = nil, spec : ::Pyrite::V1_6_1::Kubernetes::Apis::Autoscaling::V2alpha1::HorizontalPodAutoscalerSpec = nil, status : ::Pyrite::V1_6_1::Kubernetes::Apis::Autoscaling::V2alpha1::HorizontalPodAutoscalerStatus = nil, context : String? = nil)
  end
