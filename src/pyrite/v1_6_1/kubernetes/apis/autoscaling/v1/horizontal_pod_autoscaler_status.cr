...
module Pyrite::V1_6_1
  ...
  class Definitions::Kubernetes::Apis::Autoscaling::V1::HorizontalPodAutoscalerStatus
    ...
    def initialize(@current_cpu_utilization_percentage : Int32? = nil, @current_replicas : Int32? = nil, @desired_replicas : Int32? = nil, @last_scale_time : Apimachinery::Apis::Meta::V1::Time = nil, @observed_generation : Int32? = nil)
    end
  end
end
