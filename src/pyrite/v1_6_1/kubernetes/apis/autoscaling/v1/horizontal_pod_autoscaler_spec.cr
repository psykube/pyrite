...
module Pyrite::V1_6_1
  ...
  class Definitions::Kubernetes::Apis::Autoscaling::V1::HorizontalPodAutoscalerSpec
    ...
    def initialize(@max_replicas : Int32? = nil, @min_replicas : Int32? = nil, @scale_target_ref : Kubernetes::Apis::Autoscaling::V1::CrossVersionObjectReference = nil, @target_cpu_utilization_percentage : Int32? = nil)
    end
  end
end
