...
class Pyrite::V1_6_1::Kubernetes::Apis::Settings::V1alpha1::PodPresetSpec
  ...
  def initialize(@env : Array? = nil, @env_from : Array? = nil, @selector : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::LabelSelector = nil, @volume_mounts : Array? = nil, @volumes : Array? = nil)
  end
end
