...
class Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::DeleteOptions
  ...
  property preconditions : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Preconditions
  ...
  YAML.mapping({
    ...
    preconditions:        {type: ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Preconditions, nilable: true, key: preconditions, getter: false, setter: false},
  ...
  def initialize(@api_version : String? = nil, @grace_period_seconds : Int32? = nil, @kind : String? = nil, @orphan_dependents : Bool? = nil, @preconditions : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Preconditions = nil, @propagation_policy : String? = nil)
