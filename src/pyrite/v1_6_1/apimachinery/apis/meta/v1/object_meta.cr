...
class Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta
  ...
  property creation_timestamp : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Time
  ...
  property deletion_timestamp : ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Time
  ...
  property owner_references : Array(::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::OwnerReference)?
  ...
  YAML.mapping({annotations:                   {type: Hash(String, String), nilable: true, key: annotations, getter: false, setter: false},
                ...
                creation_timestamp:            {type: ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: creationTimestamp, getter: false, setter: false},
                deletion_grace_period_seconds: {type: Int32, nilable: true, key: deletionGracePeriodSeconds, getter: false, setter: false},
                deletion_timestamp:            {type: ::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: deletionTimestamp, getter: false, setter: false},
                ...
                owner_references:              {type: Array(::Pyrite::V1_6_1::Apimachinery::Apis::Meta::V1::OwnerReference), nilable: true, key: ownerReferences, getter: false, setter: false},
  ...
  def initialize(@annotations = nil, @cluster_name = nil, @creation_timestamp = nil, @deletion_grace_period_seconds = nil, @deletion_timestamp = nil, @finalizers = nil, @generate_name = nil, @generation = nil, @labels = nil, @name = nil, @namespace = nil, @owner_references = nil, @resource_version = nil, @self_link = nil, @uid = nil)
  end
end
