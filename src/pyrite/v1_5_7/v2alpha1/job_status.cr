...
module Pyrite::V1_5_7
  ...
  class Definitions::V2alpha1::JobStatus
    ...
    property conditions : Array(V2alpha1::JobCondition)?
    ...
    YAML.mapping({active:          {type: Int32, nilable: true, key: active, getter: false, setter: false},
                  ...
                  conditions:      {type: Array(V2alpha1::JobCondition), nilable: true, key: conditions, getter: false, setter: false},
