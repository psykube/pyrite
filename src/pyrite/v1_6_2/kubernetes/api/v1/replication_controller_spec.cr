...
module Pyrite::V1_6_2
  ...
  class Definitions::Kubernetes::Api::V1::ReplicationControllerSpec
    ...
    def initialize(@min_ready_seconds : Int32? = nil, @replicas : Int32? = nil, @selector : Hash(String, String)? = nil, @template : Kubernetes::Api::V1::PodTemplateSpec = nil)
    end
  end
end
