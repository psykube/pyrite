...
module Pyrite::V1_6_2
  ...
  class Definitions::Kubernetes::Api::V1::FlexVolumeSource
    ...
    YAML.mapping({driver:     {type: String, nilable: false, key: driver, getter: false, setter: false},
                  ...
                  secret_ref: {type: Kubernetes::Api::V1::LocalObjectReference, nilable: true, key: secretRef, getter: false, setter: false}}, true)
    ...
    def initialize(@driver : String? = nil, @fs_type : String? = nil, @options : Hash(String, String)? = nil, @read_only : Bool? = nil, @secret_ref : Kubernetes::Api::V1::LocalObjectReference = nil)
    end
  end
end
