...
module Pyrite::V1_6_2
  ...
  class Definitions::Kubernetes::Api::V1::ConfigMap
    ...
    def initialize(@api_version : String? = nil, @data : Hash(String, String)? = nil, @kind : String? = nil, @metadata : Apimachinery::Apis::Meta::V1::ObjectMeta = nil)
      @api_version = "v1"
      @kind = "ConfigMap"
    end
  end
  ...
  module Resources::V1
    include Resource
    alias ConfigMap = Definitions::Kubernetes::Api::V1::ConfigMap
  end
end
