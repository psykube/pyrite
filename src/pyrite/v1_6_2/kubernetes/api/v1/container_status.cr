...
module Pyrite::V1_6_2
  ...
  class Definitions::Kubernetes::Api::V1::ContainerStatus
    ...
    property last_state : Kubernetes::Api::V1::ContainerState
    ...
    property state : Kubernetes::Api::V1::ContainerState
    ...
    YAML.mapping({container_id:  {type: String, nilable: true, key: containerID, getter: false, setter: false},
                  ...
                  state:         {type: Kubernetes::Api::V1::ContainerState, nilable: true, key: state, getter: false, setter: false}}, true)
    ...
    def initialize(@container_id : String? = nil, @image : String? = nil, @image_id : String? = nil, @last_state : Kubernetes::Api::V1::ContainerState = nil, @name : String? = nil, @ready : Bool? = nil, @restart_count : Int32? = nil, @state : Kubernetes::Api::V1::ContainerState = nil)
    end
  end
end
