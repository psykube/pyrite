...
module Pyrite::V1_6_2
  ...
  class Definitions::Kubernetes::Api::V1::NodeStatus
    ...
    property addresses : Array(Kubernetes::Api::V1::NodeAddress)?
    ...
    property conditions : Array(Kubernetes::Api::V1::NodeCondition)?

    # Endpoints of daemons running on the Node.
    property daemon_endpoints : Kubernetes::Api::V1::NodeDaemonEndpoints

    # List of container images on this node
    property images : Array(Kubernetes::Api::V1::ContainerImage)?
    ...
    property node_info : Kubernetes::Api::V1::NodeSystemInfo
    ...
    property volumes_attached : Array(Kubernetes::Api::V1::AttachedVolume)?

    # List of attachable volumes in use (mounted) by the node.
    property volumes_in_use : Array(String)?

    YAML.mapping({addresses:        {type: Array(Kubernetes::Api::V1::NodeAddress), nilable: true, key: addresses, getter: false, setter: false},
    ...
    JSON.mapping({addresses:        {type: Array(Kubernetes::Api::V1::NodeAddress), nilable: true, key: addresses, getter: false, setter: false},
                  allocatable:      {type: Hash(String, String), nilable: true, key: allocatable, getter: false, setter: false},
                  capacity:         {type: Hash(String, String), nilable: true, key: capacity, getter: false, setter: false},
                  conditions:       {type: Array(Kubernetes::Api::V1::NodeCondition), nilable: true, key: conditions, getter: false, setter: false},
                  daemon_endpoints: {type: Kubernetes::Api::V1::NodeDaemonEndpoints, nilable: true, key: daemonEndpoints, getter: false, setter: false},
