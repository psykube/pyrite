...
module Pyrite::V1_6_2
  ...
  class Definitions::Kubernetes::Apis::Autoscaling::V2alpha1::HorizontalPodAutoscalerSpec
    ...
    property metrics : Array(Kubernetes::Apis::Autoscaling::V2alpha1::MetricSpec)?
    ...
    YAML.mapping({max_replicas:     {type: Int32, nilable: false, key: maxReplicas, getter: false, setter: false},
                  ...
                  scale_target_ref: {type: Kubernetes::Apis::Autoscaling::V2alpha1::CrossVersionObjectReference, nilable: false, key: scaleTargetRef, getter: false, setter: false}}, true)
    ...
    def initialize(@max_replicas : Int32? = nil, @metrics : Array? = nil, @min_replicas : Int32? = nil, @scale_target_ref : Kubernetes::Apis::Autoscaling::V2alpha1::CrossVersionObjectReference = nil)
    end
  end
end
