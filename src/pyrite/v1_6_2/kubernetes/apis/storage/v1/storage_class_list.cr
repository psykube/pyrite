...
module Pyrite::V1_6_2
  ...
  class Definitions::Kubernetes::Apis::Storage::V1::StorageClassList
    # Items is the list of StorageClasses
    property items : Array(Kubernetes::Apis::Storage::V1::StorageClass)
    ...
    YAML.mapping({
      ...
      items:       {type: Array(Kubernetes::Apis::Storage::V1::StorageClass), nilable: false, key: items, getter: false, setter: false},
  ...
  module Resources::Storage::V1
    include Resource
    alias StorageClassList = Definitions::Kubernetes::Apis::Storage::V1::StorageClassList
  end
end
