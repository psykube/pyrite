...
module Pyrite::V1_6_2
  ...
  class Definitions::Kubernetes::Apis::Extensions::V1beta1::ReplicaSetSpec
    ...
    YAML.mapping({min_ready_seconds: {type: Int32, nilable: true, key: minReadySeconds, getter: false, setter: false},
                  ...
                  template:          {type: Kubernetes::Api::V1::PodTemplateSpec, nilable: true, key: template, getter: false, setter: false}}, true)
    ...
    def initialize(@min_ready_seconds : Int32? = nil, @replicas : Int32? = nil, @selector : Apimachinery::Apis::Meta::V1::LabelSelector = nil, @template : Kubernetes::Api::V1::PodTemplateSpec = nil)
    end
  end
end
