...
module Pyrite::V1_6_2
  ...
  class Definitions::Kubernetes::Apis::Extensions::V1beta1::DaemonSetSpec
    ...
    property update_strategy : Kubernetes::Apis::Extensions::V1beta1::DaemonSetUpdateStrategy
    ...
    YAML.mapping({min_ready_seconds:   {type: Int32, nilable: true, key: minReadySeconds, getter: false, setter: false},
                  ...
                  update_strategy:     {type: Kubernetes::Apis::Extensions::V1beta1::DaemonSetUpdateStrategy, nilable: true, key: updateStrategy, getter: false, setter: false}}, true)
    ...
    def initialize(@min_ready_seconds : Int32? = nil, @selector : Apimachinery::Apis::Meta::V1::LabelSelector = nil, @template : Kubernetes::Api::V1::PodTemplateSpec = nil, @template_generation : Int32? = nil, @update_strategy : Kubernetes::Apis::Extensions::V1beta1::DaemonSetUpdateStrategy = nil)
    end
  end
end
