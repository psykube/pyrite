...
module Pyrite::V1_6_2
  ...
  class Definitions::Kubernetes::Apis::Authentication::V1::TokenReview
    ...
    property status : Kubernetes::Apis::Authentication::V1::TokenReviewStatus
    ...
    def initialize(@api_version : String? = nil, @kind : String? = nil, @metadata : Apimachinery::Apis::Meta::V1::ObjectMeta = nil, @spec : Kubernetes::Apis::Authentication::V1::TokenReviewSpec = nil, @status : Kubernetes::Apis::Authentication::V1::TokenReviewStatus = nil)
  ...
  module Resources::Authentication::V1
    include Resource
    alias TokenReview = Definitions::Kubernetes::Apis::Authentication::V1::TokenReview
  end
end
