...
class K8S::V1_6_0::Kubernetes::Apis::Autoscaling::V2alpha1::HorizontalPodAutoscalerList
  # items is the list of horizontal pod autoscaler objects.
  property items : Array(::K8S::V1_6_0::Kubernetes::Apis::Autoscaling::V2alpha1::HorizontalPodAutoscaler)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Apis::Autoscaling::V2alpha1::HorizontalPodAutoscaler), nilable: false, key: items, getter: false, setter: false},
