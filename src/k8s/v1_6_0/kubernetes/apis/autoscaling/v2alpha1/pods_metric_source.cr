...
class K8S::V1_6_0::Kubernetes::Apis::Autoscaling::V2alpha1::PodsMetricSource
  ...
  YAML.mapping({metric_name:          {type: String, nilable: false, key: metricName, getter: false, setter: false},
                target_average_value: {type: ::K8S::V1_6_0::Apimachinery::Api::Resource::Quantity, nilable: false, key: targetAverageValue, getter: false, setter: false}}, true)
