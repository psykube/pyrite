...
class K8S::V1_6_0::Kubernetes::Apis::Autoscaling::V2alpha1::ResourceMetricStatus
  ...
  YAML.mapping({current_average_utilization: {type: Int32, nilable: true, key: currentAverageUtilization, getter: false, setter: false},
                current_average_value:       {type: ::K8S::V1_6_0::Apimachinery::Api::Resource::Quantity, nilable: false, key: currentAverageValue, getter: false, setter: false},
