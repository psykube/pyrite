...
class K8S::V1_6_0::Kubernetes::Apis::Authorization::V1beta1::SelfSubjectAccessReview
  property metadata : ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta

  # Spec holds information about the request being evaluated. user and groups must be empty
  property spec : ::K8S::V1_6_0::Kubernetes::Apis::Authorization::V1beta1::SelfSubjectAccessReviewSpec
  ...
  YAML.mapping({
    ...
    spec:        {type: ::K8S::V1_6_0::Kubernetes::Apis::Authorization::V1beta1::SelfSubjectAccessReviewSpec, nilable: false, key: spec, getter: false, setter: false},
