...
class K8S::V1_6_0::Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequest
  property metadata : ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta

  # The certificate request itself and any additional information.
  property spec : ::K8S::V1_6_0::Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequestSpec

  # Derived information about the request.
  property status : ::K8S::V1_6_0::Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequestStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::K8S::V1_6_0::Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequestSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::K8S::V1_6_0::Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequestStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
