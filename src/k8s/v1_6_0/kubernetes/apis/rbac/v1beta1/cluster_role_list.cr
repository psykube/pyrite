...
class K8S::V1_6_0::Kubernetes::Apis::Rbac::V1beta1::ClusterRoleList
  # Items is a list of ClusterRoles
  property items : Array(::K8S::V1_6_0::Kubernetes::Apis::Rbac::V1beta1::ClusterRole)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Apis::Rbac::V1beta1::ClusterRole), nilable: false, key: items, getter: false, setter: false},
