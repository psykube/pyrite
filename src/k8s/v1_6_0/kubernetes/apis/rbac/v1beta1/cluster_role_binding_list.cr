...
class K8S::V1_6_0::Kubernetes::Apis::Rbac::V1beta1::ClusterRoleBindingList
  # Items is a list of ClusterRoleBindings
  property items : Array(::K8S::V1_6_0::Kubernetes::Apis::Rbac::V1beta1::ClusterRoleBinding)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Apis::Rbac::V1beta1::ClusterRoleBinding), nilable: false, key: items, getter: false, setter: false},
