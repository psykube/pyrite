...
class K8S::V1_6_0::Kubernetes::Apis::Rbac::V1beta1::RoleBindingList
  # Items is a list of RoleBindings
  property items : Array(::K8S::V1_6_0::Kubernetes::Apis::Rbac::V1beta1::RoleBinding)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Apis::Rbac::V1beta1::RoleBinding), nilable: false, key: items, getter: false, setter: false},
