...
class K8S::V1_6_0::Kubernetes::Apis::Settings::V1alpha1::PodPreset
  property metadata : ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta

  property spec : ::K8S::V1_6_0::Kubernetes::Apis::Settings::V1alpha1::PodPresetSpec
  ...
  YAML.mapping({
    ...
    spec:        {type: ::K8S::V1_6_0::Kubernetes::Apis::Settings::V1alpha1::PodPresetSpec, nilable: true, key: spec, getter: false, setter: false},
  }, true)
