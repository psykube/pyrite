...
class K8S::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::NetworkPolicyList
  # Items is a list of schema objects.
  property items : Array(::K8S::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::NetworkPolicy)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::NetworkPolicy), nilable: false, key: items, getter: false, setter: false},
