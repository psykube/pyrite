...
class K8S::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::ThirdPartyResource
  ...
  property versions : Array(::K8S::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::APIVersion)?
  ...
  YAML.mapping({
    ...
    versions:    {type: Array(::K8S::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::APIVersion), nilable: true, key: versions, getter: false, setter: false},
  }, true)
