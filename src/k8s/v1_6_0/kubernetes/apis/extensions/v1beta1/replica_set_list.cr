...
class K8S::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::ReplicaSetList
  # List of ReplicaSets.More info: http://kubernetes.io/docs/user-guide/replication-controller
  property items : Array(::K8S::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::ReplicaSet)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::ReplicaSet), nilable: false, key: items, getter: false, setter: false},
