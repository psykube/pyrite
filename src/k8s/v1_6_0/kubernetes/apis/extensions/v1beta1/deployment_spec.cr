...
class K8S::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::DeploymentSpec
  ...
  property rollback_to : ::K8S::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::RollbackConfig

  # Label selector for pods.Existing ReplicaSets whose pods are selected by this will be the ones affected by this deployment.
  property selector : ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::LabelSelector

  # The deployment strategy to use to replace existing pods with new ones.
  property strategy : ::K8S::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::DeploymentStrategy
  ...
  YAML.mapping({min_ready_seconds:         {type: Int32, nilable: true, key: minReadySeconds, getter: false, setter: false},
                ...
                rollback_to:               {type: ::K8S::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::RollbackConfig, nilable: true, key: rollbackTo, getter: false, setter: false},
                selector:                  {type: ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::LabelSelector, nilable: true, key: selector, getter: false, setter: false},
                strategy:                  {type: ::K8S::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::DeploymentStrategy, nilable: true, key: strategy, getter: false, setter: false},
