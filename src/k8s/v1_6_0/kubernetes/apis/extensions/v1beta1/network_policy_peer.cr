...
class K8S::V1_6_0::Kubernetes::Apis::Extensions::V1beta1::NetworkPolicyPeer
  ...
  property namespace_selector : ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::LabelSelector
  ...
  YAML.mapping({namespace_selector: {type: ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::LabelSelector, nilable: true, key: namespaceSelector, getter: false, setter: false},
                pod_selector:       {type: ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::LabelSelector, nilable: true, key: podSelector, getter: false, setter: false}}, true)

  JSON.mapping({namespace_selector: {type: ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::LabelSelector, nilable: true, key: namespaceSelector, getter: false, setter: false},
                pod_selector:       {type: ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::LabelSelector, nilable: true, key: podSelector, getter: false, setter: false}}, true)
