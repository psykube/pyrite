...
class K8S::V1_6_0::Kubernetes::Apis::Policy::V1beta1::PodDisruptionBudget
  property metadata : ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta

  # Specification of the desired behavior of the PodDisruptionBudget.
  property spec : ::K8S::V1_6_0::Kubernetes::Apis::Policy::V1beta1::PodDisruptionBudgetSpec

  # Most recently observed status of the PodDisruptionBudget.
  property status : ::K8S::V1_6_0::Kubernetes::Apis::Policy::V1beta1::PodDisruptionBudgetStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::K8S::V1_6_0::Kubernetes::Apis::Policy::V1beta1::PodDisruptionBudgetSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::K8S::V1_6_0::Kubernetes::Apis::Policy::V1beta1::PodDisruptionBudgetStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
