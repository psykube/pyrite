...
class K8S::V1_6_0::Kubernetes::Apis::Apps::V1beta1::Deployment
  # Standard object metadata.
  property metadata : ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta

  # Specification of the desired behavior of the Deployment.
  property spec : ::K8S::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentSpec

  # Most recently observed status of the Deployment.
  property status : ::K8S::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::K8S::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::K8S::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
