...
class K8S::V1_6_0::Kubernetes::Apis::Apps::V1beta1::StatefulSetSpec
  ...
  property volume_claim_templates : Array(::K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolumeClaim)?
  ...
  YAML.mapping({replicas:               {type: Int32, nilable: true, key: replicas, getter: false, setter: false},
                ...
                volume_claim_templates: {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolumeClaim), nilable: true, key: volumeClaimTemplates, getter: false, setter: false}}, true)
