...
class K8S::V1_6_0::Kubernetes::Apis::Apps::V1beta1::DeploymentRollback
  ...
  YAML.mapping({
    ...
    rollback_to:         {type: ::K8S::V1_6_0::Kubernetes::Apis::Apps::V1beta1::RollbackConfig, nilable: false, key: rollbackTo, getter: false, setter: false},
