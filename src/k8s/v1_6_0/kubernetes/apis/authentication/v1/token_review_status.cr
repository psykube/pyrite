...
class K8S::V1_6_0::Kubernetes::Apis::Authentication::V1::TokenReviewStatus
  ...
  property user : ::K8S::V1_6_0::Kubernetes::Apis::Authentication::V1::UserInfo
  ...
  YAML.mapping({authenticated: {type: Bool, nilable: true, key: authenticated, getter: false, setter: false},
                ...
                user:          {type: ::K8S::V1_6_0::Kubernetes::Apis::Authentication::V1::UserInfo, nilable: true, key: user, getter: false, setter: false}}, true)
