...
class K8S::V1_6_0::Kubernetes::Apis::Batch::V1::JobCondition
  # Last time the condition was checked.
  property last_probe_time : ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::Time
  ...
  YAML.mapping({last_probe_time:      {type: ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: lastProbeTime, getter: false, setter: false},
  ...
  JSON.mapping({last_probe_time:      {type: ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: lastProbeTime, getter: false, setter: false},
                last_transition_time: {type: ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: lastTransitionTime, getter: false, setter: false},
                message:              {type: String, nilable: true, key: message, getter: false, setter: false},
                reason:               {type: String, nilable: true, key: reason, getter: false, setter: false},
                status:               {type: String, nilable: false, key: status, getter: false, setter: false},
