...
class K8S::V1_6_0::Kubernetes::Apis::Batch::V1::JobStatus
  # Active is the number of actively running pods.
  property active : Int32?

  # CompletionTime represents time when the job was completed.It is not guaranteed to be set in happens-before order across separate operations.It is represented in RFC3339 form and is in UTC.
  property completion_time : ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::Time
  ...
  property conditions : Array(::K8S::V1_6_0::Kubernetes::Apis::Batch::V1::JobCondition)?
  ...
  YAML.mapping({active:          {type: Int32, nilable: true, key: active, getter: false, setter: false},
                completion_time: {type: ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: completionTime, getter: false, setter: false},
                conditions:      {type: Array(::K8S::V1_6_0::Kubernetes::Apis::Batch::V1::JobCondition), nilable: true, key: conditions, getter: false, setter: false},
                failed:          {type: Int32, nilable: true, key: failed, getter: false, setter: false},
                start_time:      {type: ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: startTime, getter: false, setter: false},
