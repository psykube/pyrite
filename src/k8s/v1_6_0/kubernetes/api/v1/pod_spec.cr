...
class K8S::V1_6_0::Kubernetes::Api::V1::PodSpec
  # Optional duration in seconds the pod may be active on the node relative to StartTime before the system will actively try to mark it failed and kill associated containers.Value must be a positive integer.
  property active_deadline_seconds : Int32?

  # If specified, the pod's scheduling constraints
  property affinity : ::K8S::V1_6_0::Kubernetes::Api::V1::Affinity
  ...
  property containers : Array(::K8S::V1_6_0::Kubernetes::Api::V1::Container)
  ...
  property init_containers : Array(::K8S::V1_6_0::Kubernetes::Api::V1::Container)?
  ...
  property security_context : ::K8S::V1_6_0::Kubernetes::Api::V1::PodSecurityContext
  ...
  property tolerations : Array(::K8S::V1_6_0::Kubernetes::Api::V1::Toleration)?
  ...
  property volumes : Array(::K8S::V1_6_0::Kubernetes::Api::V1::Volume)?

  YAML.mapping({active_deadline_seconds:          {type: Int32, nilable: true, key: activeDeadlineSeconds, getter: false, setter: false},
                affinity:                         {type: ::K8S::V1_6_0::Kubernetes::Api::V1::Affinity, nilable: true, key: affinity, getter: false, setter: false},
                automount_service_account_token:  {type: Bool, nilable: true, key: automountServiceAccountToken, getter: false, setter: false},
                containers:                       {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::Container), nilable: false, key: containers, getter: false, setter: false},
                ...
                init_containers:                  {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::Container), nilable: true, key: initContainers, getter: false, setter: false},
                ...
                security_context:                 {type: ::K8S::V1_6_0::Kubernetes::Api::V1::PodSecurityContext, nilable: true, key: securityContext, getter: false, setter: false},
                ...
                tolerations:                      {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::Toleration), nilable: true, key: tolerations, getter: false, setter: false},
                volumes:                          {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::Volume), nilable: true, key: volumes, getter: false, setter: false}}, true)
