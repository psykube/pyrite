...
class K8S::V1_6_0::Kubernetes::Api::V1::NodeList
  # List of nodes
  property items : Array(::K8S::V1_6_0::Kubernetes::Api::V1::Node)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::Node), nilable: false, key: items, getter: false, setter: false},
