...
class K8S::V1_6_0::Kubernetes::Api::V1::PodSecurityContext
  ...
  YAML.mapping({fs_group:            {type: Int32, nilable: true, key: fsGroup, getter: false, setter: false},
                ...
                se_linux_options:    {type: ::K8S::V1_6_0::Kubernetes::Api::V1::SELinuxOptions, nilable: true, key: seLinuxOptions, getter: false, setter: false},
