...
class K8S::V1_6_0::Kubernetes::Api::V1::LimitRangeList
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::LimitRange), nilable: false, key: items, getter: false, setter: false},
