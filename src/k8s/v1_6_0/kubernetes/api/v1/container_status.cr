...
class K8S::V1_6_0::Kubernetes::Api::V1::ContainerStatus
  ...
  property last_state : ::K8S::V1_6_0::Kubernetes::Api::V1::ContainerState
  ...
  property state : ::K8S::V1_6_0::Kubernetes::Api::V1::ContainerState
  ...
  YAML.mapping({container_id:  {type: String, nilable: true, key: containerID, getter: false, setter: false},
                ...
                last_state:    {type: ::K8S::V1_6_0::Kubernetes::Api::V1::ContainerState, nilable: true, key: lastState, getter: false, setter: false},
                ...
                state:         {type: ::K8S::V1_6_0::Kubernetes::Api::V1::ContainerState, nilable: true, key: state, getter: false, setter: false}}, true)
