...
class K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolume
  ...
  property spec : ::K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolumeSpec
  ...
  property status : ::K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolumeStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolumeSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolumeStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
