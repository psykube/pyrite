...
class K8S::V1_6_0::Kubernetes::Api::V1::Namespace
  ...
  property spec : ::K8S::V1_6_0::Kubernetes::Api::V1::NamespaceSpec
  ...
  property status : ::K8S::V1_6_0::Kubernetes::Api::V1::NamespaceStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::K8S::V1_6_0::Kubernetes::Api::V1::NamespaceSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::K8S::V1_6_0::Kubernetes::Api::V1::NamespaceStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
