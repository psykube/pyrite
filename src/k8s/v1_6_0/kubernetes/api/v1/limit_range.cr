...
class K8S::V1_6_0::Kubernetes::Api::V1::LimitRange
  ...
  property spec : ::K8S::V1_6_0::Kubernetes::Api::V1::LimitRangeSpec
  ...
  YAML.mapping({
    ...
    spec:        {type: ::K8S::V1_6_0::Kubernetes::Api::V1::LimitRangeSpec, nilable: true, key: spec, getter: false, setter: false},
  }, true)
