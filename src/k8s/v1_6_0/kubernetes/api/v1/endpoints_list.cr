...
class K8S::V1_6_0::Kubernetes::Api::V1::EndpointsList
  # List of endpoints.
  property items : Array(::K8S::V1_6_0::Kubernetes::Api::V1::Endpoints)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::Endpoints), nilable: false, key: items, getter: false, setter: false},
