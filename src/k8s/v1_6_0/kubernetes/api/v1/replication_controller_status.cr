...
class K8S::V1_6_0::Kubernetes::Api::V1::ReplicationControllerStatus
  # The number of available replicas (ready for at least minReadySeconds) for this replication controller.
  property available_replicas : Int32?

  # Represents the latest available observations of a replication controller's current state.
  property conditions : Array(::K8S::V1_6_0::Kubernetes::Api::V1::ReplicationControllerCondition)?
  ...
  YAML.mapping({available_replicas:     {type: Int32, nilable: true, key: availableReplicas, getter: false, setter: false},
                conditions:             {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::ReplicationControllerCondition), nilable: true, key: conditions, getter: false, setter: false},
