...
class K8S::V1_6_0::Kubernetes::Api::V1::ComponentStatusList
  # List of ComponentStatus objects.
  property items : Array(::K8S::V1_6_0::Kubernetes::Api::V1::ComponentStatus)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::ComponentStatus), nilable: false, key: items, getter: false, setter: false},
