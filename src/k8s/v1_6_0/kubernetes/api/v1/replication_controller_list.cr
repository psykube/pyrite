...
class K8S::V1_6_0::Kubernetes::Api::V1::ReplicationControllerList
  # List of replication controllers.More info: http://kubernetes.io/docs/user-guide/replication-controller
  property items : Array(::K8S::V1_6_0::Kubernetes::Api::V1::ReplicationController)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::ReplicationController), nilable: false, key: items, getter: false, setter: false},
