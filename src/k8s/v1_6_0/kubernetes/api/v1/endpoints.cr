...
#     },
#  ]
class K8S::V1_6_0::Kubernetes::Api::V1::Endpoints
  ...
  property subsets : Array(::K8S::V1_6_0::Kubernetes::Api::V1::EndpointSubset)
  ...
  YAML.mapping({
    ...
    subsets:     {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::EndpointSubset), nilable: false, key: subsets, getter: false, setter: false},
  }, true)
  ...
  def replace(subsets, pretty : String?, metadata = nil)
  end
