...
class K8S::V1_6_0::Kubernetes::Api::V1::PodTemplateList
  # List of pod templates
  property items : Array(::K8S::V1_6_0::Kubernetes::Api::V1::PodTemplate)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::PodTemplate), nilable: false, key: items, getter: false, setter: false},
