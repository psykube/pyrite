...
class K8S::V1_6_0::Kubernetes::Api::V1::RBDVolumeSource
  ...
  property secret_ref : ::K8S::V1_6_0::Kubernetes::Api::V1::LocalObjectReference
  ...
  YAML.mapping({fs_type:    {type: String, nilable: true, key: fsType, getter: false, setter: false},
                ...
                secret_ref: {type: ::K8S::V1_6_0::Kubernetes::Api::V1::LocalObjectReference, nilable: true, key: secretRef, getter: false, setter: false},
  ...
  def initialize(@image, @monitors, @fs_type = nil, @keyring = nil, @pool = nil, @read_only = nil, @secret_ref = nil, @user = nil)
  end
end
