...
class K8S::V1_6_0::Kubernetes::Api::V1::Service
  ...
  property spec : ::K8S::V1_6_0::Kubernetes::Api::V1::ServiceSpec
  ...
  property status : ::K8S::V1_6_0::Kubernetes::Api::V1::ServiceStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::K8S::V1_6_0::Kubernetes::Api::V1::ServiceSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::K8S::V1_6_0::Kubernetes::Api::V1::ServiceStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
