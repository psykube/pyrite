...
class K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolumeClaim
  ...
  property spec : ::K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolumeClaimSpec
  ...
  property status : ::K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolumeClaimStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolumeClaimSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolumeClaimStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
