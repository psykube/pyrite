...
class K8S::V1_6_0::Kubernetes::Api::V1::Taint
  ...
  property time_added : ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::Time
  ...
  YAML.mapping({effect:     {type: String, nilable: false, key: effect, getter: false, setter: false},
                ...
                time_added: {type: ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: timeAdded, getter: false, setter: false},
