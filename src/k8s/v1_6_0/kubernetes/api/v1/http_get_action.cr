...
class K8S::V1_6_0::Kubernetes::Api::V1::HTTPGetAction
  # Host name to connect to, defaults to the pod IP.You probably want to set "Host" in httpHeaders instead.
  property host : String?

  # Custom headers to set in the request.HTTP allows repeated headers.
  property http_headers : Array(::K8S::V1_6_0::Kubernetes::Api::V1::HTTPHeader)?
  ...
  YAML.mapping({host:         {type: String, nilable: true, key: host, getter: false, setter: false},
                http_headers: {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::HTTPHeader), nilable: true, key: httpHeaders, getter: false, setter: false},
                path:         {type: String, nilable: true, key: path, getter: false, setter: false},
                port:         {type: ::K8S::V1_6_0::Apimachinery::Util::Intstr::IntOrString, nilable: false, key: port, getter: false, setter: false},
