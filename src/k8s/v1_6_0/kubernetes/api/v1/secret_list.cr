...
class K8S::V1_6_0::Kubernetes::Api::V1::SecretList
  # Items is a list of secret objects.More info: http://kubernetes.io/docs/user-guide/secrets
  property items : Array(::K8S::V1_6_0::Kubernetes::Api::V1::Secret)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::Secret), nilable: false, key: items, getter: false, setter: false},
