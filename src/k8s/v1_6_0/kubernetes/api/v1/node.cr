...
class K8S::V1_6_0::Kubernetes::Api::V1::Node
  ...
  property spec : ::K8S::V1_6_0::Kubernetes::Api::V1::NodeSpec
  ...
  property status : ::K8S::V1_6_0::Kubernetes::Api::V1::NodeStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::K8S::V1_6_0::Kubernetes::Api::V1::NodeSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::K8S::V1_6_0::Kubernetes::Api::V1::NodeStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
