...
class K8S::V1_6_0::Kubernetes::Api::V1::ResourceFieldSelector
  # Container name: required for volumes, optional for env vars
  property container_name : String?

  # Specifies the output format of the exposed resources, defaults to "1"
  property divisor : ::K8S::V1_6_0::Apimachinery::Api::Resource::Quantity

  # Required: resource to select
  property resource : String

  YAML.mapping({container_name: {type: String, nilable: true, key: containerName, getter: false, setter: false},
                divisor:        {type: ::K8S::V1_6_0::Apimachinery::Api::Resource::Quantity, nilable: true, key: divisor, getter: false, setter: false},
