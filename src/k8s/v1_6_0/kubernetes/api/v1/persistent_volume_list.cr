...
class K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolumeList
  # List of persistent volumes.More info: http://kubernetes.io/docs/user-guide/persistent-volumes
  property items : Array(::K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolume)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolume), nilable: false, key: items, getter: false, setter: false},
