...
class K8S::V1_6_0::Kubernetes::Api::V1::ComponentStatus
  # List of component conditions observed
  property conditions : Array(::K8S::V1_6_0::Kubernetes::Api::V1::ComponentCondition)?
  ...
  YAML.mapping({
    ...
    conditions:  {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::ComponentCondition), nilable: true, key: conditions, getter: false, setter: false},
