...
class K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolumeClaimList
  ...
  property items : Array(::K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolumeClaim)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::PersistentVolumeClaim), nilable: false, key: items, getter: false, setter: false},
