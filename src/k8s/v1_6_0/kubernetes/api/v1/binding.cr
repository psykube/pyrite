...
class K8S::V1_6_0::Kubernetes::Api::V1::Binding
  # Standard object's metadata.More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata
  property metadata : ::K8S::V1_6_0::Apimachinery::Apis::Meta::V1::ObjectMeta

  # The target object that you want to bind to the standard object.
  property target : ::K8S::V1_6_0::Kubernetes::Api::V1::ObjectReference
  ...
  YAML.mapping({
    ...
    target:      {type: ::K8S::V1_6_0::Kubernetes::Api::V1::ObjectReference, nilable: false, key: target, getter: false, setter: false},
  }, true)
