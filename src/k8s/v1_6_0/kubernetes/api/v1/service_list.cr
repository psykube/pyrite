...
class K8S::V1_6_0::Kubernetes::Api::V1::ServiceList
  # List of services
  property items : Array(::K8S::V1_6_0::Kubernetes::Api::V1::Service)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::Service), nilable: false, key: items, getter: false, setter: false},
