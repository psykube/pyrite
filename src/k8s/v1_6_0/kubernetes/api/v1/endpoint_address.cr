...
class K8S::V1_6_0::Kubernetes::Api::V1::EndpointAddress
  ...
  property target_ref : ::K8S::V1_6_0::Kubernetes::Api::V1::ObjectReference
  ...
  YAML.mapping({hostname:   {type: String, nilable: true, key: hostname, getter: false, setter: false},
                ...
                target_ref: {type: ::K8S::V1_6_0::Kubernetes::Api::V1::ObjectReference, nilable: true, key: targetRef, getter: false, setter: false}}, true)
