...
class K8S::V1_6_0::Kubernetes::Api::V1::ConfigMapList
  # Items is the list of ConfigMaps.
  property items : Array(::K8S::V1_6_0::Kubernetes::Api::V1::ConfigMap)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_0::Kubernetes::Api::V1::ConfigMap), nilable: false, key: items, getter: false, setter: false},
