...
class K8S::V1_6_1::Apimachinery::Apis::Meta::V1::StatusDetails
  # The Causes array includes more details associated with the StatusReason failure.Not all StatusReasons may provide detailed causes.
  property causes : Array(::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::StatusCause)?
  ...
  YAML.mapping({causes:              {type: Array(::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::StatusCause), nilable: true, key: causes, getter: false, setter: false},
  ...
  JSON.mapping({causes:              {type: Array(::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::StatusCause), nilable: true, key: causes, getter: false, setter: false},
                group:               {type: String, nilable: true, key: group, getter: false, setter: false},
                kind:                {type: String, nilable: true, key: kind, getter: false, setter: false},
                name:                {type: String, nilable: true, key: name, getter: false, setter: false},
                retry_after_seconds: {type: Int32, nilable: true, key: retryAfterSeconds, getter: false, setter: false}}, true)
