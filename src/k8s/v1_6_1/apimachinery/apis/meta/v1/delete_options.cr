...
class K8S::V1_6_1::Apimachinery::Apis::Meta::V1::DeleteOptions
  ...
  property preconditions : ::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::Preconditions
  ...
  YAML.mapping({
    ...
    preconditions:        {type: ::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::Preconditions, nilable: true, key: preconditions, getter: false, setter: false},
