...
class K8S::V1_6_1::Kubernetes::Api::V1::NodeCondition
  # Last time we got an update on a given condition.
  property last_heartbeat_time : ::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::Time
  ...
  YAML.mapping({last_heartbeat_time:  {type: ::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: lastHeartbeatTime, getter: false, setter: false},
  ...
  JSON.mapping({last_heartbeat_time:  {type: ::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: lastHeartbeatTime, getter: false, setter: false},
                last_transition_time: {type: ::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: lastTransitionTime, getter: false, setter: false},
                message:              {type: String, nilable: true, key: message, getter: false, setter: false},
                reason:               {type: String, nilable: true, key: reason, getter: false, setter: false},
                status:               {type: String, nilable: false, key: status, getter: false, setter: false},
