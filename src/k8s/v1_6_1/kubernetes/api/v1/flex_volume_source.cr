...
class K8S::V1_6_1::Kubernetes::Api::V1::FlexVolumeSource
  ...
  YAML.mapping({driver:     {type: String, nilable: false, key: driver, getter: false, setter: false},
                ...
                secret_ref: {type: ::K8S::V1_6_1::Kubernetes::Api::V1::LocalObjectReference, nilable: true, key: secretRef, getter: false, setter: false}}, true)
