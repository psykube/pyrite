...
class K8S::V1_6_1::Kubernetes::Api::V1::NodeStatus
  ...
  property addresses : Array(::K8S::V1_6_1::Kubernetes::Api::V1::NodeAddress)?
  ...
  property conditions : Array(::K8S::V1_6_1::Kubernetes::Api::V1::NodeCondition)?

  # Endpoints of daemons running on the Node.
  property daemon_endpoints : ::K8S::V1_6_1::Kubernetes::Api::V1::NodeDaemonEndpoints

  # List of container images on this node
  property images : Array(::K8S::V1_6_1::Kubernetes::Api::V1::ContainerImage)?

  # Set of ids/uuids to uniquely identify the node.More info: http://releases.k8s.io/HEAD/docs/admin/node.md#node-info
  property node_info : ::K8S::V1_6_1::Kubernetes::Api::V1::NodeSystemInfo
  ...
  property volumes_attached : Array(::K8S::V1_6_1::Kubernetes::Api::V1::AttachedVolume)?

  # List of attachable volumes in use (mounted) by the node.
  property volumes_in_use : Array(String)?

  YAML.mapping({addresses:        {type: Array(::K8S::V1_6_1::Kubernetes::Api::V1::NodeAddress), nilable: true, key: addresses, getter: false, setter: false},
                ...
                conditions:       {type: Array(::K8S::V1_6_1::Kubernetes::Api::V1::NodeCondition), nilable: true, key: conditions, getter: false, setter: false},
                daemon_endpoints: {type: ::K8S::V1_6_1::Kubernetes::Api::V1::NodeDaemonEndpoints, nilable: true, key: daemonEndpoints, getter: false, setter: false},
                images:           {type: Array(::K8S::V1_6_1::Kubernetes::Api::V1::ContainerImage), nilable: true, key: images, getter: false, setter: false},
                node_info:        {type: ::K8S::V1_6_1::Kubernetes::Api::V1::NodeSystemInfo, nilable: true, key: nodeInfo, getter: false, setter: false},
                phase:            {type: String, nilable: true, key: phase, getter: false, setter: false},
                volumes_attached: {type: Array(::K8S::V1_6_1::Kubernetes::Api::V1::AttachedVolume), nilable: true, key: volumesAttached, getter: false, setter: false},
                volumes_in_use:   {type: Array(String), nilable: true, key: volumesInUse, getter: false, setter: false}}, true)

  JSON.mapping({addresses:        {type: Array(::K8S::V1_6_1::Kubernetes::Api::V1::NodeAddress), nilable: true, key: addresses, getter: false, setter: false},
                allocatable:      {type: Hash(String, String), nilable: true, key: allocatable, getter: false, setter: false},
                capacity:         {type: Hash(String, String), nilable: true, key: capacity, getter: false, setter: false},
                conditions:       {type: Array(::K8S::V1_6_1::Kubernetes::Api::V1::NodeCondition), nilable: true, key: conditions, getter: false, setter: false},
                daemon_endpoints: {type: ::K8S::V1_6_1::Kubernetes::Api::V1::NodeDaemonEndpoints, nilable: true, key: daemonEndpoints, getter: false, setter: false},
