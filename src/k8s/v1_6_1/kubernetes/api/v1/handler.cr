...
class K8S::V1_6_1::Kubernetes::Api::V1::Handler
  ...
  YAML.mapping({exec:       {type: ::K8S::V1_6_1::Kubernetes::Api::V1::ExecAction, nilable: true, key: exec, getter: false, setter: false},
                ...
                tcp_socket: {type: ::K8S::V1_6_1::Kubernetes::Api::V1::TCPSocketAction, nilable: true, key: tcpSocket, getter: false, setter: false}}, true)
