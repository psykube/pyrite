...
class K8S::V1_6_1::Kubernetes::Api::V1::ServicePort
  ...
  property target_port : ::K8S::V1_6_1::Apimachinery::Util::Intstr::IntOrString
  ...
  YAML.mapping({name:        {type: String, nilable: true, key: name, getter: false, setter: false},
                ...
                target_port: {type: ::K8S::V1_6_1::Apimachinery::Util::Intstr::IntOrString, nilable: true, key: targetPort, getter: false, setter: false}}, true)
