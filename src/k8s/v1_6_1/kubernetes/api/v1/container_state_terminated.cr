...
class K8S::V1_6_1::Kubernetes::Api::V1::ContainerStateTerminated
  ...
  property finished_at : ::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::Time
  ...
  YAML.mapping({container_id: {type: String, nilable: true, key: containerID, getter: false, setter: false},
                ...
                finished_at:  {type: ::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: finishedAt, getter: false, setter: false},
                message:      {type: String, nilable: true, key: message, getter: false, setter: false},
                reason:       {type: String, nilable: true, key: reason, getter: false, setter: false},
                signal:       {type: Int32, nilable: true, key: signal, getter: false, setter: false},
                started_at:   {type: ::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::Time, nilable: true, key: startedAt, getter: false, setter: false}}, true)
