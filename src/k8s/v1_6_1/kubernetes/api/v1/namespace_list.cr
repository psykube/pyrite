...
class K8S::V1_6_1::Kubernetes::Api::V1::NamespaceList
  # Items is the list of Namespace objects in the list.More info: http://kubernetes.io/docs/user-guide/namespaces
  property items : Array(::K8S::V1_6_1::Kubernetes::Api::V1::Namespace)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_1::Kubernetes::Api::V1::Namespace), nilable: false, key: items, getter: false, setter: false},
