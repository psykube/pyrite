...
class K8S::V1_6_1::Kubernetes::Api::V1::ServiceAccount
  ...
  property secrets : Array(::K8S::V1_6_1::Kubernetes::Api::V1::ObjectReference)?
  ...
  YAML.mapping({
    ...
    secrets:                         {type: Array(::K8S::V1_6_1::Kubernetes::Api::V1::ObjectReference), nilable: true, key: secrets, getter: false, setter: false},
  }, true)
