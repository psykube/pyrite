...
class K8S::V1_6_1::Kubernetes::Api::V1::EventList
  # List of events
  property items : Array(::K8S::V1_6_1::Kubernetes::Api::V1::Event)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_1::Kubernetes::Api::V1::Event), nilable: false, key: items, getter: false, setter: false},
