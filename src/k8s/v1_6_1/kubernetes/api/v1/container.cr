...
class K8S::V1_6_1::Kubernetes::Api::V1::Container
  ...
  property env : Array(::K8S::V1_6_1::Kubernetes::Api::V1::EnvVar)?

  # List of sources to populate environment variables in the container.The keys defined within a source must be a C_IDENTIFIER.All invalid keys will be reported as an event when the container is starting.When a key exists in multiple sources, the value associated with the last source will take precedence.Values defined by an Env with a duplicate key will take precedence.Cannot be updated.
  property env_from : Array(::K8S::V1_6_1::Kubernetes::Api::V1::EnvFromSource)?
  ...
  property lifecycle : ::K8S::V1_6_1::Kubernetes::Api::V1::Lifecycle
  ...
  property liveness_probe : ::K8S::V1_6_1::Kubernetes::Api::V1::Probe

  # Name of the container specified as a DNS_LABEL.Each container in a pod must have a unique name (DNS_LABEL).Cannot be updated.
  property name : String

  # List of ports to expose from the container.Exposing a port here gives the system additional information about the network connections a container uses, but is primarily informational.Not specifying a port here DOES NOT prevent that port from being exposed.Any port which is listening on the default "0.0.0.0" address inside a container will be accessible from the network.Cannot be updated.
  property ports : Array(::K8S::V1_6_1::Kubernetes::Api::V1::ContainerPort)?
  ...
  property readiness_probe : ::K8S::V1_6_1::Kubernetes::Api::V1::Probe
  ...
  property resources : ::K8S::V1_6_1::Kubernetes::Api::V1::ResourceRequirements

  # Security options the pod should run with.More info: http://releases.k8s.io/HEAD/docs/design/security_context.md
  property security_context : ::K8S::V1_6_1::Kubernetes::Api::V1::SecurityContext
  ...
  property volume_mounts : Array(::K8S::V1_6_1::Kubernetes::Api::V1::VolumeMount)?
  ...
  YAML.mapping({args:                       {type: Array(String), nilable: true, key: args, getter: false, setter: false},
                ...
                env:                        {type: Array(::K8S::V1_6_1::Kubernetes::Api::V1::EnvVar), nilable: true, key: env, getter: false, setter: false},
                env_from:                   {type: Array(::K8S::V1_6_1::Kubernetes::Api::V1::EnvFromSource), nilable: true, key: envFrom, getter: false, setter: false},
                ...
                lifecycle:                  {type: ::K8S::V1_6_1::Kubernetes::Api::V1::Lifecycle, nilable: true, key: lifecycle, getter: false, setter: false},
                liveness_probe:             {type: ::K8S::V1_6_1::Kubernetes::Api::V1::Probe, nilable: true, key: livenessProbe, getter: false, setter: false},
                name:                       {type: String, nilable: false, key: name, getter: false, setter: false},
                ports:                      {type: Array(::K8S::V1_6_1::Kubernetes::Api::V1::ContainerPort), nilable: true, key: ports, getter: false, setter: false},
                readiness_probe:            {type: ::K8S::V1_6_1::Kubernetes::Api::V1::Probe, nilable: true, key: readinessProbe, getter: false, setter: false},
                resources:                  {type: ::K8S::V1_6_1::Kubernetes::Api::V1::ResourceRequirements, nilable: true, key: resources, getter: false, setter: false},
                security_context:           {type: ::K8S::V1_6_1::Kubernetes::Api::V1::SecurityContext, nilable: true, key: securityContext, getter: false, setter: false},
                ...
                volume_mounts:              {type: Array(::K8S::V1_6_1::Kubernetes::Api::V1::VolumeMount), nilable: true, key: volumeMounts, getter: false, setter: false},
