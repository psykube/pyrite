...
class K8S::V1_6_1::Kubernetes::Api::V1::ServiceSpec
  ...
  property ports : Array(::K8S::V1_6_1::Kubernetes::Api::V1::ServicePort)?
  ...
  YAML.mapping({cluster_ip:                  {type: String, nilable: true, key: clusterIP, getter: false, setter: false},
                ...
                ports:                       {type: Array(::K8S::V1_6_1::Kubernetes::Api::V1::ServicePort), nilable: true, key: ports, getter: false, setter: false},
