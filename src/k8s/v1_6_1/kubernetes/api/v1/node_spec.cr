...
class K8S::V1_6_1::Kubernetes::Api::V1::NodeSpec
  ...
  property taints : Array(::K8S::V1_6_1::Kubernetes::Api::V1::Taint)?
  ...
  YAML.mapping({external_id:   {type: String, nilable: true, key: externalID, getter: false, setter: false},
                ...
                taints:        {type: Array(::K8S::V1_6_1::Kubernetes::Api::V1::Taint), nilable: true, key: taints, getter: false, setter: false},
