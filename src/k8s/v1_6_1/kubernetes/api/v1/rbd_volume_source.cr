...
class K8S::V1_6_1::Kubernetes::Api::V1::RBDVolumeSource
  ...
  YAML.mapping({fs_type:    {type: String, nilable: true, key: fsType, getter: false, setter: false},
                ...
                secret_ref: {type: ::K8S::V1_6_1::Kubernetes::Api::V1::LocalObjectReference, nilable: true, key: secretRef, getter: false, setter: false},
