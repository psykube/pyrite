...
class K8S::V1_6_1::Kubernetes::Apis::Policy::V1beta1::Eviction
  # DeleteOptions may be provided
  property delete_options : ::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::DeleteOptions
  ...
  YAML.mapping({
    ...
    delete_options: {type: ::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::DeleteOptions, nilable: true, key: deleteOptions, getter: false, setter: false},
