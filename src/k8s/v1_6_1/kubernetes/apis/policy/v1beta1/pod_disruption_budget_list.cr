...
class K8S::V1_6_1::Kubernetes::Apis::Policy::V1beta1::PodDisruptionBudgetList
  property items : Array(::K8S::V1_6_1::Kubernetes::Apis::Policy::V1beta1::PodDisruptionBudget)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_1::Kubernetes::Apis::Policy::V1beta1::PodDisruptionBudget), nilable: false, key: items, getter: false, setter: false},
