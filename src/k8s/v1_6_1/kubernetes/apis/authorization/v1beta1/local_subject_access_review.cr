...
class K8S::V1_6_1::Kubernetes::Apis::Authorization::V1beta1::LocalSubjectAccessReview
  property metadata : ::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta

  # Spec holds information about the request being evaluated. spec.namespace must be equal to the namespace you made the request against. If empty, it is defaulted.
  property spec : ::K8S::V1_6_1::Kubernetes::Apis::Authorization::V1beta1::SubjectAccessReviewSpec
  ...
  YAML.mapping({
    ...
    spec:        {type: ::K8S::V1_6_1::Kubernetes::Apis::Authorization::V1beta1::SubjectAccessReviewSpec, nilable: false, key: spec, getter: false, setter: false},
