...
class K8S::V1_6_1::Kubernetes::Apis::Apps::V1beta1::Scale
  # Standard object metadata; More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata.
  property metadata : ::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta

  # defines the behavior of the scale.More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.
  property spec : ::K8S::V1_6_1::Kubernetes::Apis::Apps::V1beta1::ScaleSpec

  # current status of the scale.More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.Read-only.
  property status : ::K8S::V1_6_1::Kubernetes::Apis::Apps::V1beta1::ScaleStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::K8S::V1_6_1::Kubernetes::Apis::Apps::V1beta1::ScaleSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::K8S::V1_6_1::Kubernetes::Apis::Apps::V1beta1::ScaleStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
