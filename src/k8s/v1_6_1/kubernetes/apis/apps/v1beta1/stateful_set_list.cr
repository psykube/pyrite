...
class K8S::V1_6_1::Kubernetes::Apis::Apps::V1beta1::StatefulSetList
  property items : Array(::K8S::V1_6_1::Kubernetes::Apis::Apps::V1beta1::StatefulSet)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_1::Kubernetes::Apis::Apps::V1beta1::StatefulSet), nilable: false, key: items, getter: false, setter: false},
