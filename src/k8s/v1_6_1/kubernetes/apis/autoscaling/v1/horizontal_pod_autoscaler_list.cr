...
class K8S::V1_6_1::Kubernetes::Apis::Autoscaling::V1::HorizontalPodAutoscalerList
  # list of horizontal pod autoscaler objects.
  property items : Array(::K8S::V1_6_1::Kubernetes::Apis::Autoscaling::V1::HorizontalPodAutoscaler)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_1::Kubernetes::Apis::Autoscaling::V1::HorizontalPodAutoscaler), nilable: false, key: items, getter: false, setter: false},
