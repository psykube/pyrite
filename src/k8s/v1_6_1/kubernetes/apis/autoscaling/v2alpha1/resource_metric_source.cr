...
class K8S::V1_6_1::Kubernetes::Apis::Autoscaling::V2alpha1::ResourceMetricSource
  ...
  YAML.mapping({name:                       {type: String, nilable: false, key: name, getter: false, setter: false},
                ...
                target_average_value:       {type: ::K8S::V1_6_1::Apimachinery::Api::Resource::Quantity, nilable: true, key: targetAverageValue, getter: false, setter: false}}, true)
