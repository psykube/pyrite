...
class K8S::V1_6_1::Kubernetes::Apis::Batch::V2alpha1::CronJobSpec
  ...
  property job_template : ::K8S::V1_6_1::Kubernetes::Apis::Batch::V2alpha1::JobTemplateSpec
  ...
  YAML.mapping({concurrency_policy:            {type: String, nilable: true, key: concurrencyPolicy, getter: false, setter: false},
                ...
                job_template:                  {type: ::K8S::V1_6_1::Kubernetes::Apis::Batch::V2alpha1::JobTemplateSpec, nilable: false, key: jobTemplate, getter: false, setter: false},
