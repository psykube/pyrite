...
class K8S::V1_6_1::Kubernetes::Apis::Batch::V2alpha1::CronJob
  ...
  property spec : ::K8S::V1_6_1::Kubernetes::Apis::Batch::V2alpha1::CronJobSpec
  ...
  property status : ::K8S::V1_6_1::Kubernetes::Apis::Batch::V2alpha1::CronJobStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::K8S::V1_6_1::Kubernetes::Apis::Batch::V2alpha1::CronJobSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::K8S::V1_6_1::Kubernetes::Apis::Batch::V2alpha1::CronJobStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
