...
class K8S::V1_6_1::Kubernetes::Apis::Batch::V1::JobList
  # Items is the list of Job.
  property items : Array(::K8S::V1_6_1::Kubernetes::Apis::Batch::V1::Job)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_1::Kubernetes::Apis::Batch::V1::Job), nilable: false, key: items, getter: false, setter: false},
