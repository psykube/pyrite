...
class K8S::V1_6_1::Kubernetes::Apis::Batch::V1::Job
  ...
  property status : ::K8S::V1_6_1::Kubernetes::Apis::Batch::V1::JobStatus
  ...
  YAML.mapping({
    ...
    spec:        {type: ::K8S::V1_6_1::Kubernetes::Apis::Batch::V1::JobSpec, nilable: true, key: spec, getter: false, setter: false},
    status:      {type: ::K8S::V1_6_1::Kubernetes::Apis::Batch::V1::JobStatus, nilable: true, key: status, getter: false, setter: false},
  }, true)
