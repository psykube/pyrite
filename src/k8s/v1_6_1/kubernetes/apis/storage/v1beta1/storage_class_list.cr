...
class K8S::V1_6_1::Kubernetes::Apis::Storage::V1beta1::StorageClassList
  # Items is the list of StorageClasses
  property items : Array(::K8S::V1_6_1::Kubernetes::Apis::Storage::V1beta1::StorageClass)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_1::Kubernetes::Apis::Storage::V1beta1::StorageClass), nilable: false, key: items, getter: false, setter: false},
