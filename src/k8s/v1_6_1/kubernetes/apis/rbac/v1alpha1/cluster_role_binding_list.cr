...
class K8S::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::ClusterRoleBindingList
  # Items is a list of ClusterRoleBindings
  property items : Array(::K8S::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::ClusterRoleBinding)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::ClusterRoleBinding), nilable: false, key: items, getter: false, setter: false},
