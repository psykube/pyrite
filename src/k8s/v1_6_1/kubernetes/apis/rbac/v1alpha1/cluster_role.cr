...
class K8S::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::ClusterRole
  # Standard object's metadata.
  property metadata : ::K8S::V1_6_1::Apimachinery::Apis::Meta::V1::ObjectMeta

  # Rules holds all the PolicyRules for this ClusterRole
  property rules : Array(::K8S::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::PolicyRule)
  ...
  YAML.mapping({
    ...
    rules:       {type: Array(::K8S::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::PolicyRule), nilable: false, key: rules, getter: false, setter: false},
  }, true)
