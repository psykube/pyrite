...
class K8S::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::RoleList
  # Items is a list of Roles
  property items : Array(::K8S::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::Role)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_1::Kubernetes::Apis::Rbac::V1alpha1::Role), nilable: false, key: items, getter: false, setter: false},
