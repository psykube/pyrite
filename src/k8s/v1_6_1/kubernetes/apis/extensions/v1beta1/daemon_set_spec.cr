...
class K8S::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::DaemonSetSpec
  ...
  property update_strategy : ::K8S::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::DaemonSetUpdateStrategy
  ...
  YAML.mapping({min_ready_seconds:   {type: Int32, nilable: true, key: minReadySeconds, getter: false, setter: false},
                ...
                update_strategy:     {type: ::K8S::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::DaemonSetUpdateStrategy, nilable: true, key: updateStrategy, getter: false, setter: false}}, true)
