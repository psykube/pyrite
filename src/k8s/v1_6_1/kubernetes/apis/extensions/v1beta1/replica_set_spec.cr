...
class K8S::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::ReplicaSetSpec
  ...
  YAML.mapping({min_ready_seconds: {type: Int32, nilable: true, key: minReadySeconds, getter: false, setter: false},
                ...
                template:          {type: ::K8S::V1_6_1::Kubernetes::Api::V1::PodTemplateSpec, nilable: true, key: template, getter: false, setter: false}}, true)
