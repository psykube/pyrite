...
class K8S::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::IngressList
  # Items is the list of Ingress.
  property items : Array(::K8S::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::Ingress)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::Ingress), nilable: false, key: items, getter: false, setter: false},
