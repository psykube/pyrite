...
class K8S::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::DeploymentList
  # Items is the list of Deployments.
  property items : Array(::K8S::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::Deployment)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::Deployment), nilable: false, key: items, getter: false, setter: false},
