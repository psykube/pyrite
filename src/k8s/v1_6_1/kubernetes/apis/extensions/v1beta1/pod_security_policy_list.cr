...
class K8S::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::PodSecurityPolicyList
  # Items is a list of schema objects.
  property items : Array(::K8S::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::PodSecurityPolicy)
  ...
  YAML.mapping({
    ...
    items:       {type: Array(::K8S::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::PodSecurityPolicy), nilable: false, key: items, getter: false, setter: false},
