...
class K8S::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::ReplicaSetStatus
  # The number of available replicas (ready for at least minReadySeconds) for this replica set.
  property available_replicas : Int32?

  # Represents the latest available observations of a replica set's current state.
  property conditions : Array(::K8S::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::ReplicaSetCondition)?
  ...
  YAML.mapping({available_replicas:     {type: Int32, nilable: true, key: availableReplicas, getter: false, setter: false},
                conditions:             {type: Array(::K8S::V1_6_1::Kubernetes::Apis::Extensions::V1beta1::ReplicaSetCondition), nilable: true, key: conditions, getter: false, setter: false},
